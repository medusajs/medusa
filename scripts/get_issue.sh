#!/usr/bin/env bash
#
# Fetches issue details (title, body, author, state).
# Usage: ./scripts/get_issue.sh [issue_number]
#
...
gh issue view "$ISSUE" --json number,title,body,author,state,labels,createdAt,url
