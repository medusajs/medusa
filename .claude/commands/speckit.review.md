---
description: Independent cross-AI critical review of spec.md, plan.md, tasks.md from a specific reviewer (Claude/Codex/Antigravity/Gemini/Copilot). Writes verdict to specs/<slug>/reviews/<provider>.md. Mandatory before /speckit.implement (per constitution Principle VI).
---
