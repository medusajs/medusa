---
description: Start a new SpecKit feature in an isolated git worktree before /speckit.specify. Reserves the next feature number, creates the branch, sets up the worktree directory.
---
