 ...
 */
exports.checkDepsChanges = ({ newPath, packageName, monoRepoPackages, isInitialScan, ignoredPackageJSON, packageNameToPath, }) => __awaiter(this, void 0, void 0, function* () {
    let localPKGjson;
    ...
    if (!areDepsEqual) {
        ...
        const depChangeLog = _.uniq(Object.keys(Object.assign(Object.assign({}, diff), diff2)))
            .reduce((acc, key) => {
