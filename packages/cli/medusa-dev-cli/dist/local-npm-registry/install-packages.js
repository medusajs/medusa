...
const installPackages = ({ packagesToInstall, yarnWorkspaceRoot, newlyPublishedPackageVersions, externalRegistry, }) => __awaiter(this, void 0, void 0, function* () {
    ...
    if (yarnWorkspaceRoot) {
        ...
        const { stdout: yarnVersion } = yield promisifiedSpawn([
            `yarn`,
            [`--version`],
            { stdio: `pipe` },
        ]);
        const workspaceCommand = !yarnVersion.startsWith("1") ? "list" : "info";
        const { stdout } = yield promisifiedSpawn([
            `yarn`,
        ...
        try {
          ...
          */
            ...
            if ((sanitizedStdOut === null || sanitizedStdOut === void 0 ? void 0 : sanitizedStdOut.length) >= 2) {
    ...
    try {
        yield promisifiedSpawn(installCmd);
