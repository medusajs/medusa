 ...
 */
function watch(root, packages, { scanOnce, quiet, forceInstall, monoRepoPackages, localPackages, packageNameToPath, externalRegistry, }) {
    return __awaiter(this, void 0, void 0, function* () {
            ...
            fs.copy(oldPath, newPath, (err) => {
                if (err) {
                    if (retry >= MAX_COPY_RETRIES) {
                        ...
                        setTimeout(() => realCopyPath(Object.assign(Object.assign({}, arg), { retry: retry + 1 })), 500 * Math.pow(2, retry));
                        return;
                    }
                }
        ...
        const clearJSFilesFromNodeModules = () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all([...packagesToClear].map((packageToClear) => __awaiter(this, void 0, void 0, function* () {
                return yield del([
        ...
        if (forceInstall) {
            try {
                if (allPackagesToWatch.length > 0) {
                    yield publishPackagesLocallyAndInstall({
                    ...
                    yield promisifiedSpawn(yarnInstallCmd);
        ...
        chokidar
            ...
            if (relativePackageFile === `package.json`) {
                ...
                const { didDepsChanged, packageNotInstalled } = yield didDepsChangedPromise;
            ...
            yield Promise.all(Array.from(waitFor));
            if (isInitialScan) {
                isInitialScan = false;
                ...
                yield clearJSFilesFromNodeModules();
                runQueuedCopies();
            }
