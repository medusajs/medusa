...
export class Migration20240213035200 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('ALTER TABLE IF EXISTS "invite" ADD CONSTRAINT "IDX_invite_email" UNIQUE (email) WHERE deleted_at IS NULL;');
