"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = exports.CustomerServiceMock = void 0;var _medusaTestUtils = require("medusa-test-utils");
...
var CustomerServiceMock = {
  ...
  update: jest.fn().mockReturnValue(Promise.resolve()) };exports.CustomerServiceMock = CustomerServiceMock;
