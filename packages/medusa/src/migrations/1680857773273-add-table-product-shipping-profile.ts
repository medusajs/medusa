  ...
  implements MigrationInterface
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `
        ...
        CREATE UNIQUE INDEX IF NOT EXISTS "idx_product_shipping_profile_product_id_unique" ON "product_shipping_profile" ("product_id");
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        ...
        DROP INDEX IF EXISTS "idx_product_shipping_profile_product_id_unique";
