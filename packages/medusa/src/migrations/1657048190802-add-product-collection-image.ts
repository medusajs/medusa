...
export class addProductCollectionImage1657048190802
    implements MigrationInterface
{
  name = "addProductCollectionImage1657048190802"

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
        `ALTER TABLE "product_collection" ADD "description" character varying`
    )
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
        `ALTER TABLE "product_collection" DROP COLUMN "description"`
    )
    await queryRunner.query(
