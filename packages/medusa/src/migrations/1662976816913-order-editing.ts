...
export class orderEditing1662976816913 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_item_change" ADD CONSTRAINT "FK_a3851ad9d890e2265ba878c5eef" FOREIGN KEY ("orderEditId") REFERENCES "order_edit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_item_change" DROP CONSTRAINT "FK_a3851ad9d890e2265ba878c5eef"`);
