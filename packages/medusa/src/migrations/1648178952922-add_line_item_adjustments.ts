...
export class addLineItemAdjustments1648178952922 implements MigrationInterface {
    name = 'addLineItemAdjustments1648178952922'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_e737b077ce87216e6d2d0c0051"`);
