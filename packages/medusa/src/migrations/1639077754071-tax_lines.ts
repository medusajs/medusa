...
export class taxLines1639077754071 implements MigrationInterface {
  name = "taxLines1639077754071"
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tax_line" ("id" character varying NOT NULL, "item_id" character varying NOT NULL, "rate" integer NOT NULL, "name" character varying NOT NULL, "code" character varying, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "metadata" jsonb, CONSTRAINT "PK_023b2ff4b7563fbb0ce7c9b5a5d" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_d27330b639b67d92a4d7d912fb" ON "tax_line" ("item_id") `
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "region" ADD "giftcards_taxable" boolean NOT NULL DEFAULT true`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "tax_line" ADD CONSTRAINT "FK_d27330b639b67d92a4d7d912fb4" FOREIGN KEY ("item_id") REFERENCES "line_item"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tax_line" DROP CONSTRAINT "FK_d27330b639b67d92a4d7d912fb4"`
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d27330b639b67d92a4d7d912fb"`
    )
