...
export class orderEditing1662981581869 implements MigrationInterface {
    name = 'orderEditing1662981581869'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "order_item_change_type_enum" AS ENUM('item_add', 'item_remove', 'quantity_change')`);
        ...
        await queryRunner.query(`CREATE TABLE "order_edit" ("id" character varying NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP WITH TIME ZONE, "order_id" character varying NOT NULL, "internal_note" character varying, "created_by" character varying NOT NULL, "requested_by" character varying, "requested_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "confirmed_by" character varying, "confirmed_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "declined_by" character varying, "declined_reason" character varying, "declined_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), "canceled_by" character varying, "canceled_at" TIMESTAMP WITH TIME ZONE DEFAULT now(), CONSTRAINT "PK_58ab6acf2e84b4e827f5f846f7a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "order_edit" ADD CONSTRAINT "FK_fe2a275ff60947aad4b8d663bdd" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_edit" ADD CONSTRAINT "FK_fe2a275ff60947aad4b8d663bdd" FOREIGN KEY ("created_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "order_edit" ADD CONSTRAINT "FK_62b7765bab66da06a02bb07e195" FOREIGN KEY ("canceled_by") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "order_edit" DROP CONSTRAINT "FK_62b7765bab66da06a02bb07e195"`);
        await queryRunner.query(`ALTER TABLE "order_edit" DROP CONSTRAINT "FK_fe2a275ff60947aad4b8d663bdd"`);
        await queryRunner.query(`ALTER TABLE "order_edit" DROP CONSTRAINT "FK_fe2a275ff60947aad4b8d663bdd"`);
