...
export default async (req, res) => {
  const schema = Validator.object().keys({
    ...
    swap_link_template: Validator.string().allow('').optional(),
    payment_link_template: Validator.string().allow('').optional(),
    default_currency_code: Validator.string().allow('').optional(),
