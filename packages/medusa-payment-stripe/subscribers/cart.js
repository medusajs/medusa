...
var CartSubscriber = /*#__PURE__*/function () {
  function CartSubscriber(_ref) {
    ...
    this.eventBus_.subscribe("cart.customer_updated", /*#__PURE__*/function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(cart) {
  ...
  _createClass(CartSubscriber, [{
    ...
    value: function () {
      var _onCustomerUpdated = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(cartId) {
        var _this2 = this;
            ...
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return this.manager_.transaction( /*#__PURE__*/function () {
                  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(transactionManager) {
                    ...
                    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return _this2.cartService_.withTransaction(transactionManager).retrieve(cartId, {
                              select: ["subtotal", "tax_total", "shipping_total", "discount_total", "gift_card_total", "total"],
                              relations: ["billing_address", "shipping_address", "region", "region.payment_providers", "items", "items.adjustments", "payment_sessions", "customer"]
                            });
                          ...
                          case 5:
                            ...
                            _context2.next = 9;
                            return _this2.paymentProviderService_.withTransaction(transactionManager).updateSession(session, cart);
