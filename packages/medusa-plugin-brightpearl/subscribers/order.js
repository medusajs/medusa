...
var OrderSubscriber = function OrderSubscriber(_ref) {
  ...
  _defineProperty(this, "registerShipment", /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
      var order_id, shipment, noteId;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              order_id = data.order_id, shipment = data.shipment;
              noteId = shipment.metadata.goods_out_note;
  ...
  _defineProperty(this, "registerReturn", function (data) {
    var order = data.order,
        fromReturn = data["return"];
    return _this.brightpearlService_.createSalesCredit(order, fromReturn)["catch"](function (err) {
      return console.log(err);
    });
  });

  _defineProperty(this, "registerRefund", function (data) {
    var order = data.order,
        refund = data.refund;
    return _this.brightpearlService_.createRefundCredit(order, refund)["catch"](function (err) {
      return console.log(err);
    });
  });
