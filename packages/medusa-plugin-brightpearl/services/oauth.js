...
var BrightpearlOauth = /*#__PURE__*/function (_OauthService) {
  ...
  _createClass(BrightpearlOauth, [{
    key: "refreshToken",
    value: function () {
      var _refreshToken2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_refreshToken) {
        var params, data;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return _brightpearl["default"].refreshToken(this.account_, params);
    ...
    key: "generateToken",
    value: function () {
      var _generateToken = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(code) {
        var params, data;
