      ...
      <Section title="Attributes" actions={actions} forceDropdown>
        <div className="flex flex-col gap-y-xsmall mb-large mt-base">
          ...
          <div className="flex flex-col gap-y-xsmall">
            <Attribute attribute="Height" unit="in" value={product.height} />
            <Attribute attribute="Width" unit="in" value={product.width} />
            <Attribute attribute="Length" unit="in" value={product.length} />
            <Attribute attribute="Weight" unit="oz" value={product.weight} />
          </div>
        </div>
        <div className="flex flex-col gap-y-xsmall">
...
const Attribute = ({ attribute, value, unit }: AttributeProps) => {
  return (
