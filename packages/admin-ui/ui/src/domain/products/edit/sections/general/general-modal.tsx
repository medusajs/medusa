    ...
    onUpdate(
      {
        ...
        tax_category_id: data.general.tax_category_id || null,
        ...
        customer_response_prompt: data.general.customer_response_prompt,
      },
      onReset
    )
  })
...
const getDefaultValues = (product: Product): GeneralFormWrapper => {
  return {
    general: {
      ...
      tax_category_id: product.tax_category?.id || null,
      shipping_profile: {
        label: product.profile.name,
        value: product.profile_id,
      },
      customer_response_prompt: product.customer_response_prompt,
    },
    organize: {
