 ...
 */
const PricesForm = ({ form, allowRegionPricing = true, required }: Props) => {
  ...
  const priceObj = useMemo(() => {
    ...
    const regionPrices = fields.filter(
      (field) => field.region_id !== null && allowRegionPricing
    )
