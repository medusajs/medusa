 ...
 */
function ImportEtsyProducts(props: ImportProductsProps) {
  ...
  return (
    <UploadModal
      ...
      fileTitle={"Products from Etsy"}
      description1Text="You can get the CSV file to import from your Etsy account."
      description2Title=""
      description2Text=""
    />
  )
...
export default ImportEtsyProducts
