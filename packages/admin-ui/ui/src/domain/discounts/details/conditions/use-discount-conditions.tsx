...
export const useDiscountConditions = (discount: Discount) => {
  ...
  const removeCondition = (conditionId: string) => {
    mutate(conditionId, {
      onSuccess: () => {
        notification(t("Success"), t("Condition removed"), "success")
        refetch()
      },
      onError: (error) => {
...
const getDescription = (type: DiscountConditionType, t: TFunction) => {
  switch (type) {
    case DiscountConditionType.PRODUCTS:
      return t("Discount is applicable to specific products")
    case DiscountConditionType.PRODUCT_COLLECTIONS:
      return t("Discount is applicable to specific collections")
    case DiscountConditionType.PRODUCT_TAGS:
      return t("Discount is applicable to specific product tags")
    case DiscountConditionType.PRODUCT_TYPES:
      return t("Discount is applicable to specific product types")
    case DiscountConditionType.CUSTOMER_GROUPS:
      return t("Discount is applicable to specific customer groups")
  }
}
