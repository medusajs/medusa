      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Modal.Body>
          <Modal.Header handleClose={onDismiss}>
            <h2 className="inter-xlarge-semibold">{t("Create a refund")}</h2>
          </Modal.Header>
          <Modal.Content>
            {isSystemPayment && (
            ...
            <span className="inter-base-semibold">{t("Details")}</span>
            <div className="gap-y-base mt-4 grid">
              ...
              <Controller
                name="reason"
                control={control}
                defaultValue={{ label: t("Discount"), value: "discount" }}
                rules={{ required: true }}
              ...
              <TextArea
                {...register("note")}
                label={t("Note")}
                placeholder={t("Discount for loyal customer")}
              />
            </div>
          </Modal.Content>
          <Modal.Footer>
