...
const MarkShippedModal: React.FC<MarkShippedModalProps> = ({
  ...
  const onSubmit = (data: MarkShippedFormData) => {
    ...
    let successText = t("Successfully marked order as shipped")
    let requestObj
    ...
    switch (type) {
      case "swap":
        ...
        successText = t("Successfully marked swap as shipped")
        break
      ...
      case "claim":
        ...
        successText = t("Successfully marked claim as shipped")
        break
        ...
        <Modal.Body>
          <Modal.Header handleClose={handleCancel}>
            <span className="inter-xlarge-semibold">
              {t("Mark Fulfillment Shipped")}
            </span>
          </Modal.Header>
          <Modal.Content>
            <div className="flex flex-col">
              <span className="inter-base-semibold mb-2">{t("Tracking")}</span>
                  ...
                  <Controller
                    ...
                    render={({ field }) => {
                      return (
                        <Input
                          deletable={index !== 0}
                          label={index === 0 ? t("Tracking number") : ""}
                          type="text"
            ...
            <div className="mt-4 flex w-full justify-end">
              ...
              >
                {t("+ Add Additional Tracking Number")}
              </Button>
            </div>
          </Modal.Content>
          <Modal.Footer>
