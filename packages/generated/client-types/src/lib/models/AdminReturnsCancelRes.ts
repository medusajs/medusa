...
export interface AdminReturnsCancelRes {
   ...
   * Order details.
   */
  order: Merge<SetRelation<Order, 'billing_address' | 'claims' | 'customer' | 'discounts' | 'fulfillments' | 'gift_card_transactions' | 'gift_cards' | 'items' | 'payments' | 'refunds' | 'region' | 'returns' | 'shipping_address' | 'shipping_methods' | 'swaps'>, {
    ...
    swaps: Array<Merge<SetRelation<Swap, 'additional_items' | 'fulfillments' | 'payment' | 'return_order' | 'shipping_address' | 'shipping_methods'>, {
      additional_items: Array<SetRelation<LineItem, 'variant'>>,
      fulfillments: Array<SetRelation<Fulfillment, 'tracking_links'>>,
      return_order: Merge<SetRelation<Return, 'shipping_method'>, {
        shipping_method: SetRelation<ShippingMethod, 'tax_lines'>,
