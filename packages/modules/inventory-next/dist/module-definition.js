...
const InventoryModels = __importStar(require("./models"));
const InventoryRepositories = __importStar(require("./repositories"));
const InventoryServices = __importStar(require("./services"));
const inventory_1 = __importDefault(require("./services/inventory"));
const modules_sdk_1 = require("@medusajs/modules-sdk");
const utils_1 = require("@medusajs/utils");
const migrationScriptOptions = {
    moduleName: modules_sdk_1.Modules.INVENTORY,
...
const service = inventory_1.default;
