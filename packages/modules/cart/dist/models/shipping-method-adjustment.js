...
let ShippingMethodAdjustment = class ShippingMethodAdjustment extends adjustment_line_1.default {
    ...
    onCreate() {
        this.id = (0, utils_1.generateEntityId)(this.id, "casmadj");
    }
    onInit() {
        this.id = (0, utils_1.generateEntityId)(this.id, "casmadj");
    }
...
], ShippingMethodAdjustment.prototype, "promotion_id", void 0);
__decorate([
    DeletedAtIndex(),
    (0, core_1.Property)({ columnType: "timestamptz", nullable: true }),
    __metadata("design:type", Object)
], ShippingMethodAdjustment.prototype, "deleted_at", void 0);
__decorate([
...
ShippingMethodAdjustment = __decorate([
    (0, core_1.Entity)({ tableName: "cart_shipping_method_adjustment" }),
