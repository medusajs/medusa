...
export class Migration20260525090000 extends Migration {
  ...
  override async up(): Promise<void> {
    this.addSql(`create table if not exists "auth_verification_token" ("id" text not null, "auth_identity_id" text not null, "provider_identity_id" text not null, "entity_id" text not null, "token_hash" text not null, "expires_at" timestamptz not null, "used_at" timestamptz null, "metadata" jsonb null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "auth_verification_token_pkey" primary key ("id"));`);
