...
// import type { EventBusEventsOptions } from "@zjedene-medusa/types"

// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import type { ModuleOptions } from "@zjedene-medusa/types"
...
declare module "@zjedene-medusa/types" {
  interface ModuleOptions {
    "@zjedene-medusa/event-bus-redis": EventBusRedisModuleOptions
    "@zjedene-medusa/medusa/event-bus-redis": EventBusRedisModuleOptions
  }
}
