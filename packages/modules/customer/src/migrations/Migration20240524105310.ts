...
export class Migration20240524105310 extends Migration {

  async up(): Promise<void> {
    this.addSql('CREATE UNIQUE INDEX IF NOT EXISTS "IDX_customer_email_unique" ON "customer" (email) WHERE deleted_at IS NULL;');
