...
export class Migration20240509083918_InitialSetupMigration extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table if not exists "notification" ("id" text not null, "to" text not null, "channel" text not null, "template" text not null, "data" jsonb null, "trigger_type" text null, "resource_id" text null, "resource_type" text null, "customer_id" text null, "original_notification_id" text null, "external_id" text null, "provider_id" text null, "created_at" timestamptz not null default now(), constraint "notification_pkey" primary key ("id"));');
