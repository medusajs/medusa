...
class AdminStoresResource extends BaseResource {
   ...
   */
  update(payload: AdminPostStoreReq, customHeaders: object = {}): ResponsePromise<AdminStoresRes> {
   ...
   */
  addCurrency(currency_code: string, customHeaders: object = {}): ResponsePromise<AdminStoresRes> {
   ...
   * @returns updated store
   */
  deleteCurrency(currency_code: string, customHeaders: object = {}): ResponsePromise<AdminStoresRes> {
   ...
   */
  retrieve(customHeaders: object = {}): ResponsePromise<AdminStoresRes> {
    const path = `/admin/store/`
   ...
   */
  listPaymentProviders(customHeaders: object = {}): ResponsePromise<AdminPaymentProvidersList> {
