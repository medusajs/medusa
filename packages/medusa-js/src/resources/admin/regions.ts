...
class AdminRegionsResource extends BaseResource {
   ...
   */
  create(payload: AdminPostRegionsReq, customHeaders: object = {}): ResponsePromise<AdminRegionsRes> {
   ...
   */
  delete(id: string, customHeaders: object = {}): ResponsePromise<AdminRegionsDeleteRes> {
    const path = `/admin/regions/${id}`
   ...
   */
  retrieve(id: string, customHeaders: object = {}): ResponsePromise<AdminRegionsRes> {
    const path = `/admin/regions/${id}`
   ...
   */
  list(query?: AdminGetRegionsParams, customHeaders: object = {}): ResponsePromise<AdminRegionsListRes> {
   ...
   * @returns updated region
   */
  deleteMetadata(id: string, key: string, customHeaders: object = {}): ResponsePromise<AdminRegionsRes> {
