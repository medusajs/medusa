...
class ProductVariantsResource extends BaseResource {
   ...
   * @returns AxiosPromise<StoreVariantsRes>
   */
   ...
   * @param query
   * @returns AxiosPromise<StoreVariantsListRes>
   */
  list(query?: StoreVariantsListParamsObject): AxiosPromise<StoreVariantsListRes> {
