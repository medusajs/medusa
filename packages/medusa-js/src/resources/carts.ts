...
class CartsResource extends BaseResource {
   ...
   * @return {AxiosPromise<StoreCartsCartRes>}
   */
  complete(cart_id: string): AxiosPromise<StoreCartsCartRes> {
   ...
   * @return {AxiosPromise<StoreCartsCartRes>}
   */
  create(payload?: StorePostCartReq): AxiosPromise<StoreCartsCartRes> {
   ...
   * @return {AxiosPromise<StoreCartsCartRes>}
   */
  createPaymentSessions(cart_id: string): AxiosPromise<StoreCartsCartRes> {
   ...
   * @return {AxiosPromise<StoreCartsCartRes>}
   */
  retrieve(cart_id: string): AxiosPromise<StoreCartsCartRes> {
