...
export class Migration20230713151052 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create index "IDX_product_collection_deleted_at" on "product_collection" ("deleted_at");');
    this.addSql('alter table "product_collection" add constraint "IDX_product_collection_handle_unique" unique ("handle");');

    this.addSql('create table "image" ("id" text not null, "url" text not null, "metadata" jsonb null, "deleted_at" timestamptz null, constraint "image_pkey" primary key ("id"));');
    this.addSql('create index "IDX_product_image_url" on "image" ("url");');
    this.addSql('create index "IDX_product_image_deleted_at" on "image" ("deleted_at");');
    ...
    this.addSql('create index "IDX_product_tag_deleted_at" on "product_tag" ("deleted_at");');
    ...
    this.addSql('create index "IDX_product_type_deleted_at" on "product_type" ("deleted_at");');
    ...
    this.addSql('create index "IDX_product_option_deleted_at" on "product_option" ("deleted_at");');
    ...
    this.addSql('create table "product_images" ("product_id" text not null, "image_id" text not null, constraint "product_images_pkey" primary key ("product_id", "image_id"));');
    ...
    this.addSql('create index "IDX_product_variant_deleted_at" on "product_variant" ("deleted_at");');
    ...
    this.addSql('create index "IDX_product_option_value_option_id" on "product_option_value" ("option_id");');
    this.addSql('create index "IDX_product_option_value_variant_id" on "product_option_value" ("variant_id");');
    this.addSql('create index "IDX_product_option_value_deleted_at" on "product_option_value" ("deleted_at");');
    ...
    this.addSql('alter table "product_images" add constraint "product_images_image_id_foreign" foreign key ("image_id") references "image" ("id") on update cascade on delete cascade;');
