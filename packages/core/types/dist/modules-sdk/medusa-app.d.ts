...
import { ExternalModuleDeclaration, InternalModuleDeclaration, LoadedModule, MedusaContainer, ModuleJoinerConfig, ModuleServiceInitializeOptions } from "./common";
export type RunMigrationFn = (options?: ModuleServiceInitializeOptions, injectedDependencies?: Record<any, any>) => Promise<void>;
export type MedusaModuleConfig = {
    [key: string]: boolean | Partial<InternalModuleDeclaration | ExternalModuleDeclaration>;
};
...
export type MedusaAppOutput = {
    ...
    listen?: (protocol: "http" | "grpc", port: number, options?: Record<string, any>) => Promise<void>;
};
