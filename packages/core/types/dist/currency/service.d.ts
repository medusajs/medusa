...
export interface ICurrencyModuleService extends IModuleService {
     ...
     */
    retrieve(code: string, config?: FindConfig<CurrencyDTO>, sharedContext?: Context): Promise<CurrencyDTO>;
    /**
     ...
     * ```
     */
    list(filters?: FilterableCurrencyProps, config?: FindConfig<CurrencyDTO>, sharedContext?: Context): Promise<CurrencyDTO[]>;
    /**
     ...
     * ```
     */
    listAndCount(filters?: FilterableCurrencyProps, config?: FindConfig<CurrencyDTO>, sharedContext?: Context): Promise<[CurrencyDTO[], number]>;
}
