export interface IFulfillmentProvider {
     ...
     */
    calculatePrice(optionData: Record<string, unknown>, data: Record<string, unknown>, context: Record<string, unknown>): Promise<any>;
    /**
     * @ignore
     *
     * Create a fulfillment for the given data.
     */
    createFulfillment(data: object, items: object[], order: object, fulfillment: Record<string, unknown>): Promise<Record<string, unknown>>;
    /**
     * @ignore
     *
