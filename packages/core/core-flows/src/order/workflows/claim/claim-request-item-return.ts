 ...
 * :::note
 *
 * You can retrieve an order, order claim, order return, and order change details using [Query](https://docs.medusajs.com/learn/fundamentals/query),
 ...
 * [Add Inbound Items to Claim Admin API Route](https://docs.medusajs.com/api/admin/claims/add-inbound-items).
 *
