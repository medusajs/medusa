...
const Row = React.forwardRef(({ className, ...props }, ref) => (React.createElement("tr", { ref: ref, className: clx("bg-ui-bg-base hover:bg-ui-bg-base-hover border-ui-border-base transition-fg border-b", "[&_td:last-child]:pr-6 [&_th:last-child]:pr-6", "[&_td:first-child]:pl-6 [&_th:first-child]:pl-6", className), ...props })));
Row.displayName = "Table.Row";
const Cell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("td", { ref: ref, className: clx("h-12 pr-6", className), ...props })));
...
const HeaderCell = React.forwardRef(({ className, ...props }, ref) => (React.createElement("th", { ref: ref, className: clx("txt-compact-small-plus h-12 pr-6 text-left", className), ...props })));
...
translations = {
    ...
    return (React.createElement("div", { ref: ref, className: clx("text-ui-fg-subtle txt-compact-small-plus flex w-full items-center justify-between px-3 py-4", className), ...props },
        ...
        React.createElement("div", { className: "flex items-center gap-x-2" },
            React.createElement("div", { className: "inline-flex items-center gap-x-1 px-3 py-[5px]" },
                React.createElement("p", null,
                    ...
                    " ",
                    translations.pages)),
            React.createElement(Button, { type: "button", variant: "transparent", onClick: previousPage, disabled: !canPreviousPage }, translations.prev),
            React.createElement(Button, { type: "button", variant: "transparent", onClick: nextPage, disabled: !canNextPage }, translations.next))));
});
