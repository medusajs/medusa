...
export class OrderEditService {
  ...
  public deleteItemChange(
    ...
    return this.httpRequest.request({
      method: 'DELETE',
      url: '/order-edits/{id}/changes/{change_id}',
      path: {
        'id': id,
        'change_id': changeId,
      },
  ...
  public updateLineItem(
    ...
    return this.httpRequest.request({
      method: 'POST',
      url: '/order-edits/{id}/items/{item_id}',
      path: {
        'id': id,
        'item_id': itemId,
      },
