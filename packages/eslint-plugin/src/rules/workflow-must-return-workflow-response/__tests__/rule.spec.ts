...
ruleTester.run("workflow-must-return-workflow-response", rule, {
  valid: [
    ...
    {
      code: `
        import { createWorkflow, WorkflowResponse as WR } from "@zjedene-medusa/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
    ...
    {
      code: `
        import { createWorkflow, createStep, WorkflowResponse } from "@zjedene-medusa/framework/workflows-sdk"
        createWorkflow("my-workflow", (input) => {
  ...
  invalid: [
    ...
    {
      code: `
        import { createWorkflow as cw, WorkflowResponse } from "@zjedene-medusa/framework/workflows-sdk"
