...
ruleTester.run("link-no-cross-module-relationship", rule, {
  valid: [
    ...
    // Non-framework `model` import — out of scope.
    {
      code: `
        ...
        import Other from "@zjedene-medusa/other/models/other"
  ...
  invalid: [
    // belongsTo across modules.
    {
      code: `
        import { model } from "@zjedene-medusa/framework/utils"
        import Product from "@zjedene-medusa/medusa/product/models/product"
      ...
      errors: [
        {
          ...
          data: {
            method: "belongsTo",
            name: "Product",
            source: "@zjedene-medusa/medusa/product/models/product",
          },
        },
      ],
    },
    // hasMany across modules.
    {
      code: `
        import { model } from "@zjedene-medusa/framework/utils"
        import { Customer } from "@zjedene-medusa/customer"
    ...
    // Block body with single return targeting an external import.
    {
      code: `
        import { model } from "@zjedene-medusa/framework/utils"
        import Other from "@zjedene-medusa/other"
        export default model.define("x", {
    ...
    // Aliased model import.
    {
      code: `
        import { model as m } from "@zjedene-medusa/framework/utils"
        import Foreign from "@zjedene-medusa/other/models/foreign"
      ...
      errors: [
        {
          ...
          data: {
            method: "belongsTo",
            name: "Foreign",
            source: "@zjedene-medusa/other/models/foreign",
          },
        },
      ],
    },
