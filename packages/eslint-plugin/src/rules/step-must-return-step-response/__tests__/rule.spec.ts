...
ruleTester.run("step-must-return-step-response", rule, {
  valid: [
    ...
    {
      code: `
        import { createStep, StepResponse as SR } from "@zjedene-medusa/framework/workflows-sdk"
        createStep("s", (input) => {
  ...
  invalid: [
    ...
    {
      code: `
        import { createStep as cs, StepResponse } from "@zjedene-medusa/framework/workflows-sdk"
        cs("s", (input) => {
          return input
        })
      `,
