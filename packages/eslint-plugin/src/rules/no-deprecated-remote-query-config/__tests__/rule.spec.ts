...
ruleTester.run("no-deprecated-remote-query-config", rule, {
  valid: [
    ...
    {
      code: `
        import { MedusaRequest } from "@zjedene-medusa/framework/http"
  ...
  invalid: [
    ...
    {
      code: `
        import { AuthenticatedMedusaRequest, MedusaResponse } from "@zjedene-medusa/framework/http"
    ...
    {
      code: `
        import { MedusaRequest as MReq } from "@zjedene-medusa/framework/http"
