...
ruleTester.run("medusa-context-on-context-param", rule, {
  valid: [
    ...
    {
      code: `
        import { MedusaService, MedusaContext } from "@zjedene-medusa/framework/utils"
    ...
    {
      code: `
        import { MedusaService, MedusaContext as MC } from "@zjedene-medusa/framework/utils"
        class FooService extends MedusaService({}) {
    ...
    {
      code: `
        import { MedusaContext } from "@zjedene-medusa/framework/utils"
        class OrderService {
          async list(@MedusaContext() sharedContext: Context = {}) {}
        }
      `,
