 ...
 * are exposed to consumers (e.g. `"@zjedene-medusa/no-async-workflow-constructor"`).
 *
 ...
 */
export const PLUGIN_NAMESPACE = "@zjedene-medusa"
...
export const FRAMEWORK_UTILS_SOURCE = "@zjedene-medusa/framework/utils"
export const WORKFLOWS_SDK_SOURCE = "@zjedene-medusa/framework/workflows-sdk"
export const FRAMEWORK_TYPES_SOURCE = "@zjedene-medusa/framework/types"
export const FRAMEWORK_HTTP_SOURCE = "@zjedene-medusa/framework/http"
export const LEGACY_TYPES_SOURCE = "@zjedene-medusa/types"
