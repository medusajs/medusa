 ...
 * `@zjedene-medusa/framework/utils` (honors `import { MedusaService as MS }`).
 *
 ...
 * superclass is `MedusaService(...)` (from `@zjedene-medusa/framework/utils`), **or**
 ...
 * `@zjedene-medusa/framework/utils`. Given a map of canonical imported names to
