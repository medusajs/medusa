...
export class Migration20240307130441 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table if not exists "reservation_item" ("id" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, "line_item_id" text null, "inventory_item_id" text not null, "location_id" text not null, "quantity" integer not null, "external_id" text null, "description" text null, "created_by" text null, "metadata" jsonb null, constraint "reservation_item_pkey" primary key ("id"));');
