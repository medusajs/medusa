...
var DigitalOceanService = /*#__PURE__*/function (_AbstractFileService) {
  _inherits(DigitalOceanService, _AbstractFileService);
  var _super = _createSuper(DigitalOceanService);
  function DigitalOceanService(_ref, options) {
    var _options$spaces_url, _options$download_url;
    var _this;
    _objectDestructuringEmpty(_ref);
    _classCallCheck(this, DigitalOceanService);
    _this = _super.call(this, {}, options);
    _this.bucket_ = options.bucket;
    _this.spacesUrl_ = (_options$spaces_url = options.spaces_url) === null || _options$spaces_url === void 0 ? void 0 : _options$spaces_url.replace(/\/$/, "");
  ...
  _createClass(DigitalOceanService, [{
    ...
    value: function uploadFile(file) {
      ...
      var params = {
        ACL: (_options$acl = options.acl) !== null && _options$acl !== void 0 ? _options$acl : options.isProtected ? "private" : "public-read",
        Bucket: this.bucket_,
      ...
      return new Promise(function (resolve, reject) {
        s3.upload(params, function (err, data) {
          ...
          if (_this2.spacesUrl_) {
            resolve({
              url: "".concat(_this2.spacesUrl_, "/").concat(data.Key),
              key: data.Key
            });
          }
          resolve({
    ...
    key: "delete",
    value: function () {
      var _delete2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(file) {
        var s3, params;
    ...
    value: function () {
      var _getUploadStreamDescriptor = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(fileData) {
        var pass, isPrivate, fileKey, params, s3;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              this.updateAwsConfig();
              pass = new _stream["default"].PassThrough(); // default to private
              isPrivate = typeof fileData.isPrivate === "undefined" ? true : fileData.isPrivate;
    ...
    value: function () {
      var _getDownloadStream = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(fileData) {
        var s3, params;
    ...
    value: function () {
      var _getPresignedDownloadUrl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(fileData) {
        var s3, params;
    ...
    key: "updateAwsConfig",
    value: function updateAwsConfig() {
      var additionalConfiguration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
