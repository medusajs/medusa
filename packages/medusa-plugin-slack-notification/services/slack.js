...
var SlackService = /*#__PURE__*/function (_BaseService) {
  ...
  _createClass(SlackService, [{
    ...
    value: function () {
      var _orderNotification = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(orderId) {
        var order, subtotal, tax_total, discount_total, shipping_total, total, currencyCode, getDisplayAmount, blocks, _iterator, _step, lineItem, totals, line, url;
          ...
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              return this.orderService_.retrieve(orderId, {
                ...
                relations: ["customer", "billing_address", "shipping_address", "discounts", "discounts.rule", "shipping_methods", "shipping_methods.shipping_option", "payments", "fulfillments", "returns", "gift_cards", "gift_card_transactions", "swaps", "swaps.return_order", "swaps.payment", "swaps.shipping_methods", "swaps.shipping_methods.shipping_option", "swaps.shipping_address", "swaps.additional_items", "swaps.fulfillments"]
              });
            case 2:
              order = _context.sent;
              ...
              blocks = [{
                ...
                text: {
                  type: "mrkdwn",
                  text: "Order *<".concat(this.options_.admin_orders_url, "/").concat(order.id, "|#").concat(order.display_id, ">* has been processed.")
                }
              }, {
                type: "section",
                text: {
              ...
              if (order.gift_card_total) {
                blocks.push({
                  ...
                  text: {
                    type: "mrkdwn",
                    text: "*Gift Card Total*\t".concat(getDisplayAmount(order.gift_card_total), " ").concat(currencyCode)
                  }
                });
              }
              if (this.options_.show_discount_code) {
                order.discounts.forEach(function (d) {
                  blocks.push({
                    type: "section",
                    text: {
                      type: "mrkdwn",
                      text: "*Promo Code*\t".concat(d.code, " ").concat(d.rule.value).concat(d.rule.type === "percentage" ? "%" : " ".concat(currencyCode))
                    }
                  });
                });
              }
              ...
              _iterator = _createForOfIteratorHelper(order.items);
              _context.prev = 11;
              _iterator.s();
            case 13:
              ...
              lineItem = _step.value;
              _context.next = 17;
              return this.totalsService_.getLineItemTotals(lineItem, order, {
                include_tax: true
              });
            case 17:
              totals = _context.sent;
              line = {
                type: "section",
                text: {
                  type: "mrkdwn",
                  text: "*".concat(lineItem.title, "*\n").concat(lineItem.quantity, " x ").concat(getDisplayAmount(totals.original_total), " ").concat(currencyCode)
                }
              };
              if (lineItem.thumbnail) {
                url = lineItem.thumbnail;
                if (lineItem.thumbnail.startsWith("//")) {
                  url = "https:".concat(lineItem.thumbnail);
                }
                line.accessory = {
                  type: "image",
                  alt_text: "Item",
            ...
            case 32:
              return _context.abrupt("return", _axios["default"].post(this.options_.slack_url, {
                text: "Order ".concat(order.display_id, " was processed"),
                blocks: blocks
              }));
            case 33:
            case "end":
