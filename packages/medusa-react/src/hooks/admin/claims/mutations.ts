...
export const useAdminCreateClaim = (
  ...
  return useMutation({
    mutationFn: (payload: AdminPostOrdersOrderClaimsReq) =>
...
export const useAdminUpdateClaim = (
  ...
  return useMutation({
    mutationFn: ({ claim_id, ...payload }: AdminUpdateClaimReq) =>
...
export const useAdminCancelClaim = (
  ...
  return useMutation({
    mutationFn: (claimId: string) =>
      client.admin.orders.cancelClaim(orderId, claimId),
    ...buildOptions(queryClient, adminOrderKeys.detail(orderId), options),
  })
}
 ...
 */
export type AdminFulfillClaimReq =
  AdminPostOrdersOrderClaimsClaimFulfillmentsReq & {
    /**
     * The claim's ID.
     */
...
export const useAdminFulfillClaim = (
  ...
  return useMutation({
    mutationFn: ({ claim_id, ...payload }: AdminFulfillClaimReq) =>
