...
export class addProductReview1658330229321 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "product_review" ("id" character varying NOT NULL, "product_id" character varying NOT NULL, "rating" integer NOT NULL, "body" character varying, "email" character varying NOT NULL, "name" character varying, CONSTRAINT "PK_f62d1a5c2c0c40729a944b8a52b" PRIMARY KEY ("id"))`
    )
    await queryRunner.query(
