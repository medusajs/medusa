...
import { OrderEditItem } from "./order-edit-item.tsx"
import { CreateOrderEditSchemaType } from "./schema"
...
type ExchangeInboundSectionProps = {
  ...
  form: UseFormReturn<CreateOrderEditSchemaType>
}

let itemsToAdd: string[] = []
let itemsToRemove: string[] = []

export const OrderEditSection = ({
  order,
  preview,
  exchange,
  form,
