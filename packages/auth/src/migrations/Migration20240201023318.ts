...
export class Migration20240201023318 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('alter table "auth_user" add constraint "IDX_auth_user_scope_entity_id" unique ("scope", "entity_id");');
