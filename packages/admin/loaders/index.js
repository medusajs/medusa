...
function adminLoader() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, utils_1.loadConfig)(), dev = _a.dev, path = _a.path;
                    console.log("Should open browser?", dev === null || dev === void 0 ? void 0 : dev.autoOpen, process.env.NODE_ENV === "development");
                    if (!(process.env.NODE_ENV === "development" && (dev === null || dev === void 0 ? void 0 : dev.autoOpen))) return [3 /*break*/, 2];
                    port = 9000;
