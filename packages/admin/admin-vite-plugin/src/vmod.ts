...
const RESOLVED_CELL_RENDERER_VIRTUAL_MODULE = `\0${CELL_RENDERER_VIRTUAL_MODULE}`
const RESOLVED_LAYOUT_VIRTUAL_MODULE = `\0${LAYOUT_VIRTUAL_MODULE}`
const RESOLVED_SEARCH_ENTITY_VIRTUAL_MODULE = `\0${SEARCH_ENTITY_VIRTUAL_MODULE}`
...
export type VirtualModule =
  ...
  | typeof CELL_RENDERER_VIRTUAL_MODULE
  | typeof LAYOUT_VIRTUAL_MODULE
  | typeof SEARCH_ENTITY_VIRTUAL_MODULE
