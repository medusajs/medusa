...
const PRODUCT_DETAILS_BEFORE = "virtual:medusa/widget/product/details/before"
const RESOLVED_PRODUCT_DETAILS_BEFORE = `\0${PRODUCT_DETAILS_BEFORE}`
...
const RESOLVED_VIRTUAL_MODULES = [
  ...
  RESOLVED_PRODUCT_DETAILS_BEFORE,
] as const
...
const resolvedVirtualModuleIds = {
  ...
  productDetailsBefore: RESOLVED_PRODUCT_DETAILS_BEFORE,
} as const
...
const virtualModuleIds = {
  ...
  productDetailsBefore: PRODUCT_DETAILS_BEFORE,
} as const
