import {
  CUSTOMER_CUSTOM_FIELD_DISPLAY_PATHS,
  CUSTOMER_CUSTOM_FIELD_DISPLAY_ZONES,
  CUSTOMER_CUSTOM_FIELD_FORM_CONFIG_PATHS,
  CUSTOMER_CUSTOM_FIELD_FORM_FIELD_PATHS,
  CUSTOMER_CUSTOM_FIELD_FORM_ZONES,
  CUSTOMER_CUSTOM_FIELD_LINK_PATHS,
  CUSTOMER_CUSTOM_FIELD_MODEL,
} from "./customer"
import {
...
export const CUSTOM_FIELD_MODELS = [
  PRODUCT_CUSTOM_FIELD_MODEL,
  CUSTOMER_CUSTOM_FIELD_MODEL,
] as const
