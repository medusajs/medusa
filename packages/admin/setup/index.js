...
function setupAdmin() {
    return __awaiter(this, void 0, void 0, function () {
        var _a, autoRebuild, serve, backend, outDir, path, appDir, shouldContinue, plugins;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = (0, utils_1.loadConfig)(), autoRebuild = _a.autoRebuild, serve = _a.serve, backend = _a.backend, outDir = _a.outDir, path = _a.path;
                    if (process.env.COMMAND_INITIATED_BY === "develop") {
                        admin_ui_1.logger.info("Running in development mode. Skipping setup.");
                        return [2 /*return*/];
                    }
                    if (!serve) {
                        return [2 /*return*/];
                    ...
                    appDir = process.cwd();
                    return [4 /*yield*/, (0, build_manifest_1.shouldBuild)(appDir, {
                            backend: backend,
                            path: path,
                            outDir: outDir
                        })];
