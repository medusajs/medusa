 ...
 */
export declare type ShippingOptionRequirementType = "min_subtotal" | "max_subtotal";
export declare const ShippingOptionRequirementType: {
    min_subtotal: ShippingOptionRequirementType;
    max_subtotal: ShippingOptionRequirementType;
};
