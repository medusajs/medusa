...
var checkContentTypes = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(container) {
    var contentfulService, product, variant, productFields, customProductFields, keys, missingKeys, variantFields, customVariantFields, _keys, _missingKeys;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 16:
          ...
          customProductFields = Object.keys(contentfulService.options_.custom_product_fields || {});
          keys = Object.values(productFields).map(function (f) {
            return f.id;
          });
          missingKeys = requiredProductFields.filter(function (rpf) {
            return !keys.includes(rpf) && !customProductFields.includes(rpf);
          });
        ...
        case 23:
          ...
          customVariantFields = Object.keys(contentfulService.options_.custom_variant_fields || {});
          _keys = Object.values(variantFields).map(function (f) {
            return f.id;
          });
          _missingKeys = requiredVariantFields.filter(function (rpf) {
            return !_keys.includes(rpf) && !customVariantFields.includes(rpf);
          });
          if (!_missingKeys.length) {
            _context.next = 30;
            break;
          }
...
var requiredProductFields = ["title", "variants", "options", "medusaId", "type", "collection", "tags", "handle"];
var requiredVariantFields = ["title", "sku", "prices", "options", "medusaId"];
