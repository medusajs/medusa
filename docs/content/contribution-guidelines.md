...
When the documentation page is tutorial documentation, the label in the sidebar should start with a verb. An exception to this rule is integration documentation and upgrade guides.
