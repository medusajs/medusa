---
description: 'Learn how to install the Medusa admin to use with the Medusa server. The Medusa admin gives merchants an easy-to-use interface to manage their data such as orders, products, regions, and more.'
---
