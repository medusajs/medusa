...
In addition, this document doesn't cover how to implement checkout functionality. You can follow [this document](../../modules/carts-and-checkout/storefront/implement-checkout-flow.mdx) to learn how to implement that.
