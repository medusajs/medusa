...
It is assumed you already have an order placed by a guest customer. You can refer to the [Cart](../../modules/carts-and-checkout/storefront/implement-cart) and [Checkout](../../modules/carts-and-checkout/storefront/implement-checkout-flow.mdx) implementation documentation to learn how to implement them in your storefront.
