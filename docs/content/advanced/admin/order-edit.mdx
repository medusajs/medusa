---
description: 'Learn how to implement order-editing features for admins using the REST APIs. Order edits can be used to make changes to an order such as adding or removing items. This guide includes how to create an order edit and move order edit to request state, among other steps.'
---
