...
This document doesn't cover what price lists are and their basics. If you’re interested to learn about that, check out [this documentation](./index.ms) instead.
