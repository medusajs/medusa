---
description: 'Learn how to create a batch job strategy in the Medusa server. Batch jobs are used to perform long tasks in the background of the server. This guide also includes how to test your batch job strategy.'
---
