---
description: 'Learn how to create a batch job strategy in the Medusa backend. This guide also includes how to test your batch job strategy.'
addHowToData: true
---
...
In this document, you’ll learn how to create a batch job strategy on your Medusa backend.
...
Make sure to replace `<YOUR_SERVER>` with the backend URL where applicable.
...
- [Import products using the Admin API](../../../modules/products/admin/import-products.mdx).
