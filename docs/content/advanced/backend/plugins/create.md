...
This section includes recommended changes to your `package.json`. You can skip any of these changes if you don’t find
...
Before contributing to the Medusa repository, please check out
