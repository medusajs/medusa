...
1. Go to the Categories page.
2. Click and hold the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1680253830/Medusa%20Docs/UI%20Icons/dots-six-light_pvyhgo.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1680253830/Medusa%20Docs/UI%20Icons/dots-six-dark_jf2tuw.png" alt="drag" /> icon next to the category you want to move. Keep holding the icon until step four.
...
4. Once you move it to the new destination, release the <UiIcon lightIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1680253830/Medusa%20Docs/UI%20Icons/dots-six-light_pvyhgo.png" darkIcon="https://res.cloudinary.com/dza7lstvk/image/upload/v1680253830/Medusa%20Docs/UI%20Icons/dots-six-dark_jf2tuw.png" alt="drag" /> icon.
