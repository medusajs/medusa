...
<LearningPath pathName="subscriptions" className="tw-mb-1">
  <LargeCard
    Icon={Icons['building-storefront']}
    title='Guided path to build subscription-based purchases'
  >

  Start a guided journey to implement subscription-based purchases that walks you through the steps in this document.
