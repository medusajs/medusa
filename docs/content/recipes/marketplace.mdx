...
<LearningPath pathName="marketplace" className="tw-mb-1">
  <LargeCard
    Icon={Icons['building-storefront']}
    title='Guided path to build a marketplace'
  >

  Start a guided journey to build a marketplace that walks you through the steps in this document.
