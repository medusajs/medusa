...
In the core EventBusService, a check has been introduced to only insert staged jobs i.e. fire events, if there are subscribers to it.
...
Update your event bus dependency. If you are using an official package, run one of these two commands:
