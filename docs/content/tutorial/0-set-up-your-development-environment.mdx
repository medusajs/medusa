...
If you're not interested in installing the optional tools and want to get started quickly, check out the [quickstart guide](../core/backend/install.mdx).
...
After installing PostgreSQL, check out the [Configure your Backend documentation](../usage/configurations.md#postgresql-configurations) to learn how to configure PostgreSQL to work with Medusa.
...
After installing Redis, check out the [Configure your Backend documentation](../usage/configurations.md#redis) to learn how to configure Redis to work with Medusa.
...
- [Install Medusa server](../core/backend/install.mdx)
