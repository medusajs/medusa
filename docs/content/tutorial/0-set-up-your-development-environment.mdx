...
## Required Tools[](https://docs.medusajs.com/tutorial/set-up-your-development-environment#required-tools)
...
## Optional Tools[](https://docs.medusajs.com/tutorial/set-up-your-development-environment#optional-tools)
