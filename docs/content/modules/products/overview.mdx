...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      ...
      description: 'Learn how to manage products as an admin.'
    }
  },
  {
    type: 'link',
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage collections as an admin.'
    }
  },
  {
    type: 'link',
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to import products into Medusa as an admin.'
    }
  },
  {
    type: 'link',
