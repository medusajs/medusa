...
Not a developer? Check out the [Discounts user guide](../../user-guide/discounts/index).
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      ...
      description: 'Learn how to manage discounts as an admin.'
    }
  },
  {
    type: 'link',
...
<DocCard item={{
    type: 'link',
    href: '/modules/discounts/discounts',
