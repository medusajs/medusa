...
It is assumed that you already have a Medusa backend installed and set up. If not, you can follow our [quickstart guide](../../../core/backend/install.mdx) to get started.
...
When you create or update a price list, you can specify one or more customer groups as conditions for the price list. You can learn how to do that in the [PriceList API documentation](../../../advanced/backend/price-lists/use-api.mdx).

---

## See Also

- [Customer Groups Overview](../customer-groups.md).
- [Use Sales Channels Admin APIs](../../../advanced/backend/sales-channels/manage-admin.mdx).