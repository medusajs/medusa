...
This flow was added starting from Medusa v1.7. You can learn more about upgrading in the [upgrade guide](../../../advanced/backend/upgrade-guides/medusa-core/1-7-0.md).
