...
const DraftOrders = () => {
  ...
  return (
    <div>
      ...
      {draft_orders && !draft_orders.length && <span>No Draft Orders</span>}
...
const UpdateDraftOrder = () => {
  const updateDraftOrder = useAdminUpdateDraftOrder(draftOrderId)
  // ...
...
const AddLineItem = () => {
  const addLineItem = useAdminDraftOrderAddLineItem(draftOrderId)
  // ...
...
const UpdateLineItem = () => {
  const updateLineItem = useAdminDraftOrderUpdateLineItem(draftOrderId)
  // ...
...
const DeleteLineItem = () => {
  const deleteLineItem = useAdminDraftOrderRemoveLineItem(draftOrderId)
  // ...
...
const RegisterPayment = () => {
  const registerPayment = useAdminDraftOrderRegisterPayment(draftOrderId)
  // ...
...
const DeleteDraftOrder = () => {
  const deleteDraftOrder = useAdminDeleteDraftOrder(draftOrderId)
  // ...
