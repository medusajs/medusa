...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage custom gift cards as an admin.'
    }
  },
  {
    type: 'link',
...
- Products: A store’s main gift card is essentially a Product.
- Carts and Checkout: Gift Cards can be used during checkout.
