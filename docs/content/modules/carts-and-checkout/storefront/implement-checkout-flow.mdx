...
- Check out available plugins for popular payment providers such as [Stripe](../../../plugins/payment/stripe.md) and [PayPal](../../../plugins/payment/paypal.md).
- [Payment Architecture](../payment.md)
- [Shipping Architecture](../shipping.md)
