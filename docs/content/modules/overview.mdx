...
<LargeCardList>
  ...
  - Associate order fulfillemnts and returns with a stock channel. The management of inventory item quantity is handled automatically.
