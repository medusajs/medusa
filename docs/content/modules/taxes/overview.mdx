...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage a taxes as an admin.',
      isSoon: true
    }
  },
]} />
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage tax rates as an admin.',
      isSoon: true
    }
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage tax overrides as an admin.',
      isSoon: true
    }
  },
  {
