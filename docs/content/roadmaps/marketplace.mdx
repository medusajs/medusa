...
This document will guide you through the different documentation resources that will help you build a marketplace with Medusa.
...
You'll also need to create migrations to reflect the changes on these entities in your database.

<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/development/entities/extend-entity',
    label: 'Step 1: Extend an Entity',
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Learn how to extend an entity in Medusa.',
    }
  },
  {
    type: 'link',
    href: '/development/entities/extend-entity',
    label: 'Step 2: Create Migrations',
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Learn how to create a migrations for your entities.',
    }
  },
]} />
...
<details>
  ...
  export class AddUserStoreId1681287255173 implements MigrationInterface {
      //...
...
<DocCard item={{
  ...
  customProps: {
    icon: Icons['academic-cap-solid'],
    html: 'Learn how to access the logged-in user throughout your project using a Middleware.',
  }
}} />
...
For example, when a new user is added, you need to ensure that it's associated either with a new store or with the store of the logged-in user. Another example is associating a new product with the logged-in user's store.

Functionalities related to each entity are created in Services. Services are classes that contain helper methods, such as retrieve or update methods. Each service is focused on a single entity. For example, the `UserService` class contains helper methods for the `User` entity.

When a new user is added using the backend's REST APIs, the endpoint uses the `UserService` to add the new user. So, to ensure that a store is associated with that user, you need to extend the `UserService` to change how the `create` method is implemented.

This process applies to the services of other entities that you associated with the `Store` entity, as well. You can also extend services if you need to customize a functionality implemented in a service for other reasons.
...
<DocCard item={{
  ...
  customProps: {
    icon: Icons['academic-cap-solid'],
    html: 'Learn how to extend a service in Medusa',
  }
}} />
...
<DocCard item={{
  ...
  customProps: {
    icon: Icons['academic-cap-solid'],
    html: 'Learn how to create a subscriber in Medusa.',
  }
}} />
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Learn how to create a payment processor.',
    }
  },
  {
    type: 'link',
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Learn how to create a fulfillment provider.',
    }
  },
]} />
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Check out available Medusa plugins to install.',
    }
  },
  {
    type: 'link',
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Check out available community plugins to install.',
    }
  },
]} />
...
<DocCardList colSize={6} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Install the Next.js Storefront to customize it.',
    }
  },
  {
    type: 'link',
    href: '/storefront/roadmap',
    label: 'Option 2: Build Storefront Roadmap',
    customProps: {
      icon: Icons['academic-cap-solid'],
      html: 'Find useful resources to build your own storefront.',
    }
  },
]} />
...
<DocCard item={{
  ...
  customProps: {
    icon: Icons['academic-cap-solid'],
    html: 'Learn how to deploy your marketplace backend to different hosting providers.',
  }
}} />
