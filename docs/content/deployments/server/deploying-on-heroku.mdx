...
Medusa requires a set of environment variables to be configured. You can learn more about Medusa's configurations in the [Configure your Medusa Server](../../development/backend/configurations.md) document.
...
To test your backend, run the following command to retrieve the server's URL:
