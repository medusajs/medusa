...
If you instead want to quickly install and setup only a Medusa backend, follow [this quickstart guide](../core/backend/install.mdx).
...
- [Learn about backend configurations](./configurations.md)
