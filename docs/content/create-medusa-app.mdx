...
Medusa is composed of three different components: a Node.js backend, the storefront, and the admin dashboard.

Developers have full freedom in how they choose to set up these components and have full ownership over their tech stack. However, if you're interested in a way to set up the three components all together, you can use the `create-medusa-app` command.
