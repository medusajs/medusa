...
If you're not interested in installing the optional tools and want to get started quickly, check out the [quickstart guide](./install.mdx).
...
- [Install Medusa server](./install.mdx)
- [Configure your Medusa server](./configurations.md).
