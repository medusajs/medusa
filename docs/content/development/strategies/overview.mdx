---
description: "Learn what a Strategy is in the Medusa Backend. A strategy is an isolated piece of business logic that can be overridden and customized."
---
...
In this document, you’ll learn what a Strategy is in the Medusa Backend.
