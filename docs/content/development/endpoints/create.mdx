...
Posts are represented by a custom entity not covered in this guide. You can refer to the [entities](../entities/create.md) for more details on how to create a custom entity.
...
`PostService` is a custom service that is not covered in this guide. You can refer to the [services](../services/create-service.mdx) documentation for more details on how to create a custom service.
...
You can refer to the [Entities](../entities/create.md) and [Services](../services/create-service.mdx) documentation to learn how to create the custom entities and services used in this example.
