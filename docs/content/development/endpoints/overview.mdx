...
In this document, you’ll learn what endpoints are in the Medusa Backend.
...
Each [Commerce Module](../../modules/overview.mdx) contains a set of endpoints specific to the functionalities that it provides. Since the Medusa Backend acts as an orchestrator of Commerce Modules and exposes their endpoints, the endpoints of each of these Commerce Modules are available within the Medusa Backend’s server.
...
As the Medusa Backend is completely customizable, developers can also extend the functionality even further to implement GraphQL endpoints.
...
<DocCardList colSize={6} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to add a middleware in the Medusa Backend.'
    }
  },
]} />