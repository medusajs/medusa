...
<DocCardList colSize={4} items={[
  ...
  {
    type: 'link',
    href: '/medusa-react/overview#custom-hooks',
    label: 'Medusa React: Custom Hooks',
    customProps: {
      icon: Icons['tools-solid'],
      description: 'Learn about the new utility function that allows you to create hooks for custom endpoints.',
      badge: {
        variant: 'blue',
        children: 'New'
      }
