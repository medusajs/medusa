...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      ...
      description: 'Create your first Medusa server in three steps.',
      className: 'card-highlight'
    }
  },
  {
    type: 'link',
    href: '/tutorial/0-set-up-your-development-environment',
    ...
    customProps: {
      ...
      description: 'Set up your environment to efficiently use Medusa.'
    }
  },
  {
    type: 'link',
    ...
    customProps: {
      ...
      description: 'Explore the different configurations you can use.'
    }
  },
  {
    type: 'link',
...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      ...
      description: 'Bulk import products into your Medusa server.'
    },
  },
  {
    type: 'link',
