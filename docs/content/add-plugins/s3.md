---
description: 'Learn how to integrate S3 with the Medusa server. Learn how to configure and use S3 to store images related to the Medusa server. Learn how to install the S3 plugin on the Medusa server.'
---
