...
Additionally, you need a Medusa backend installed and set up. If not, you can follow the [quickstart guide](../core/backend/install.mdx) to get started.
