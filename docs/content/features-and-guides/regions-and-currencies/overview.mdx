...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/features-and-guides/regions-and-customers/admin/manage-regions',
...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/features-and-guides/regions-and-customers/storefront/use-regions',
...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/features-and-guides/regions-and-customers/regions',
