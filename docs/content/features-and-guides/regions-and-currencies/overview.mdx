...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/features-and-guides/regions-and-currencies/admin/manage-regions',
...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/features-and-guides/regions-and-currencies/storefront/use-regions',
...
Learn how Regions and Currencies are built, their relation to other components in your Medusa server, and more.

<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/features-and-guides/regions-and-currencies/regions',
