...
<DocCardList colSize={4} items={[
  ...
  },
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage customers as an admin.'
    }
  },
  {
    type: 'link',
...
Customers can be segmented or assigned to different customer groups. This can be useful for marketing purposes.

For example, you can specify a different pricing or special discounts for specific customer groups.
...
<DocCardList colSize={4} items={[
  {
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage customer groups as an admin.'
    }
  },
  {
    type: 'link',
...
Learn how Customer-related entities are built, their relation to other components in your Medusa server, and more.
...
Discover Customers’ relation to other components in Medusa.
