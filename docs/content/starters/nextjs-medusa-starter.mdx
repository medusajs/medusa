...
This document assumes you already have a Medusa backend installed. If you don’t, please follow the [Quickstart guide for the Medusa server](../development/backend/install.mdx) to learn how to do it.
