...
This method is used to delete products. Unlike the [softDelete](../product.IProductModuleService.softDelete/page.mdx) method, this method will completely remove the products and they can no longer be accessed or retrieved.
