...
slug: /references/auth/listAndCount
sidebar_label: listAndCount
---

import { TypeList } from "docs-ui"

# listAndCount - Auth Module Reference

This documentation provides a reference to the `listAndCount` method. This belongs to the Auth Module.
