...
Medusa ships as a set of commerce modules and tools that allows you to build rich, reliable, and performant commerce applications without reinventing core commerce logic. The modules can be customized and used to build advanced ecommerce stores, marketplaces, or any product that needs foundational commerce primitives. All modules are open source and freely available on NPM.
...
You can view the roadmap with features that are planned, started, and completed in the [Roadmap discussion](https://github.com/medusajs/medusa/discussions/categories/roadmap).

Follow the [Upgrade Guides](https://docs.medusajs.com/advanced/backend/upgrade-guides/) to keep your Medusa project up-to-date.

Check out all [our available plugins](https://medusajs.com/plugins/) for your Medusa server.
...
Join the [Discord](https://discord.com/invite/medusajs) to meet other community members.
