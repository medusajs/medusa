 ...
 *   update_order_email:
 *     type: boolean
 *     title: update_order_email
 *     default: false
 *     description: Whether to update the order's email to the email of the customer the order is being transferred to. By default, the order's email will not be updated.
 * 
*/
