...
<PermissionsBadge permissions={["customer:create"]} />
...
<PermissionsBadge permissions={["customer:update"]} />
...
<PermissionsBadge permissions={["customer:update", "customer_address:create"]} />
...
<PermissionsBadge permissions={["customer:update", "customer_address:delete"]} />
...
<PermissionsBadge permissions={["customer:delete"]} />
