...
<PermissionsBadge permissions={["reservation_item:read"]} />
...
<PermissionsBadge permissions={["reservation_item:read", "inventory_item:read", "inventory_level:read", "stock_location:read"]} />
...
<PermissionsBadge permissions={["reservation_item:read", "inventory_item:read", "inventory_level:read", "stock_location:read", "reservation_item:update"]} />
