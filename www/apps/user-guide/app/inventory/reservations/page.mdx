...
To view reservations, go to Inventory from the sidebar, then click the Reservations sub-item shown in the sidebar. You can also use the keyboard shortcut <Kbd>G</Kbd> then <Kbd>R</Kbd> to navigate directly to the Reservations page.
