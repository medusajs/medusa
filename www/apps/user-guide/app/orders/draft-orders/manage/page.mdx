...
4. In the form that opens:
    ...
    - To edit an existing item, click the <InlineIcon Icon={PencilSquare} alt="pencil" /> button in the item's row. This will allow you to change the item's quantity, price, and add custom metadata fields to store additional information about the item.
