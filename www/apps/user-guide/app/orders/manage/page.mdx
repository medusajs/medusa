...
<PermissionsBadge permissions={["reservation_item:create"]} />
...
<PermissionsBadge permissions={["order_address:update", "order:update"]} />
...
<PermissionsBadge permissions={["customer:update", "order:update"]} />
