...
For many activities, you can also see who performed the action (such as which user created a fulfillment or processed a refund). When viewing order edits, you can hover over the "Added" or "Removed" labels to see detailed information about which specific items and quantities were changed.
