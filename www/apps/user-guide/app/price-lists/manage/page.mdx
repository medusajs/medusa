...
<PermissionsBadge permissions={["price_list:read"]} />
...
This will open the price list's details page. The "Configuration" section also shows the price list's customer availability, which requires the `customer_group:read` policy to view.
...
<PermissionsBadge permissions={["price_list:update"]} />
...
<PermissionsBadge permissions={["price_list:update", "customer_group:read"]} />

A price list's configurations include the start and expiry dates, and customer availability. Browsing customer groups to set the customer availability requires the `customer_group:read` policy.
...
<PermissionsBadge permissions={["price_list:update", "product:read"]} />
...
<PermissionsBadge permissions={["price_list:delete"]} />
