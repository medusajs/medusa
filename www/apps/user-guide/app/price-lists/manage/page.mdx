...
4. In the side window that opens, you can edit the start and expiry dates and the customer groups that the price list applies to.
    - To change the operator, select **In** to apply the price list to customers in the selected groups, or **Not in** to apply it to all customers except those in the selected groups.
