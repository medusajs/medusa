...
<PermissionsBadge permissions={["product_collection:read"]} />
...
<PermissionsBadge permissions={["product_collection:create"]} />
...
<PermissionsBadge permissions={["product_collection:update"]} />
...
<PermissionsBadge permissions={["product:read", "product:update", "product_collection:update"]} />
...
<PermissionsBadge permissions={["product:update", "product_collection:update"]} />
...
<PermissionsBadge permissions={["product_collection:delete"]} />
