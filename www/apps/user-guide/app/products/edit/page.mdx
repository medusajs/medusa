...
<PermissionsBadge permissions={["product:read"]} />
...
<PermissionsBadge permissions={["product:update"]} />
...
<PermissionsBadge permissions={["product:delete"]} />
...
<PermissionsBadge permissions={["product:update", "product_variant:update"]} />
...
<PermissionsBadge permissions={["product:update", "product_option:create"]} />
...
<PermissionsBadge permissions={["product:update", "product_option:update"]} />
...
<PermissionsBadge permissions={["product:update", "product_option:delete"]} />
...
<PermissionsBadge permissions={["product:read", "product_variant:read"]} />
