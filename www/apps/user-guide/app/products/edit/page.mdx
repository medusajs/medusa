...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        The product is available on the storefront and can be purchased.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        A product whose details you're still working on. It's not available on the storefront.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        A product that is not yet approved for publishing. It's not available on the storefront.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        A product that has been rejected and is not available on the storefront.
      </Table.Cell>
    </Table.Row>
  </Table.Body>
</Table>
...
## Manage Product's Options

<Note>

As of [Medusa v2.16.0](https://github.com/medusajs/medusa/releases/tag/v2.16.0), product options can be managed globally and re-used across products. If you don't see the Product → Options page in the sidebar, request your technical team to [upgrade your Medusa application](!docs!/learn/update).

</Note>

The Options section includes the product's [options](../options/page.mdx). Use this section to view and edit the product's options.
...
Product options can be defined globally from the [Product → Options](../options/page.mdx) page, or can be specific to this product.

To manage the product's options:

1. Click the <InlineIcon Icon={EllipsisHorizontal} alt="three-dots" /> icon in the "Options" section's header.
2. Choose Manage from the dropdown.
3. In the side window that opens, you can:
    - Add existing product options by selecting them in the "Product Options" dropdown.
    - Create a product-specific option by entering a title in the "Product Options" dropdown. You can also enter the option's values separated by commas in the field shown for the new option.
    - Remove an option by clicking the <InlineIcon Icon={XMark} alt="cross" /> icon next to it.
    - Remove and add option values from the "Values" dropdown field of each option.
4. Once you're done, click the Save button.

![Manage Product Options form in the Medusa Admin dashboard](https://res.cloudinary.com/dza7lstvk/image/upload/v1765529614/User%20Guide/CleanShot_2025-12-12_at_10.53.03_2x_f8ftqv.png)
