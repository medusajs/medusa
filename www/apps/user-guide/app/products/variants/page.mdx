...
<PermissionsBadge permissions={["product:update", "product_variant:create"]} />
...
<PermissionsBadge permissions={["product:update", "product_variant:update", "price:update"]} />
...
<PermissionsBadge permissions={["product:update", "product_variant:update", "inventory_level:update"]} />
...
<PermissionsBadge permissions={["product:update", "product_variant:delete"]} />
