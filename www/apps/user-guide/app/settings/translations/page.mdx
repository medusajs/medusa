...
<PermissionsBadge permissions={["translation:create", "translation:update", "translation:delete"]} />
...
With only the `translation:read` policy, you can open the bulk editor in view mode, but the inputs are disabled and the save actions are hidden. To edit and save translations, you need the `translation:create`, `translation:update`, and `translation:delete` policies.
...
<PermissionsBadge permissions={["translation_setting:create", "translation_setting:update", "translation_setting:delete"]} />
...
<PermissionsBadge permissions={["translation:read"]} />
