...
<PermissionsBadge permissions={["store:read"]} />
...
<PermissionsBadge permissions={["store:update"]} />
...
<PermissionsBadge permissions={["store:update", "currency:read"]} />
...
<PermissionsBadge permissions={["store:update", "store_locale:read"]} />
