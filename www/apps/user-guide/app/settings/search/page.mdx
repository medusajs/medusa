...
By default, all Medusa stores have the product index. Your technical team can also have [custom search indexes](!resources!/infrastructure-modules/search/index-definitions) set up for other entities, such as brands or orders.
