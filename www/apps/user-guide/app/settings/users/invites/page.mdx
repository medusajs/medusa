...
<PermissionsBadge permissions={["invite:create", "invite:read"]} />
...
<PermissionsBadge permissions={["invite:read"]} />
...
<PermissionsBadge permissions={["invite:update"]} />
...
<PermissionsBadge permissions={["invite:delete"]} />
