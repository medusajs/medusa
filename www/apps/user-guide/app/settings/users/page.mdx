...
This feature is available since [Medusa v2.19.1](https://github.com/medusajs/medusa/releases/tag/v2.19.1). The option only appears for users whose authentication provider supports password reset (currently, `emailpass`).
