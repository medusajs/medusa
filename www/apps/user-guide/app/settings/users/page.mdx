...
Deleting a user is irreversible. Deleting a user removes their account and prevents them from signing in again, but any active sessions or tokens they hold remain valid until they expire. To immediately revoke all active sessions and tokens, ask your developer to rotate the application's secrets.
