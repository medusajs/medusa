...
For role-based access control, you can also manage [user roles](./roles/page.mdx) and [policies](./policies/page.mdx) to control what actions users can perform.
...
You can assign roles to users to control what actions they can perform in the admin dashboard.
...
1. Go to the user's details page.
2. In the Roles section, you can see all roles assigned to the user.
...
1. Go to the user's details page.
2. In the Roles section, click the Add button.
3. Select the roles you want to assign from the list.
4. Click Save.
...
1. Go to the user's details page.
2. In the Roles section, click the X button next to the role you want to remove.

<Note>

You can only assign roles that you have permission to assign. The list shows only roles you're authorized to manage.
