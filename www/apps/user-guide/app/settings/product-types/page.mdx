...
<PermissionsBadge permissions={["product_type:read"]} />
...
<PermissionsBadge permissions={["product_type:create"]} />
...
This opens the product type's details page where you can also manage the product type. To see the products assigned to the type, you also need the `product:read` policy.
...
<PermissionsBadge permissions={["product_type:update"]} />
...
<PermissionsBadge permissions={["product_type:delete"]} />
