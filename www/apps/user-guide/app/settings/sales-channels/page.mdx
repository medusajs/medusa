...
<PermissionsBadge permissions={["sales_channel:read"]} />
...
<PermissionsBadge permissions={["sales_channel:create"]} />
...
This opens the sales channel's details page where you can also manage the sales channel. To see the products in the sales channel, you also need the `product:read` policy.
...
<PermissionsBadge permissions={["sales_channel:update"]} />
...
<PermissionsBadge permissions={["sales_channel:update", "product:read", "product:update"]} />
...
<PermissionsBadge permissions={["sales_channel:update", "product:update"]} />
...
<PermissionsBadge permissions={["sales_channel:delete"]} />
