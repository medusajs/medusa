...
<PermissionsBadge permissions={["refund_reason:read"]} />
...
<PermissionsBadge permissions={["refund_reason:create"]} />
...
<PermissionsBadge permissions={["refund_reason:update"]} />
...
<PermissionsBadge permissions={["refund_reason:delete"]} />
