...
<PermissionsBadge permissions={["tax_region:read"]} />
...
<PermissionsBadge permissions={["tax_region:create"]} />
...
This opens the tax region's details page, where you can also manage the tax region. To see the region's tax rates, including the default tax rate and overrides, you also need the `tax_rate:read` policy.
...
<PermissionsBadge permissions={["tax_region:update"]} />
...
<PermissionsBadge permissions={["tax_region:update", "tax_rate:update"]} />
...
<PermissionsBadge permissions={["tax_region:update", "tax_rate:create"]} />
...
<PermissionsBadge permissions={["tax_region:delete"]} />
...
This opens the sublevel tax region's details page, where you can also manage the sublevel tax region. To see its tax rates, you also need the `tax_rate:read` policy.
