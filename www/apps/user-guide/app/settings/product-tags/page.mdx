...
<PermissionsBadge permissions={["product_tag:read"]} />
...
<PermissionsBadge permissions={["product_tag:create"]} />
...
This opens the product tag's details page where you can also manage the product tag and its metadata. To see the products assigned to the tag, you also need the `product:read` policy.
...
<PermissionsBadge permissions={["product_tag:update"]} />
...
<PermissionsBadge permissions={["product_tag:delete"]} />
