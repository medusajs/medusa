...
export default {
  ...
  content: `- The Cloud dashboard now uses the global sidebar layout exclusively. The option to switch between navigation styles has been removed, and the **Navigation Style** section is no longer available in Profile settings. Previously, users could toggle between a classic top-navigation mode and the global sidebar.
