...
export default {
  ...
  title: "Medusa Search",
  summary:
    "Medusa Search is available on Cloud. In addition, Domain pages show provisioning failure alerts, and the database page gains a read-access toggle and credential rotation.",
