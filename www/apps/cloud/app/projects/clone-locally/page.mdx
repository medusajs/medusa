...
For the storefront, create a `.env` file in its directory with the variables its framework expects. Refer to the starter's `.env.template` file for the list of variables.
...
To run the storefront, refer to the starter's README file in the repository. It has the commands and variables specific to the storefront's framework.
