...
1. Package manager: Cloud supports `npm`, `yarn` (v1, v3, and v4), and `pnpm` as package managers. Note that `pnpm` requires additional workspace configuration as shown in the [Docker installation guide](!docs!/learn/installation/docker).
