...
5. In the modal that opens, select the GitHub installation and then choose the new repository.
6. Click **Save Changes**.

<Note>

**Save Changes** is disabled until you select a repository. If GitHub is not connected or no installation is available, connect GitHub first from the same Connections settings page.
...
<Note type="warning" title="Danger">
  Deleting the storefront is irreversible. This action permanently removes the storefront associated with the project.
</Note>

If your project has a storefront deployed, you can permanently delete it from the project settings. The **Delete** button is disabled when no storefront exists on the project.

To delete the storefront:

1. Open the project's dashboard.
2. Click on the **Settings** tab.
3. In the **General** tab of the Settings page, scroll to the **Delete Storefront** section.
4. Click the **Delete** button.
5. Confirm the deletion by entering the verification phrase in the confirmation prompt, then click **Delete**.
