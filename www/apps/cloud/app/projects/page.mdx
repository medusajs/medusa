...
You can quickly clone a starter template with a single click using the one-click cloning system:
...
3. In the modal that opens:
   - **GitHub Installation**: If you haven't connected your GitHub account yet, you'll be prompted to install the Medusa GitHub App and authenticate.
   - **Repository Selection**: Choose a GitHub organization to clone the starter into.
   - **Repository Name**: Enter a name for your new repository. If the name conflicts with an existing repository, you'll be prompted to choose a different name.
4. Click **Create Repository** to start the cloning process.
...
You can monitor the progress through different phases:
- **Creating repository**: The template is being cloned to your GitHub account
- **Creating project**: Cloud is setting up your project resources

Once complete, you'll automatically move forward to the [Configure step](#configure-project-during-creation).

### Manual Template Setup

If the one-click cloning encounters issues, you can fall back to the traditional project creation flow by manually creating a repository from the template and then [creating a project from an existing application](#2-create-project-from-an-existing-application).
