...
If you have an empty organization with no projects, you'll also see an [AI agent prompt section](#ai-agent-prompt-section) at the top of the page to help you get started with AI coding assistants.

---

## AI Agent Prompt Section

If your organization doesn't have any projects yet, you'll see a prominent AI agent prompt section at the top of the project creation page. This section provides you with a copyable command prompt designed for AI coding assistants.

The section displays icons for popular AI coding tools including Claude Code, Cursor, Codex, Copilot, Gemini CLI, and OpenCode. You can copy the AI prompt command with a single click to get started quickly with your preferred AI assistant.

The section also includes a link to "How it works" documentation to learn more about using AI agents with Cloud.

---

## 1. Create Project from a Starter

Medusa provides multiple starter templates that you can use to quickly set up your ecommerce application. The main project creation page shows the first two starter templates by default:
...
Additional starter templates are available when you browse all starters, including:

- **Configurable Products Starter**: Template for products with configurable options and variants.
- **Modern DTC Starter**: Contemporary direct-to-consumer storefront with modern design patterns.
- **Industrials B2B Starter**: Specialized template for industrial B2B commerce scenarios.
- **Quiz-to-Product Starter**: Interactive template that guides customers through product selection via quiz functionality.
- **Fashion Starter**: Template tailored for fashion and apparel retailers.
- **Bold DTC Starter**: Eye-catching direct-to-consumer template with bold design elements.

All starters come with a pre-configured Medusa server, admin dashboard, and storefront. Each template includes preview links and themed images to help you understand the template's purpose and styling.

To create a project from any of these starters:

1. Click on the **Browse Starters** button or **Browse all starters** link on the [project creation page](#create-a-project).
