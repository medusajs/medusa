...
2. If you have no projects, you can create a project either through the [guided get started flow](../get-started/page.mdx) or by clicking on the **Create Project** button in your organization's dashboard.
   - The [get started flow](../get-started/page.mdx) provides three streamlined onboarding paths: AI-assisted project creation, starter template selection, or GitHub repository import.
3. Click on the **Create Project** button in your organization's dashboard if you prefer the standard project creation process.
...
3. If GitHub is not connected, you'll be directed to the new project form to set up the repository connection.
