...
Medusa provides you with starter templates that you can use to quickly set up your ecommerce application. These templates include:

- **Essentials Starter** (formerly Fashion starter): Standard Medusa application with fully-fledged commerce features.
- **Uncut Coffee Starter** (formerly Bold DTC starter): Feature-rich ecommerce template for direct-to-consumer brands.
- **Grounded Starter** (formerly Modern DTC starter): Modern ecommerce starter optimized for performance and user experience.
- **B2B Starter**: Medusa application with powerful B2B and commerce features.

All starters come with a pre-configured Medusa server, admin dashboard, and support both Next.js and TanStack Start frameworks for the storefront.
...
2. Browse through the available templates in either the featured section or the complete template gallery.
3. Click on any template card to view detailed information about that template.

### Template Details Modal

When you click on a template card, a detailed modal opens showing:

- Large hero image of the template
- Template name and tagline
- Detailed description of features and use cases
- Framework information (Next.js or TanStack Start with corresponding icons)
- Comprehensive features checklist
- Live preview and clone options
- Information about which organization the template will be cloned to

### Clone Template

To clone your selected template:

1. From the template details modal, click the **Clone Starter** button.
...
6. In the **AI Development Assistant** section, you can access integration instructions for AI agents:
    - **Prompt Tab**: Displays a copyable text prompt optimized for AI agents, with support for agents including Claude Code, Cursor, Codex, Copilot, Gemini CLI, and OpenCode.
    - **MCP Tab**: Provides integration snippets for different development environments (Claude, Cursor, VS Code, OpenCode) with configuration formats for connecting to Medusa's Model Context Protocol server.
    - **Skills Tab**: Offers installation commands for AI agent skills, with separate options for Claude Code users (plugin marketplace commands) and other agents (npm-based installation).
    - All tabs include copy-to-clipboard functionality and links to relevant documentation.
7. Once you're done configuring the project, click the "Create" button.
