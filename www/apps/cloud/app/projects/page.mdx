...
2. If you have no projects, you can create a project either by:
  - Copying the "Start with AI Prompt" and using it with your AI agent, such as Claude Code. This will create a project locally, push it to a new GitHub repository, and assist you in deploying it to Cloud.
  - Cloning an existing starter, as explained in the [Create Project from a Starter](#1-create-project-from-a-starter) section below.
  - Clicking "Import" to create a project from an existing application, as explained in the [Create Project from an Existing Application](#2-create-project-from-an-existing-application) section below.
