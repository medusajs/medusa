...
import { ChevronUpDown, XCircleSolid } from "@medusajs/icons"
...
## Remove Storefront from Project

You can remove a storefront from a project and only keep the Medusa backend and admin dashboard. To do that:

1. Open the project's dashboard.
2. Click on the "Settings" tab.
3. In the "General" tab of the Settings page, find the "Medusa root directory" section.
4. Click on <InlineIcon Icon={XCircleSolid} alt="remove storefront" /> next to the "Storefront root directory" input field.

This will remove the storefront from the project. Future deployments will only deploy the Medusa backend and admin dashboard.
