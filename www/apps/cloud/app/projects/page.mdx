...
3. If you haven't connected your GitHub account yet, you'll be automatically redirected to GitHub to authorize Medusa Cloud access. After authorization, you'll return to the project creation flow.
...
1. If you haven't connected your GitHub account yet, you'll be automatically redirected to GitHub to authorize Medusa Cloud access. After authorization, you'll return to the project creation flow.
