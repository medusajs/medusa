import { Note, Prerequisites, InlineIcon, getOsShortcut, Kbd } from "docs-ui"
...
2. Click **Projects** in the sidebar and select the project. This will open the project's dashboard.

When you open a project's dashboard, its name will be shown at the top left next to the [organization switcher](../organizations/page.mdx#switch-organization).
...
2. **Long-Lived Environments**: The long-lived environments for the project are shown as cards. By default, you'll find the Production environment. You can learn more about environments in the [Environments](../environments/page.mdx) guide.
    ...
    - Each environment card shows the environment's name, URLs, status, and custom domains (if configured). If an environment fails to provision, the card shows an error icon and a descriptive message instead of a loading animation.
...
To view the deployments of a project, click **Deployments** in the sidebar of the project's dashboard. This will show you a list of all deployments for the project, including their status, environment, and how long the deployment took.
...
1. [Open the project's dashboard](#open-project-dashboard).
...
1. [Open the project's dashboard](#open-project-dashboard).
2. Click **Settings** > **General** in the sidebar.
3. You can edit the project's name and root directories of the backend and storefront in the repository.
...
You can also edit a project's preview settings, which are general settings related to Previews environments, by clicking **Settings** > **Preview Settings** in the sidebar.
...
You can change the GitHub repository connected to your project from the project's general settings page. This is useful if you've moved your Medusa application to a different repository.

To change the connected repository:

1. [Open the project's dashboard](#open-project-dashboard).
2. Click **Settings** > **General** in the sidebar.
3. In the "Repository" section, click the **Change** button.
4. In the modal that opens, choose the new repository to connect.
...
1. [Open the project's dashboard](#open-project-dashboard).
2. Click **Settings** > **General** in the sidebar.
3. Enable the "Infrastructure specs" toggle.
...
5. Once you're done making changes, click the "Save changes" button next to the input field.
...
If you want to revert the infrastructure specifications of a project to use the specifications defined in your organization's plan, you can do so by disabling the "Infrastructure specs" toggle in the **Settings** > **General** page.
...
1. [Open the project's dashboard](#open-project-dashboard).
2. Click **Settings** > **General** in the sidebar.
3. Click the **Delete** button in the **Delete Storefront** section.
...
1. [Open the project's dashboard](#open-project-dashboard).
2. Click **Settings** > **General** in the sidebar.
3. Click the "Delete" button in the "Delete project" section at the bottom.
