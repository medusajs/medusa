...
You can rotate the credentials for the read-only connection string from the **Database read-only connection string** section. Click the **Rotate credentials** button, confirm the action in the dialog that opens, and Medusa generates a new read-only connection string. Update any tools or scripts that use the old connection string after rotating.
...
### Rotate Write Credentials

Organization owners can rotate the credentials for the write connection string from the **Database write-access connection string** section. Click the **Rotate credentials** button, confirm the action in the dialog that opens, and Medusa generates a new write connection string. Update any tools or scripts that use the old connection string after rotating.
