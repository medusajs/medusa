...
By default, the database connection string provided for your Cloud environments has read-only access. This is a security measure to prevent accidental modifications to your database.
