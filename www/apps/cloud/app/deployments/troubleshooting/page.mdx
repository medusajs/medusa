...
Cloud now provides enhanced error messaging and context to help distinguish between different types of failures. The logs interface offers improved error categorization and localized messages for both:

- **Build failures**: Issues during the compilation and build process
- **Deployment failures**: Problems during deployment rollout and runtime startup

This enhanced error context helps you more quickly identify the appropriate troubleshooting approach.
