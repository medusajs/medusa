...
## Next.js Storefront: Cannot Find Module @opennextjs/cloudflare

If your Next.js storefront build fails with an error similar to:
...
The `bundler` resolution mode is the recommended setting for Next.js projects using modern packages with subpath exports. Refer to the [Next.js TypeScript documentation](https://nextjs.org/docs/app/api-reference/config/typescript) for more details.
