...
4. **Downgrade Medusa** — As a temporary workaround, you can downgrade your Medusa version to match the third-party package's requirement. This is not recommended long-term since you will miss out on bug fixes and new features.

<Note type="warning">

Using `--legacy-peer-deps` or downgrading Medusa may introduce compatibility issues. Always test your application thoroughly after applying either of these workarounds.
...
3. Find the failed deployment and click the <InlineIcon icon={EllipsisHorizontal} /> button to open the deployment actions menu. 
