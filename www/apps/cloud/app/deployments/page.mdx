...
The "Redeploy" button is disabled if the build's container image has been deleted. In that case, you must create a new deployment by pushing a new commit to the environment's branch.
