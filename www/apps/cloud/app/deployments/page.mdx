import { Note, Table, InlineIcon, getOsShortcut, Kbd, Tabs, TabsList, TabsTrigger, TabsContent, TabsContentWrapper } from "docs-ui"
...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    2. Click on "Deployments" in the sidebar under the project.
    3. In the search bar, search for the project you want to view its deployments, then click on it.
    4. In the Deployments list, change the **All environments** filter to "Production" to see only the deployments for the Production environment.
...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    2. Click on "Deployments" in the sidebar under the project.
    3. In the search bar, search for the project you want to view its deployments, then click on it.
    4. In the Deployments list, click on the deployment you want to view.
...
4. **Activity**: This section shows the build logs for the backend and storefront (if applicable). They are useful to understand why a deployment failed. Errors from either the backend or storefront build processes will cause the deployment to show a failed status. Learn more in the [Logs](../logs/page.mdx) guide.
