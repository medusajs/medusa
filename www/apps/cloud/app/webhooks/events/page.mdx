...
Webhook events are available on plans that include the webhooks entitlement. If your current plan does not include webhooks, you will see an upgrade prompt instead of the events table. Click **Change Plan** in the prompt to upgrade your organization's plan.
...
3. Click **Webhooks** > **Events** in the sidebar.
