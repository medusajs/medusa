      ...
      children: [
        {
          ...
          children: [
            ...
            },
            {
              name: "commit_message",
              type: "`string`",
              description: `Git commit message associated with the build.`,
            },
            {
              name: "commit_author",
              type: "`string`",
...
```json
{
  ...
  "data": {
    "build": {
      ...
      "id": "bld_01HXYZ5678ABCDEF",
      "status": "canceled"
    },
    "environment": {
      "branch": "main",
      "handle": "production",
      "id": "env_01HXYZ7890ABCDEF",
      "name": "Production"
    },
    "organization": {
...
- Medusa removed the `data.build.created_at` property on August 10, 2026. The build creation timestamp is no longer included in the payload.
- Medusa removed the `data.build.updated_at` property on August 10, 2026. The build last-updated timestamp is no longer included in the payload.
- Medusa removed the `data.organization.created_at` property on August 10, 2026. The organization creation timestamp is no longer included in the payload.
- Medusa removed the `data.organization.updated_at` property on August 10, 2026. The organization last-updated timestamp is no longer included in the payload.
- Medusa removed the `data.project.created_at` property on August 10, 2026. The project creation timestamp is no longer included in the payload.
- Medusa removed the `data.project.updated_at` property on August 10, 2026. The project last-updated timestamp is no longer included in the payload.
- Medusa removed the `data.environment.created_at` property on August 10, 2026. The environment creation timestamp is no longer included in the payload.
- Medusa removed the `data.environment.updated_at` property on August 10, 2026. The environment last-updated timestamp is no longer included in the payload.
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              name: "commit_message",
              type: "`string`",
              description: `Git commit message of the build.`,
            },
            {
              name: "commit_author",
              type: "`string`",
...
- Medusa removed the `data.deployment.created_at` property on August 10, 2026. The deployment creation timestamp is no longer included in the payload.
- Medusa removed the `data.deployment.updated_at` property on August 10, 2026. The deployment last-updated timestamp is no longer included in the payload.
- Medusa removed the `data.build.status` property on August 10, 2026. The build status is no longer included in deployment event payloads.
- Medusa removed the `data.build.created_at` property on August 10, 2026. The build creation timestamp is no longer included in the payload.
- Medusa removed the `data.build.updated_at` property on August 10, 2026. The build last-updated timestamp is no longer included in the payload.
- Medusa removed the `data.organization.created_at` property on August 10, 2026. The organization creation timestamp is no longer included in the payload.
- Medusa removed the `data.organization.updated_at` property on August 10, 2026. The organization last-updated timestamp is no longer included in the payload.
