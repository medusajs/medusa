...
You can also upload files using Medusa's [Upload Files API route](!api!/admin/uploads/upload-files), or in a [custom API route that handles file upload](!docs!/learn/fundamentals/api-routes/parse-body#configure-file-uploads).
