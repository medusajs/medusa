...
- **Medusa Search**: Power your storefront's search with full-text and vector search using [Medusa Search](./search/page.mdx), without managing a search engine yourself. Full-text search is available for all plans, and vector search for the Scale and Enterprise plans.
...
- **Docs MCP Server**: Access the [Medusa documentation MCP server](!docs!/learn/introduction/build-with-llms-ai/mcp-server) in your IDE or AI tools for efficient development.
- **Dedicated Support**: Receive dedicated support from the Medusa team to help you with any issues you may encounter.
- **Agentic Support with CLI**: Use the [Cloud CLI](./cli/agents/page.mdx) to manage your Cloud resources and debug issues with AI agents like Claude Code.
- **Cloud Assistant**: Ask the [Cloud Assistant](./assistant/page.mdx) about Medusa or your projects from anywhere in the dashboard. It helps you find answers, diagnose issues, and remember important information about your projects to assist you better in the future.
- **Fix with AI**: Troubleshoot and resolve build and deployment issues with the help of the [Cloud Assistant](./deployments/fix-with-ai/page.mdx).
