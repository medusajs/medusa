...
- **Medusa Search**: Power your storefront's search with full-text and vector search using [Medusa Search](./search/page.mdx), without managing a search engine yourself. Available for all plans.
