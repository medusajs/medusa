...
You can delete payment methods that are no longer needed from your organization. Note that you cannot delete the default payment method or bank transfer payment methods.
...
If you need to remove the default payment method, first set another payment method as default, then delete the previous one.
