...
Flex Budget Alerts are available for paid plans only.

</Note>

You can set a spending threshold at which Medusa Cloud will send you an alert. This helps you monitor your Flex Usage costs before they grow unexpectedly.

To set a Flex Budget Alert:

1. [Open the organization's settings](../organizations/page.mdx#view-organization-settings).
2. Click on "Billing" from the sidebar.
3. Scroll to the **Flex Budget Alert** section.
4. In the **Alert amount** field, enter the monetary threshold at which you want to receive an alert. Leave the field empty to remove any existing alert.
