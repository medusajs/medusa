...
1. [Open the organization's settings](../organizations/page.mdx#view-organization-settings).
2. Click on "Details" under "Billing" in the sidebar.
3. Scroll to the "Flex budget alert" section.
4. In the "Monthly flex budget" field, enter the monetary threshold at which you want to receive an alert. The value is in USD. Leave the field empty to remove any existing budget alert.
