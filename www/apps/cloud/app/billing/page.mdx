...
## View Plan Status and Upcoming Changes

In the billing section, you can view your organization's current plan and any scheduled plan changes. When you have a pending plan change (such as a cancellation or upgrade/downgrade), you'll see both your current plan and your target plan for the next billing cycle.

If you've scheduled a plan change, the billing interface will show you what plan you'll be on after the current billing period ends, providing visibility into upcoming changes before they take effect.
