...
4. In the "Upcoming payment" section, click the **Change plan** button.
5. In the modal that opens, choose either to upgrade to the Launch or Scale plan or downgrade to the Develop plan.
    - To upgrade to the Enterprise plan, contact support for assistance.
6. Confirm the plan change in the pop-up by clicking the **Confirm** button.
...
2. Make sure you're on the projects overview page of the organization. You can do this by clicking on the organization name at the top left of the dashboard.
3. Click **Settings** > **Billing** in the sidebar to open the organization's billing settings.
4. Scroll down to the "Cancel subscription" section and click the **Cancel subscription** button.
5. In the cancellation form, select a reason for cancelling from the available options.
6. Answer the follow-up question that appears based on your selected reason.
7. Click the **Cancel Subscription** button to confirm the cancellation.
