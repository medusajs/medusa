...
6. In the cancellation form, select a reason for cancelling from the available options.
7. Answer the follow-up question that appears based on your selected reason.
8. Click the "Cancel" button to confirm the cancellation.

To dismiss the form without cancelling, click the "Keep using" button.

Upon successful cancellation, your organization is downgraded to the free plan.