...
The get started flow is designed for new organizations with no existing projects, providing clear paths to get your Medusa application up and running on Cloud.

## Onboarding After Sign Up

After you [sign up](../sign-up/page.mdx), you'll reach the onboarding experience with three guided paths:
