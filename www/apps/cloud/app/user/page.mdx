...
3. This will open the Profile page. You can edit your first and last name and email address.
...
2. Click **Account** > **Authentication** in the sidebar to open the account's authentication settings.
