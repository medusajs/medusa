...
By default, the **Develop** plan is selected. This plan is minimal and allows you to deploy a single Medusa application that is suitable for development and testing purposes.
...
After you sign up, the next step is to create your first project. Medusa guides you based on the path that works best for you, with options for AI-assisted project creation.

Refer to the [Create your First Project guide](../first-project/page.mdx) to learn more.
