...
For custom domain metrics, different colors are used to distinguish between domain types: custom domain storefront appears in teal, custom domain backend in pink, and custom domain email in gray.
