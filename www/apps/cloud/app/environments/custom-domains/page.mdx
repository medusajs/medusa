...
Backend custom domains are available for Scale and Enterprise plans only. This feature is not available for Develop plans. Learn more about plan features on the [pricing page](../../pricing/page.mdx).
...
Storefront custom domains are available for Launch, Scale, and Enterprise plans only. This feature is not available for Develop plans. Learn more about plan features on the [pricing page](../../pricing/page.mdx).
