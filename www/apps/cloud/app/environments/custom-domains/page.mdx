...
You can trigger an immediate DNS check at any time instead of waiting for the next automatic check by clicking the **Verify** button at the top right of the DNS configuration detail page.
...
If you've updated your DNS records and want to trigger an immediate check, open the DNS configuration detail page for your domain and click the **Verify** button. This manually starts a fresh DNS check instead of waiting for the next automatic check. To restart the verification process from the beginning, click **Restart Verification**.
...
2. **Re-verify**: Click the **Verify** button on the DNS configuration detail page to trigger a fresh check, or click **Restart Verification** to restart the verification process from the beginning.
