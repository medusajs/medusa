...
If you have a storefront deployed alongside your Medusa backend, you need to manually update the backend URL in your storefront's configuration to point to the new custom domain. This is essential to avoid downtime for your storefront before the backend custom domain is activated.
