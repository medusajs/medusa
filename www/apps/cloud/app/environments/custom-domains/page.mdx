...
1. Go to your project's dashboard in Cloud.
2. Click on the environment card where you want to remove the custom domain.
3. Click the **Domains** tab.
4. Click the <InlineIcon Icon={EllipsisHorizontal} alt="three-dots" /> icon on the domain card you want to remove.
5. Select **Remove domain** from the dropdown menu.
