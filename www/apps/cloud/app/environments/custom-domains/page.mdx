...
If you've updated your DNS records and want to trigger an immediate check, open the DNS records detail page for your domain and click the **Re-verify** button. This manually starts a fresh DNS check rather than waiting for the next automatic check.

### Diagnose DNS Record Issues

On the DNS records detail page, you can expand individual rows in the DNS records table to reveal troubleshooting details for that record. Expanding a row shows:
