...
3. Click **Domains** in the environment sidebar.
...
- **Failed**: DNS verification failed. Use the **Re-verify** button on the DNS detail page to retry.
...
You can trigger an immediate DNS check at any time instead of waiting for the next automatic check by clicking the **Re-verify** button at the top right of the DNS configuration detail page.

### Remove Custom Domain

You can remove a custom domain directly from the DNS configuration detail page by clicking the action menu and selecting **Remove domain**.
...
In the **Domains** section of your environment sidebar, each custom domain is shown as a card with its domain name and DNS verification status. Click a domain card to open its DNS configuration detail page.
...
1. Click **Domains** in the environment sidebar and find the domain you want to remove.
2. Click the domain card to open its DNS configuration detail page.
3. Open the action menu and select **Remove domain**.
...
If you've updated your DNS records and want to trigger an immediate check, open the DNS configuration detail page for your domain and click the **Re-verify** button. This manually starts a fresh DNS check instead of waiting for the next automatic check.
...
2. **Re-verify**: Click the **Re-verify** button on the DNS configuration detail page to trigger a fresh check.
