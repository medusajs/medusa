...
If you've updated your DNS records and want to trigger an immediate check, open the DNS records detail page for your domain and click the **Reverify records** button. This manually starts a fresh DNS check rather than waiting for the next automatic check.

### Diagnose DNS Record Issues

On the DNS records detail page, you can click the <InlineIcon Icon={TriangleRightMini} alt="expand" /> icon in any row in the DNS records table to reveal troubleshooting details for that record. This shows:
...
2. **Re-verify**: Click the **Re-verify** button on the DNS records detail page to trigger a fresh check.
