...
4. Click **Rules** in the sidebar under the environment's section.
5. In the **Linked Branch** section, click the <InlineIcon Icon={PencilSquare} alt="pencil" /> icon to change the branch.
6. In the side window that opens, enter the name of the branch you want to link to the environment.
...
In the environment's **Database & Storage** settings, you can export a database dump of the environment. This is useful for backing up the environment's data, debugging issues, or migrating the data to another environment.
...
1. In the [environment's dashboard](#open-environment-dashboard), click **Rules** in the sidebar.
...
1. In the environment's dashboard, click **Rules** in the sidebar.
