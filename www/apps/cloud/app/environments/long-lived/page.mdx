...
2. In the environment's dashboard, click on the **Environment variables** tab.
...
In the environment's **Environment variables** tab, you can manage the environment variables for the environment's Medusa application and storefront. Environment variables are key-value pairs that store sensitive information, such as API keys, or configurations that your application needs to run.
...
In an environment's **Deployment Rules** tab, the **Linked Branch** section shows the branch the environment deploys from.

To change the branch associated with an environment:

1. In the [environment's dashboard](#open-environment-dashboard), click on the **Deployment Rules** tab.
...
1. In the environment's dashboard, click on the **Deployment Rules** tab.
