...
2. In the side window that opens:
    ...
    - **Configuration Group** (optional): Select a compute configuration for the environment. This determines the compute tier used to run the environment. It defaults to **Develop**. The estimated cost shown in the drawer reflects the selected configuration group.
