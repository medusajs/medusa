...
The **Configuration Group** setting controls the compute tier used to run the environment. You can change it at any time from the environment's settings.

To change the configuration group for a long-lived environment:

1. In the [environment's dashboard](#open-environment-dashboard), click on the **Settings** tab.
2. In the **Configuration Group** section, select a new configuration group from the dropdown.
3. Click **Save Changes**.

A toast notification confirms whether the change was saved successfully.
