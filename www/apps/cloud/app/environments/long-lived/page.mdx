...
6. In the drawer that opens, enter the name of the branch you want to link to the environment.
...
1. In the [environment's dashboard](#open-environment-dashboard), click **Rules** in the environment's navigation.
...
1. In the environment's dashboard, click **Settings** in the environment's navigation.
2. Click the **Delete** button in the **Delete** section.
