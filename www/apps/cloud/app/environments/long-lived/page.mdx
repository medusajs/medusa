...
2. In the side window that opens:
    ...
    - **Configuration Group** (optional): Select a compute tier for the environment. The cost estimate below the form updates to reflect the selected group. By default, the environment uses the compute tier of your organization's plan. You can choose a lighter tier to reduce costs, or a heavier tier for high-traffic environments.
...
2. In the environment's dashboard, click **Variables** in the sidebar.
...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    1. Make sure you're viewing the [correct organization's dashboard in Cloud](../../organizations/page.mdx#switch-organization).
    2. Click on the project in the sidebar.
    3. Click on **Overview** in the sidebar under the project.
    4. Click on the environment you want to view in the updated sidebar.
...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    1. Click on the current environment's name at the top of the sidebar to go back to the project's dashboard.
    2. Click on the environment name in the sidebar.
...
Click **Variables** in the environment sidebar to manage the environment variables for the environment's Medusa application and storefront. Environment variables are key-value pairs that store sensitive information, such as API keys, or configurations that your application needs to run.
...
To update these domains, click **Domains** in the environment sidebar. See the [Subdomains](../subdomains/page.mdx) and [Custom Domains](../custom-domains/page.mdx) guides for details.
...
In an environment's **Rules** tab, the **Linked Branch** section shows the branch the environment deploys from.

To change the branch associated with an environment:

1. In the [environment's dashboard](#open-environment-dashboard), click on the **Rules** tab.
2. In the **Linked Branch** section, click the <InlineIcon Icon={PencilSquare} alt="pencil" /> icon next to the current branch name.
3. In the side window that opens, enter the new branch name in the **Branch** field.
4. Click **Save**.
...
In the environment's **Database & Storage** tab, you can export a database dump of the environment. This is useful for backing up the environment's data, debugging issues, or migrating the data to another environment.
...
1. In the [environment's dashboard](#open-environment-dashboard), click on the **Rules** tab.
2. In the **Configuration Group** section, select the compute tier you'd like to use for the long-lived environment.
...
1. In the environment's dashboard, click on the **Rules** tab.
