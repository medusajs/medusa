...
2. In the environment's dashboard, click on the **Variables** tab.
...
In the environment's **Variables** tab, you can manage the environment variables for the environment's Medusa application and storefront. Environment variables are key-value pairs that store sensitive information, such as API keys, or configurations that your application needs to run.
