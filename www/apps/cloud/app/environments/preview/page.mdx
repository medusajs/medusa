...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    1. Go to its [project's dashboard](../../projects/page.mdx#open-project-dashboard).
    2. Click on the preview environment name in the sidebar.
...
1. In a [project's dashboard](../../projects/page.mdx#open-project-dashboard), click on the **Previews** tab.
2. This opens the shared settings page for both Backend and Storefront. You can change the view by toggling the **Backend** or **Storefront** tabs. It includes the following settings:
  ...
  - **Database base branch**: Specify which environment's database to create the preview environment's database from. By default, a new database is created from the Production environment's database. You can change this to use a different environment's database, such as Staging. If you want preview environments to use a dedicated database that isn't linked to any long-lived environment, select **Dedicated preview settings** and upload a data dump.
