...
You can manage an environment's variables in its **Variables** tab. You can manage environment variables for the environment's Medusa backend and storefront (if applicable).
