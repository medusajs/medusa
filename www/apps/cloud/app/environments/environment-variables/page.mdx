...
You can manage an environment's variables in its **Environment variables** tab. You can manage environment variables for the environment's Medusa backend and storefront (if applicable).
...
1. In the [environment's dashboard](../long-lived/page.mdx#open-environment-dashboard), click on the **Environment variables** tab.
