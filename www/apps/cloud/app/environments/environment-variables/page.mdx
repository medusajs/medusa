...
You can manage an environment's variables by clicking **Variables** in the environment sidebar. You can manage environment variables for the environment's Medusa backend and storefront (if applicable).
...
1. In the [environment's dashboard](../long-lived/page.mdx#open-environment-dashboard), click **Variables** in the sidebar.
