...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    4. In the Deployments list, change the **All environments** filter to the environment that the deployment belongs to, such as "Production".
    5. Find the deployment you want to view the build logs for and click on it.
...
Medusa Cloud provides improved error messaging and context when deployments fail. The logs section now offers better error type handling to help you quickly understand whether issues occurred during:

- **Build failures**: Problems during the compilation and build process
- **Deployment failures**: Issues during the deployment and rollout phase

This enhanced error context includes localized messages and better categorization to help you identify the right troubleshooting steps more efficiently.
...
<Tabs defaultValue="classic">
  ...
  <TabsContentWrapper>
    ...
    1. Make sure you're viewing the [correct organization's dashboard in Cloud](../organizations/page.mdx#switch-organization).
    2. Click on "Logs" in the sidebar under the environment.
    3. In the search bar, search for the project you want to view its logs, then click on it.
