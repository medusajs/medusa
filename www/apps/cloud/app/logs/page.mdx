...
For storefront deployments, logs are further categorized into separate build and deployment phases to provide clearer visibility into each stage of the storefront lifecycle.
...
- **Storefront deployment logs**: If you deployed a storefront, these logs show the deployment phase separate from the build phase, providing clearer insight into which stage succeeded or failed.
