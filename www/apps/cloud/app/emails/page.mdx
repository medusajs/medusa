...
The detail page shows the DNS records for each section (DKIM, SPF, and DMARC) with an inline status indicator showing whether verification succeeded, failed, or is still in progress.
