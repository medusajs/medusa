...
You can trigger an immediate DNS check at any time instead of waiting for the next automatic check by clicking the **Verify** button at the top right of the domain detail page.
