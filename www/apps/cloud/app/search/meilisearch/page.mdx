...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        Hybrid search that blends text and vector results by a semantic ratio, on the Scale and Enterprise plans, with embeddings Medusa Search can create for you on the Enterprise plan.
      </Table.Cell>
      <Table.Cell>
