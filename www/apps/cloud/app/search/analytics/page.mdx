...
Use it to see the natural-language phrases that keyword search can't match, and to decide which of them deserve their own fields or synonyms in the [index definition](!resources!/infrastructure-modules/search/index-definitions).
