...
export const definitionHighlights = [
  ["29", "title", "Outweighs the description in relevance."],
  ["32", "thumbnail", "Held by the index, but never searched or filtered."],
  ["33", "status", "Lets the Store Search API route scope the index to published products."],
  ["37", "categories", "An array of objects, so a filter matches any category."],
  ["43", "facetable", "Powers the storefront's category filter counts."],
]
