...
When working with AI agents in project templates, Medusa Cloud provides an improved prompt interface with interactive copy functionality. 

The agent instructions section now features clickable icons for different AI agents including:

- **Claude Code**: Optimized instructions for Claude-based development
- **Cursor**: Instructions tailored for Cursor IDE integration  
- **Codex**: OpenAI Codex-specific prompt templates
- **Copilot**: GitHub Copilot integration guidelines
- **Gemini CLI**: Google Gemini command-line instructions
- **OpenCode**: Open-source AI development prompts

Each agent icon is now clickable and provides:

- **Individual copy functionality** for agent-specific instructions
- **Tooltip confirmation** when prompts are successfully copied
- **Analytics tracking** to help improve prompt effectiveness

This enhancement makes it easier to quickly copy the right instructions for your preferred AI development environment.
