...
Retrieve a single environment by its ID or handle. This is useful if you want to retrieve the environment's details, such as its status or tracked branch.
...
<CodeTabs group="cli-output">
  ...
  Type:            production
  Status:          ready
  Medusa domain:   https://trusting-soft-form.medusajs.app
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID or handle of the environment to redeploy.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID or handle of the environment to build.
