...
List all projects in an organization. If you don't specify an organization, either through the `--organization` flag or the [active context](../use/page.mdx), the command lists projects across all organizations you have access to, grouped by organization.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      `-p <id-handle-or-name>`, `--project <id-handle-or-name>`
