...
Retrieve a single organization by its ID, handle, or name. Returns the organization's metadata, subscription details, and members.
...
<CodeTabs group="cli-output">
  ...
  Members (3):
    ...
    alice@example.com  Alice Example  mem_01ABC  Aug 30, 2024, 12:07 PM GMT+3
    bob@example.com    Bob Example    mem_01DEF  Aug 30, 2024, 12:10 PM GMT+3
    carol@example.com  Carol Example  mem_01GHI  Aug 30, 2024, 12:15 PM GMT+3
  ```
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The ID, handle, or name of the organization to retrieve.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      `-o <id-handle-or-name>`, `--organization <id-handle-or-name>`

      </Table.Cell>
      <Table.Cell>

      The ID, handle, or name of the organization to retrieve. Interchangeable with the positional argument.
