...
- `mcloud deployments get` now displays deployment details in a key-value format instead of a horizontal table, with updated field labels (e.g. "Started at", "Updated at")
