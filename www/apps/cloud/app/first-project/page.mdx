...
2. Browse the list of starters to find the store that fits your use case. The templates page features an improved layout with navigation controls that remain visible when scrolling through longer template lists.
