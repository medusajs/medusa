...
1. In the onboarding page, click on the "AI Tools" card with the wand sparkle icon.
2. This opens an AI Tools drawer with various AI-powered assistance tools available for project setup.
3. Browse the available tools and select the ones that match your project needs.
4. Follow the tool-specific instructions to integrate AI assistance into your development workflow.

The AI Tools option is ideal for developers who want to leverage AI assistance throughout their project setup and development process, providing automated help with configuration, optimization, and best practices.
