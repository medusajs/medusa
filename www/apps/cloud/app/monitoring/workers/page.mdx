import { InlineIcon, Note, Table } from "docs-ui"
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        [Total CPU](#monitor-total-cpu) and [Summary of CPU Usage Across Workers](#monitor-summary-of-cpu-usage-across-workers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Summary of Memory Usage Across Workers](#monitor-summary-of-memory-usage-across-workers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Worker Restarts](#monitor-worker-restarts) and [Summary of Memory Usage Across Workers](#monitor-summary-of-memory-usage-across-workers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Summary of CPU Usage Across Workers](#monitor-summary-of-cpu-usage-across-workers) and [Summary of Memory Usage Across Workers](#monitor-summary-of-memory-usage-across-workers)
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
      ...
      <Table.Cell>
        [Total CPU](#monitor-total-cpu) and [Summary of Memory Usage Across Workers](#monitor-summary-of-memory-usage-across-workers)
      </Table.Cell>
    </Table.Row>
  </Table.Body>
</Table>
...
If the metrics don't show a cause related to your application, [check the Cloud status page](../../status/page.mdx) for ongoing Cloud incidents that may be affecting your environment.
...
1. Go to the [environment's dashboard](../../environments/long-lived/page.mdx#open-environment-dashboard).
2. Click **Monitoring** > **Workers** in the sidebar.
...
In the [Workers monitoring dashboard](#view-worker-metrics), the Summary of CPU chart shows:
...
In the [Workers monitoring dashboard](#view-worker-metrics), the Summary of Memory chart shows:
