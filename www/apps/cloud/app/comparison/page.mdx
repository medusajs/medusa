...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        Lack of tools with context on your project and expertise in Medusa to help you build and maintain your application.
      </Table.Cell>
      <Table.Cell>
        Empower your agentic workflows with context and expertise on Medusa with MCP servers, skills, CLI tools, and more.
      </Table.Cell>
    </Table.Row>
    <Table.Row>
      <Table.Cell>
...
When you self-host your Medusa application, you lack access to AI-native tools with expertise in Medusa to help you build and maintain your application. Custom feature development takes more time and effort, and troubleshooting issues can be more complex and time-consuming.

With Cloud, you get access to AI-native tools that empower your agentic workflows with built-in Medusa and deployment knowledge:

1. [Medusa documentation MCP server](!docs!/learn/introduction/build-with-llms-ai/mcp-server) for efficient development with AI agents.
2. [Cloud CLI](../cli/page.mdx) tools to manage your Cloud resources and debug issues with AI agents like Claude Code.
3. [Fix with AI](../deployments/fix-with-ai/page.mdx) feature to troubleshoot and resolve build and deployment issues with the help of Cloud's support agent.
4. [Agentic skills](!docs!/learn/introduction/build-with-llms-ai/agentic-skills) to give your AI agent the Medusa expertise it needs to help you build and maintain your application.
