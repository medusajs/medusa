...
On Cloud, access the Medusa Admin at your backend's URL with the `/app` path, for example `https://my-project.medusajs.app/app`. Once logged in, navigate to **Settings** > **Publishable API Keys** to create or copy a publishable API key.
