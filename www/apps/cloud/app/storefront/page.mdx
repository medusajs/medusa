...
2. [Add a storefront to an existing project](../projects/page.mdx#add-storefront-to-existing-project) that already has a Medusa application deployed on Cloud.
