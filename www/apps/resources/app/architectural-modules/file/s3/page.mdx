...
<Tabs defaultValue="aws">
  <TabsList>
    ...
    <TabsTrigger value="suapbase">Supabase S3 Storage</TabsTrigger>
  </TabsList>
  <TabsContentWrapper>
...
<TabsContent value="supabase">
    ...
    - [Supabase account](https://supabase.com/dashboard/sign-in?returnTo=%2Fprojects).
    - Create [New Project]
    ...
    - Create [Storage Policy](https://supabase.com/docs/guides/storage/security/access-control).
      1. On your bucket's dashboard, under configuration, click polocies.
      2. Click on New Policy under Other policies under storage.objects.
      3. Click get started quickly and enable insert access for authenticated users only.
      4. Click ALL instead of INSERT, then review and save policy.
      5. Click settings under configuration.
      6. Click New access key.
      7. Name new access key, and save id and secret key. 
      8. S3_FILE_URL= ``https://{uniqueID}/supabase.co/storage/v1/object/public``
      9. Copy settings for ``S3_ENDPOINT``, ``S3_REGION``, ``S3_BUCKET``, ``S3_ACCESS_KEY``, ``S3_SECRET_KEY``
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      - for Supabase, it's `https://{uniqueID}.supabase.co/storage/v1/object/public/{bucket}`.
    ...
    <Table.Row>
      ...
      - For Supabase, it's the Endpoint url
