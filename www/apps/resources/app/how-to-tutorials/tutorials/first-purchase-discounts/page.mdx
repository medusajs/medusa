...
export const validatePromotionHighlights = [
  ["12", "hasFirstPurchasePromo", "Check if the first-purchase promotion is being applied."],
  ["20", "", "Throw an error if the cart isn't associated with a customer."],
  ["30", "customer", "Retrieve the customer associated with the cart."],
  ["38", "", "Throw an error if the customer doesn't have an account or has previous orders."],
]
...
To retrieve the customer's details, you use [Query](!docs!/learn/fundamentals/query). Query allows you to retrieve data across modules in your Medusa application.
...
export const validateCartCompletionHighlights = [
  ...
  ["22", "customer", "Retrieve the customer associated with the cart."],
  ["30", "", "Throw an error if the customer doesn't have an account or has previous orders."],
]
