...
export const getProductFeedItemsHighlights2 = [
  ...
  ["6", "storefrontUrl", "The storefront URL to format the product links."],
  ["17", "products", "Retrieve the products with pagintion"],
  ["57", "feedItems", "Return the feed items."]
]
...
- [Query](!docs!/learn/fundamentals/query) that allows you to retrieve data across modules.
...
To retrieve the product variant prices for a currency code, you must pass the currency code as a [query context](!docs!/learn/fundamentals/query/query-context). Learn more in the [Get Variant Prices](../../../commerce-modules/product/guides/price/page.mdx) chapter.
