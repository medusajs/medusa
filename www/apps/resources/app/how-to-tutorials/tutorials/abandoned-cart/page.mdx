...
In the scheduled job function, so far you resolve the [Logger](!docs!/learn/debugging-and-testing/logging) to log messages, and [Query](!docs!/learn/fundamentals/query) to retrieve data across modules.
