...
The Next.js Starter storefront is compatible with Medusa's Stripe Payment Provider Module.

### Stripe Integration

<Note type="check">

- [Stripe Payment Provider Module](../commerce-modules/payment/payment-provider/stripe/page.mdx) installed in the Medusa application.
