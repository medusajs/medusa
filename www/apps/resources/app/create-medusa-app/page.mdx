...
Since [Medusa v2.13.7](https://github.com/medusajs/medusa/releases/tag/v2.13.7), if Claude Code is detected on your system, the tool prompts you to install the Medusa Plugin for Claude Code to enhance your development experience.
