...
As of Medusa v2.16.0, Medusa provides a [LayoutComposer](../../components/layout-composer/page.mdx) component that you can use to create layouts, including the two column layout.
