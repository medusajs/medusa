...
Medusa exports an `ActionMenu` component from the `@medusajs/dashboard` package since [v2.21.0](https://github.com/medusajs/medusa/releases/tag/v2.21.0). Use [the exported component](../../components/action-menu/page.mdx) instead of building your own. This guide is kept for reference only.
...
This widget also uses a [Container](../../guides/container/page.mdx) custom component.

### Use in Header

You can also use the action menu in the [Header](../../guides/header/page.mdx) component as part of its actions.
