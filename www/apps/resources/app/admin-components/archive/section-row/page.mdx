...
Medusa exports a `SectionRow` component from the `@medusajs/dashboard` package since [v2.21.0](https://github.com/medusajs/medusa/releases/tag/v2.21.0). Use [the exported component](../../components/section-row/page.mdx) instead of building your own. This guide is kept for reference only.
...
This widget also uses the [Container](../../guides/container/page.mdx) and [Header](../../guides/header/page.mdx) custom component.
