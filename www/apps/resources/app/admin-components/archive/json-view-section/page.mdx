...
Medusa exports a `JsonViewSection` component from the `@medusajs/dashboard` package since [v2.21.0](https://github.com/medusajs/medusa/releases/tag/v2.21.0). Use [the exported component](../../components/json-view-section/page.mdx) instead of building your own. This guide is kept for reference only.
