...
Aside from the `DataTable` component, you also import the [LayoutComposer](../../layouts/layout-composer/page.mdx) and [Container](../container/page.mdx) components to lay out the page. These components ensure a style consistent to other pages in the admin dashboard.
