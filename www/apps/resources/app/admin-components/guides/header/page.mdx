...
The `@medusajs/dashboard` package doesn't export a header component, so this guide is still the recommended way to build one. Refer to the [Components reference](../../components/page.mdx) for the components that Medusa does export.
...
The component also uses the [ActionMenu](../../components/action-menu/page.mdx) component.
