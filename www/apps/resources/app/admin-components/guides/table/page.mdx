...
This widget also uses the [Container](../container/page.mdx) custom component.
...
Aside from the `Table` component, this UI route also uses the [LayoutComposer](../../layouts/layout-composer/page.mdx), [Container](../container/page.mdx), and [Header](../header/page.mdx) custom component.
