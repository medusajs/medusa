...
When building a Next.js storefront that uses dynamic routes (for example, `/[countryCode]/categories/[...category]`), the build may fail with errors like:
...
If you're deploying on a platform like Vercel, check the **Environment Variables** section of your project settings to make sure these values are present and correct.
