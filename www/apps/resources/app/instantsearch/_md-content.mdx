...
- [`query.search`](!docs!/learn/fundamentals/query/search): the API behind the `/store/products/search` route, for a custom route over an index the route doesn't expose.
