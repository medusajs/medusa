  ...
  types={[
    {
      ...
      children: [
        ...
        },
        {
          ...
          description:
            "Dependencies to inject into the module's container. They key is the registration name, and the value is the instance of the dependency.",
        },
        {
          type: "`string`",
          name: "schema",
          ...
          children: [
            {
              ...
              name: "manager",
              description:
                "An instance of MikroORM's entity manager, which can be used to run queries and perform other database tasks.",
            },
            {
              type: "`() => Promise<void>`",
              name: "setupDatabase",
