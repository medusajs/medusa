...
- An object with `verification_required: true`: This means the authentication requires email verification before a token can be issued. The object includes verification details like expiry time. Learn more about [email verification](../../../commerce-modules/auth/email-verification/page.mdx).
