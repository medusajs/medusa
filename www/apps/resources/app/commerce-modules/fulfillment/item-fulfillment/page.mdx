...
To access tracking information for a fulfillment, you must retrieve the related labels. For example, to retrieve the tracking data with [Query](!docs!/learn/fundamentals/query):
