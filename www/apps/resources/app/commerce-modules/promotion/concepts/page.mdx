...
To retrieve the supported attributes programmatically, use the [listRuleAttributes](/references/js_sdk/admin/Promotion/methods/js_sdk.admin.Promotion.listRuleAttributes) JS SDK method or the [List Rule Attribute Options](!api!/admin#promotions_getpromotionsruleattributeoptionsrule_type) Admin API route.
