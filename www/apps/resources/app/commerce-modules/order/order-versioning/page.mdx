...
Since [Medusa v2.13.7](https://github.com/medusajs/medusa/releases/tag/v2.13.7), adjustment data models like `OrderLineItemAdjustment` and `OrderShippingMethodAdjustment` also include a `version` property to track which version they belong to.
