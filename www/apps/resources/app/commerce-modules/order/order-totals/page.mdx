...
In this guide, you'll learn how to retrieve order totals in your Medusa application using [Query](!docs!/learn/fundamentals/query).
...
) // or req.scope.resolve in API routes
...
{/* eslint-disable @medusajs/no-wildcard-with-specific-fields */}
