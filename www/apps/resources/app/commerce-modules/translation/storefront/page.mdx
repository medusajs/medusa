...
You can retrieve the list of locales available in your store using the [List Locales Store API route](!api!/store/locales/list-locales). You can display this list to customers, allowing them to select their preferred language.
