...
You can retrieve translations for a resource on the Medusa server using [Query](!docs!/learn/fundamentals/query). You can filter translations by `reference_id` and `locale_code` to get the specific translation you need.
