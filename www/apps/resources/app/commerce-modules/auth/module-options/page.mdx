...
- `resolve`: A string indicating the package name of the auth module provider or the path to it.
- `options`: An optional object of the auth module provider's options. The object must have the following property:
