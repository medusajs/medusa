...
Before [Medusa v2.16.0](https://github.com/medusajs/medusa/releases/tag/v2.16.0), `require_verification` was a boolean option. To migrate from the previous version, change `require_verification: true` to `require_verification: ["customer"]`.
