...
If your Medusa project is deployed to Cloud, you don't need to set the `AUTH_MFA_ENCRYPTION_KEY` environment variable. Medusa automatically sets it to a random value.
