...
Before [Medusa v2.17.3](https://github.com/medusajs/medusa/releases/tag/v2.17.3), passing `0` as the capture amount was treated as if no amount was provided, defaulting to the full payment amount. Now, passing `0` or a negative number throws an error.
...
Before [Medusa v2.17.3](https://github.com/medusajs/medusa/releases/tag/v2.17.3), passing `0` as the refund amount was treated as if no amount was provided, defaulting to the full payment amount. Now, passing `0` or a negative number throws an error.
