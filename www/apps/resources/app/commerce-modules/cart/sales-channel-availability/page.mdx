...
export const helperHighlights = [
  ["15", "query", "Use Query to retrieve data across modules."],
  ["21", "fields", "Retrieve the sales channels of each variant's product."],
  ["32", "some", "Check whether the product is linked to the cart's sales channel."],
]
