...
The Settings Module discovers the entities in your application from the registered modules' [query graph](!docs!/learn/fundamentals/query), including your custom modules' data models. For each entity, it generates the column configurations that are used in its configurable data table in the Medusa Admin dashboard.
