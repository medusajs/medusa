...
If you don't need saved views or dynamic columns, use the [DataTable component](!ui!/components/data-table) from `@medusajs/ui` instead. It's a stable, fully-supported table primitive.
