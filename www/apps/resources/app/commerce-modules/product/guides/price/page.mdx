...
So, to retrieve data across the linked records of the two modules, you use the Query.

</Note>

## Retrieve All Product Variant Prices

To retrieve all product variant prices, retrieve the product using the Query and include among its fields `variants.prices.*`.
