...
`calculated_price`'s value is created using the `QueryContext` utility, passing it a [calculation context object](../../../pricing/price-calculation/page.mdx#calculation-context).
