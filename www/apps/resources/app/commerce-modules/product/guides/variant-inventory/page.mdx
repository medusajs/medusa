...
export const variantAvailabilityHighlights = [
  ...
  ["11", "query", "Pass Query as a parameter."],
  ["12", "variant_ids", "The IDs of the variants to retrieve their inventory availability."],
  ["13", "sales_channel_id", "The ID of the sales channel to retrieve the variant availability in."],
]
...
export const salesChannelScopeHighlights = [
  ["14", "sales_channel_ids", "Retrieve the sales channel IDs from the request's publishable key context."],
  ["18", "sales_channel_ids[0]", "Pass the first sales channel ID to retrieve availability in."]
]
...
export const productSalesChannelHighlights = [
  ["13", `"product.sales_channels.*"`, "Retrieve the sales channels of the variant's product."],
  ["21", "sales_channel_id", "Pass the first sales channel ID to retrieve availability in."]
]
...
In this example, you retrieve the sales channels of the variant's product using [Query](!docs!/learn/fundamentals/query).
