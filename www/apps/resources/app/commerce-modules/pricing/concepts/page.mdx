...
You can store custom data in key-value pairs on a price list using the `metadata` property. This feature is available since Medusa [v2.14.2](https://github.com/medusajs/medusa/releases/tag/v2.14.2).
