...
<Card
  href="!docs!/learn/advanced-development/modules/service-factory"
...
<CardList itemsPerRow={2} items={[
  {
    href: "!docs!/learn/advanced-development/module-links/remote-link",
    title: "How to Use the Remote Link",
    text: "Learn how to link data models of different modules.",
    icon: AcademicCapSolid,
  },
  {
    href: "!docs!/learn/advanced-development/module-links/query",
