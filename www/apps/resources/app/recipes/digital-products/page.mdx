...
Use the remote link to create a link between two records, and use the Query to fetch data across linked data models.
...
<CardList itemsPerRow={2} items={[
  ...
  },
  {
    ...
    title: "How to Use the Query",
    text: "Learn how to fetch data across modules with the Query.",
    icon: AcademicCapSolid,
  },
]} />
