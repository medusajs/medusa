...
- [How to Create a Module](!docs!/learn/basics/modules-and-services)
- [How to Create a Data Model](!docs!/learn/basics/data-models)
...
- [How to Define Module Links](!docs!/learn/advanced-development/modules/module-links)
...
- [Learn more about Query](!docs!/learn/advanced-development/modules/query)
...
- [What is the Compensation Function](!docs!/learn/advanced-development/workflows/compensation-function)
- [Learn more about the remote link function](!docs!/learn/advanced-development/modules/remote-link)
...
- [How to Create Admin Widgets](!docs!/learn/advanced-development/admin/widgets)
...
- [Conditions in Workflows with When-Then](!docs!/learn/advanced-development/workflows/conditions)
...
- [What are protected API routes](!docs!/learn/advanced-development/api-routes/protected-routes)
...
In this recipe, you learned how to customize the admin with UI routes. You can also do further customization using widgets. Learn more in [this documentation](!docs!/learn/advanced-development/admin).
