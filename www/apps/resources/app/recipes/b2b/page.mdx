...
<CardList items={[
  {
    href: "#",
    title: "Create Products Using Medusa Admin",
  ...
  },
  {
    ...
    title: "Create Products Using REST APIs",
...
<Details summaryContent="Example">
  ...
  ```ts title="src/modules/b2b/models/company.ts" highlights={[["23", "", "Field will be used to create a relationship to customer groups."]]}
...
export const mainServiceHighlights = [
  ...
  ```ts title="src/modules/b2b/service.ts" highlights={mainServiceHighlights}
...
export const workflowHighlights = [
  ...
  ```ts title="src/workflows/create-company.ts" highlights={workflowHighlights}
  import { 
    StepResponse, 
    createStep, 
    createWorkflow
  ...
  ```ts title="src/api/admin/b2b/company/route.ts"
  import type { 
    MedusaRequest, 
    MedusaResponse
...
<CardList items={[
  {
    href: "#",
    title: "Create Price List Using Medusa Admin",
  ...
  },
  {
    ...
    title: "Create Price List Using REST APIs",
...
export const checkCustomerHighlights = [
  ...
  ```ts title="src/api/store/b2b/check-customer/route.ts" highlights={checkCustomerHighlights}
