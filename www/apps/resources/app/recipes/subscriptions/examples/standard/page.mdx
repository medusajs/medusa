...
```ts title="src/modules/checkout/components/subscriptions/index.tsx" badgeLabel="Storefront" badgeColor="orange" collapsibleLines="1-13" expandMoreLabel="Show Imports"
"use client"
...
export const createSubscriptionOrderStep1Highlights = [
  ...
  ["33", "createOrdersWorkflow", "Use Medusa's workflow to create the order."],
  ["44", "order", "Pass the order to the compensation function."]
]
