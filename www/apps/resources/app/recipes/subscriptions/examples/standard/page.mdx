...
In the route handler, you use the Query to retrieve a subscription with its orders and customer. 
...
In the route handler, you retrieve a subscription by its ID using the Query and return it in the response.
...
In the route handler, you retrieve the authenticated customer’s subscriptions using the Query and return them in the response.
