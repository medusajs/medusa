...
{/* TODO change provider pages to integration page */}

{/* TODO add the following item
...
<CardList items={[
  ...
  {
    href: "/commerce-modules/payment/payment-provider",
    title: "Payment Providers Modules",
    text: "Check out the list of payment provider modules.",
    startIcon: <AcademicCapSolid />,
    showLinkIcon: false
  },
]} />
