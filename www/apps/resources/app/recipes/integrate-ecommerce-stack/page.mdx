...
<Card
  href="!docs!/learn/basics/modules-and-services"
...
export const serviceHighlights = [
  ...
  You can store the product's ID in the external system using the `metadata` property of the `Product` data model in the Product Module. Alternatively, you can create a [data model](!docs!/learn/basics/data-models) in your module to store data related to the external system.
