...
This creates a `GET` API route at `/restaurants`. It uses the Query to retrieve a restaurant, its products, and the product variant’s prices for a specified currency.
