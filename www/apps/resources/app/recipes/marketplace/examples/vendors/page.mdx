...
export const vendorAdminWorkflowHighlights = [
  ["29", "createVendorAdminStep", "Create the vendor admin."],
  ["33", "setAuthAppMetadataStep", "Create the `vendor` actor type."]
]
...
export const vendorOrder3Highlights = [
  ...
  ["9", "prepareOrderData", "Format the order data and pass it as the workflow's input."],
  ["17", "push", "Add a link between the vendor and the order to be created later."],
  ["29", "cancelOrderWorkflow", "Cancel all created workflows if an error occurs while creating any of them."]
]
