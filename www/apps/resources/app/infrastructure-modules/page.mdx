...
The Search Module has module providers that implement the underlying logic of indexing and searching documents in a search engine. The following Search Module Providers are provided by Medusa. You can also create a custom provider as explained in the [Create Search Module Provider guide](#).
