...
This provider doesn't support [vector fields](../../index-definitions/fields/page.mdx#searchvector) or vector search. It rejects an index that declares one, so your application fails to start.
