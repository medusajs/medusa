...
In this example, you store the English and French titles in separate fields. Then, you write each locale's value to its own field. If you use the [Translation Module](../../../../commerce-modules/translation/page.mdx), pass the `locale` option to Query to retrieve the translated values of a locale.
