...
With [Medusa Search](!cloud!/search), an embedding you compute yourself can have at most 1536 dimensions. Medusa Search rejects a query whose embedding is longer than that.
