...
The [Search Products API route](!api!/store/products/search-products) resolves the index named `product`, so the fields you add here become available to storefront searches. Refer to [Search Products](../../page.mdx#search-products) for how to query it.
