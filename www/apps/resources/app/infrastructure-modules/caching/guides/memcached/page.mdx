...
export const loaderHighlights = [
  ["8", "serverUrls", "Memcached server URLs"],
  ["9", "username", "Username for authentication"],
  ["10", "password", "Password for authentication"],
  ["11", "options", "Additional Memcached client options"],
  ["12", "cachePrefix", "Prefix for cache keys"],
  ["13", "defaultTtl", "Default time-to-live for cached items"],
  ["14", "compression", "Compression settings"],
  ["15", "enable", "Enable compression"],
  ["16", "threshold", "Minimum size to compress"],
  ["17", "level", "Compression level"],
  ["39", "client", "Create Memcached client"],
  ["47", "stats", "Test the connection to Memcached"],
  ["59", "register", "Register the client in the container"],
]
