...
When you cache entities with the [Query](!docs!/learn/fundamentals/query) or [Index Module](!docs!/learn/fundamentals/query/index-module), the Caching Module automatically generates tags based on the entity type and its ID:
