...
Starting in [Medusa v2.13.6](https://github.com/medusajs/medusa/releases/tag/v2.13.6), the Redis Locking Module Provider uses exponential backoff for retry logic, improving performance in high-contention scenarios. The default retry intervals have also been updated for better efficiency.
