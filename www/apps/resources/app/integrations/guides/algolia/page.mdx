...
This guide is deprecated as of Medusa v2.21.1, which introduced the [Search Module](/infrastructure-modules/search). Rather than the custom module this guide builds, consider one of the following instead:
