...
2. The `data` property of the shipping method to be created. This can hold custom data sent in the [Add Shipping Method API route](!api!/store/carts/add-shipping-method).
3. An object of the checkout's context, including the cart's items, the location associated with the shipping option, and more.
...
Open the terminal in the Next.js Starter Storefront's directory (`apps/storefront`).
