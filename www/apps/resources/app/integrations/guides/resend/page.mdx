...
1. `useQueryGraphStep`, which is a step implemented by Medusa that uses [Query](!docs!/learn/fundamentals/query), a tool that allows you to retrieve data across modules. You use it to retrieve the order's details.
