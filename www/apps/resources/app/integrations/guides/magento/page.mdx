...
You use the `useQueryGraphStep` step to retrieve the store details and shipping profiles. `useQueryGraphStep` is a Medusa step that wraps [Query](!docs!/learn/fundamentals/query), allowing you to use it in a workflow. Query is a tool that retrieves data across modules.
...
export const prepareHighlights = [
  ...
  ["25", "external_id", "Set the Magento product's ID in the Medusa product's `external_id` property."],
  ...
  ["34", "existingProduct", "Find the existing product in Medusa that matches the Magento product's ID."],
  ["40", "options", "Map the Magento product's configurable product options to Medusa product options."],
  ["77", "variants", "Map the Magento product's children to Medusa product variants."],
]
