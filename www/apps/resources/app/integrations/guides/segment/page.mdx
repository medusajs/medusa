...
export const stepHighlights = [
  ["5", "event", "The name of the event to track."],
  ["6", "userId", "The ID of the user performing the event."],
  ["7", "properties", "Additional properties associated with the event."],
  ["8", "timestamp", "The timestamp of the event."],
  ["14", "analyticsModuleService", "Resolve the Analytics Module's service from the Medusa container."],
  ["22", "anonymousId", "Set a random ID if no user ID is passed."],
  ["27", "track", "Track the event in Segment."]
]
...
1. Retrieve the Medusa order using the `useQueryGraphStep` helper step. This step uses Medusa's [Query](!docs!/learn/fundamentals/query) tool to retrieve data across modules. You pass it the order ID to retrieve.
