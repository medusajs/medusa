...
{/* eslint-disable @medusajs/link-create-keys-modules-enum */}
...
export const apiRouteHighlights = [
  ["5", "newsletterSignupSchema", "Zod schema to validate the request body."],
  ["11", "POST", "POST route handler function for the API route."],
  ["15", "eventModuleService", "Resolve the Event Module service from the Medusa container."],
  ["19", "emit", "Emit the newsletter.signup event with the request body data."],
]
...
export const workflowHighlights = [
  ["17", "transform", "Compute the cutoff date in a `transform` so it is evaluated at runtime."],
  ["21", "useQueryGraphStep", "Retrieve the products created in the last 7 days."],
  ["36", "when", "Check whether there are new products."],
  ["38", "sendNotificationsStep", "Create a notification with the new products data."],
]
