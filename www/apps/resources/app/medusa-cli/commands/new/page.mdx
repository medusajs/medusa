...
The command always uses the `medusajs/dtc-starter` monorepo template and creates a project structure with your backend in `apps/backend`.
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      Seed the database with demo data after setup.
