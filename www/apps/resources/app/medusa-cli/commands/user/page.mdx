...
If the [role-based access control (RBAC)](../../../enterprise/rbac/page.mdx) feature is enabled, the created user is assigned the Super Admin role by default, giving them full access to all resources and operations.
