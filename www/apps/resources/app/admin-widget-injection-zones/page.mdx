...
import PropertyLabelContent from "../commerce-modules/settings/admin-widget-zones/_content.mdx"
import DeprecationNote from "./_deprecation-note.mdx"
...
The Top Bar is the navigation bar at the top of the admin dashboard. You can add widgets to it using the `topbar` injection zone, such as to add a button to the top bar. The following zones are available since [Medusa v2.17.2](https://github.com/medusajs/medusa/releases/tag/v2.17.2).
