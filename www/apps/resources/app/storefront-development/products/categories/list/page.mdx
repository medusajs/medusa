...
To retrieve the list of product categories, send a request to the [List Product Categories API route](!api!/store/product-categories/list-product-categories):
...
In this example, you send a request to the [List Product Categories API route](!api!/store/product-categories/list-product-categories).
...
To paginate product categories, pass the following query parameters to the [List Product Categories API route](!api!/store/product-categories/list-product-categories):
...
In this example, you send a request to the [List Product Categories API route](!api!/store/product-categories/list-product-categories) with the `limit` and `offset` query parameters.
...
The [List Product Categories API route](!api!/store/product-categories/list-product-categories) accepts query parameters to filter the categories by description, handle, `external_id`, and more.

Refer to the [API reference](!api!/store/product-categories/list-product-categories) for the full list of accepted query parameters.
