...
The [List Product Collections API route](!api!/store#collections_getcollections) accepts query parameters to filter the collections by title, handle, external ID, and more.
