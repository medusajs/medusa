...
`PRODUCT_INDEX_NAME` and `searchClient` come from the adapter setup explained in the [InstantSearch Adapter guide](../../../instantsearch/page.mdx#step-2-create-the-search-client).
