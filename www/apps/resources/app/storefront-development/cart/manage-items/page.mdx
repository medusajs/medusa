...
export const addHighlights = [
  ...
  ["13", "process.env.NEXT_PUBLIC_PAK", "You must pass the publishable API key of all storefront requests."], 
...
export const updateHighlights = [
  ...
  ["18", "process.env.NEXT_PUBLIC_PAK", "You must pass the publishable API key of all storefront requests."], 
]
