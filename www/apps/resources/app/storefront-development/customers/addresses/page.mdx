...
To retrieve the list of customer addresses, send a request to the [List Customer Addresses API route](!api!/store/customers/get-address):
...
export const highlights = [
  ...
  ["53", "", "Using only two address fields for simplicity."],
  ["60", "button", "Show a button to load more addresses if there are more pages."]
]
...
The [List Customer Addresses API route](!api!/store/customers/list-customers-addresses) accepts pagination parameters to paginate the address.

The request returns in the response the `addresses` field, which is an array of addresses. You can check its structure in the [customer schema](!api!/store/customers/schema).
...
To add a new address for the customer, send a request to the [Add Customer Address API route](!api!/store/customers/create-address):
...
In this example, you send a request to the [Add Customer Address API route](!api!/store/customers/create-address) to add a new address for the customer.

The response of the request has a `customer` field, which is a [customer object](!api!/store/customers/schema). You can access the new address in the `addresses` property of the customer object.

---

## Edit an Address

To edit an address, send a request to the [Update Customer Address API route](!api!/store/customers/update-address):
...
In this example, you send a request to the [Update Customer Address API route](!api!/store/customers/update-address) to edit an address.

The response of the request has a `customer` field, which is a [customer object](!api!/store/customers/schema). You can access the updated address in the `addresses` property of the customer object.

---

## Delete Customer Address

To delete a customer's address, send a request to the [Delete Customer Address API route](!api!/store/customers/remove-address):
...
In this example, you send a request to the [Delete Customer Address API route](!api!/store/customers/remove-address) to delete an address.

The response of the request has a `parent` field, which is a [customer object](!api!/store/customers/schema). You can access the updated customer in the `parent` property of the response.
