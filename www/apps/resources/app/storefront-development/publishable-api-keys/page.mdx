...
export const highlights = [
  ["4", "NEXT_PUBLIC_PAK", "An environment variable that holds the publishable API key's token."]
]
...
Where `NEXT_PUBLIC_PAK` is an environment variable that holds your publishable API key's token.
