...
Workflow events (`*WorkflowEvents` enums) are the stable, public API for subscribing to commerce actions. Using them ensures your subscribers continue to work across Medusa upgrades.
