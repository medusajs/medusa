...
This rule targets data model files in your project's `src/modules` directory. It reports a relationship method that references a data model imported from outside the current module.
