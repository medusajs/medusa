...
This rule has been removed as of Medusa [v2.18.0](https://github.com/medusajs/medusa/releases/tag/v2.18.0) since `QueryContext` can be applied to nested objects, making it difficult to determine its usage in a linting rule.
