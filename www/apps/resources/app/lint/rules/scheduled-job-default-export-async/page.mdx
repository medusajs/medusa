...
Scheduled jobs receive the Medusa container and are always awaited by the framework. Making the job async ensures Medusa can wait for its work to finish before continuing.
