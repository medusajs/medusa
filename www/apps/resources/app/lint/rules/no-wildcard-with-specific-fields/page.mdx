...
This rule targets calls to `query.graph` and `useQueryGraphStep` anywhere in your project. It reports a `fields` array that contains both the `*` wildcard and one or more specific top-level fields.
