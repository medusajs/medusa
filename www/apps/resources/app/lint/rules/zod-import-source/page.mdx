...
Importing Zod from `@medusajs/framework/zod` ensures you use the same Zod version the framework relies on, avoiding version mismatches and duplicate copies in your project.
