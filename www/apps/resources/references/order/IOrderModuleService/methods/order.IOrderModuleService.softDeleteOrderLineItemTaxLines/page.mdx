...
slug: /references/order/softDeleteOrderLineItemTaxLines
sidebar_label: softDeleteOrderLineItemTaxLines
---

import { TypeList } from "docs-ui"

# softDeleteOrderLineItemTaxLines - Order Module Reference

This documentation provides a reference to the `softDeleteOrderLineItemTaxLines` method. This belongs to the Order Module.
