...
slug: /references/order/retrieveOrderLineItem
sidebar_label: retrieveOrderLineItem
---
...
This documentation provides a reference to the `retrieveOrderLineItem` method. This belongs to the Order Module.
