...
slug: /references/order/deleteOrderTransactions
sidebar_label: deleteOrderTransactions
---
...
This documentation provides a reference to the `deleteOrderTransactions` method. This belongs to the Order Module.
