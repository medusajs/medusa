...
slug: /references/order/restoreLineItemAdjustments
sidebar_label: restoreLineItemAdjustments
---

import { TypeList } from "docs-ui"

# restoreLineItemAdjustments - Order Module Reference

This documentation provides a reference to the `restoreLineItemAdjustments` method. This belongs to the Order Module.
