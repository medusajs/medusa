...
slug: /references/order/restoreOrderLineItems
sidebar_label: restoreOrderLineItems
---

import { TypeList } from "docs-ui"

# restoreOrderLineItems - Order Module Reference

This documentation provides a reference to the `restoreOrderLineItems` method. This belongs to the Order Module.
