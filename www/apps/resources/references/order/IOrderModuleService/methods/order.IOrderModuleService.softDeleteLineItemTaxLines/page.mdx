...
slug: /references/order/softDeleteLineItemTaxLines
sidebar_label: softDeleteLineItemTaxLines
---

import { TypeList } from "docs-ui"

# softDeleteLineItemTaxLines - Order Module Reference

This documentation provides a reference to the `softDeleteLineItemTaxLines` method. This belongs to the Order Module.
