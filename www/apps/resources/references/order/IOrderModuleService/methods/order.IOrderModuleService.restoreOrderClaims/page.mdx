...
slug: /references/order/restoreOrderClaims
sidebar_label: restoreOrderClaims
---

import { TypeList } from "docs-ui"

# restoreOrderClaims - Order Module Reference

This documentation provides a reference to the `restoreOrderClaims` method. This belongs to the Order Module.
