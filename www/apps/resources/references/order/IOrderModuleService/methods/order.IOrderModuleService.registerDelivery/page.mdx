...
slug: /references/order/registerDelivery
sidebar_label: registerDelivery
---

import { TypeList } from "docs-ui"

# registerDelivery - Order Module Reference

This documentation provides a reference to the `registerDelivery` method. This belongs to the Order Module.
