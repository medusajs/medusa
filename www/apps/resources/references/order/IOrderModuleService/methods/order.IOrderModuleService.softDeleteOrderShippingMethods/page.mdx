...
slug: /references/order/softDeleteOrderShippingMethods
sidebar_label: softDeleteOrderShippingMethods
---

import { TypeList } from "docs-ui"

# softDeleteOrderShippingMethods - Order Module Reference

This documentation provides a reference to the `softDeleteOrderShippingMethods` method. This belongs to the Order Module.
