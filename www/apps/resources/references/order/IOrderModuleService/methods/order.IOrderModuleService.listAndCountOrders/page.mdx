...
slug: /references/order/listAndCountOrders
sidebar_label: listAndCountOrders
---

import { TypeList } from "docs-ui"

# listAndCountOrders - Order Module Reference

This documentation provides a reference to the `listAndCountOrders` method. This belongs to the Order Module.
