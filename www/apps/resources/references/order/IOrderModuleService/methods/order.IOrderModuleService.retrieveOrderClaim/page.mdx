...
slug: /references/order/retrieveOrderClaim
sidebar_label: retrieveOrderClaim
---
...
This documentation provides a reference to the `retrieveOrderClaim` method. This belongs to the Order Module.
