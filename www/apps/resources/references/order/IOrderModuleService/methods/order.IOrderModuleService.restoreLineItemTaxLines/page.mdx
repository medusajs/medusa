...
slug: /references/order/restoreLineItemTaxLines
sidebar_label: restoreLineItemTaxLines
---

import { TypeList } from "docs-ui"

# restoreLineItemTaxLines - Order Module Reference

This documentation provides a reference to the `restoreLineItemTaxLines` method. This belongs to the Order Module.
