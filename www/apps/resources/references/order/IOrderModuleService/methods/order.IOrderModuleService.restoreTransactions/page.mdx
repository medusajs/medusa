...
slug: /references/order/restoreTransactions
sidebar_label: restoreTransactions
---

import { TypeList } from "docs-ui"

# restoreTransactions - Order Module Reference

This documentation provides a reference to the `restoreTransactions` method. This belongs to the Order Module.
