...
slug: /references/order/listOrderClaims
sidebar_label: listOrderClaims
---

import { TypeList } from "docs-ui"

# listOrderClaims - Order Module Reference

This documentation provides a reference to the `listOrderClaims` method. This belongs to the Order Module.
