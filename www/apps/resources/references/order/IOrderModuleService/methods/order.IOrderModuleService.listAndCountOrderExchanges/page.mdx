...
slug: /references/order/listAndCountOrderExchanges
sidebar_label: listAndCountOrderExchanges
---

import { TypeList } from "docs-ui"

# listAndCountOrderExchanges - Order Module Reference

This documentation provides a reference to the `listAndCountOrderExchanges` method. This belongs to the Order Module.
