...
slug: /references/order/restoreAddresses
sidebar_label: restoreAddresses
---

import { TypeList } from "docs-ui"

# restoreAddresses - Order Module Reference

This documentation provides a reference to the `restoreAddresses` method. This belongs to the Order Module.
