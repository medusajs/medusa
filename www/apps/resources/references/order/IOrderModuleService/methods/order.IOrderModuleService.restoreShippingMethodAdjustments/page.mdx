...
slug: /references/order/restoreShippingMethodAdjustments
sidebar_label: restoreShippingMethodAdjustments
---

import { TypeList } from "docs-ui"

# restoreShippingMethodAdjustments - Order Module Reference

This documentation provides a reference to the `restoreShippingMethodAdjustments` method. This belongs to the Order Module.
