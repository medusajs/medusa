...
slug: /references/order/retrieveOrder
sidebar_label: retrieveOrder
---
...
This documentation provides a reference to the `retrieveOrder` method. This belongs to the Order Module.
