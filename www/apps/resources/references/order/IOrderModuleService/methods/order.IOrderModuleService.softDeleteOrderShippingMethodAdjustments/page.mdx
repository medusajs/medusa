...
slug: /references/order/softDeleteOrderShippingMethodAdjustments
sidebar_label: softDeleteOrderShippingMethodAdjustments
---

import { TypeList } from "docs-ui"

# softDeleteOrderShippingMethodAdjustments - Order Module Reference

This documentation provides a reference to the `softDeleteOrderShippingMethodAdjustments` method. This belongs to the Order Module.
