...
slug: /references/order/restoreOrderChanges
sidebar_label: restoreOrderChanges
---

import { TypeList } from "docs-ui"

# restoreOrderChanges - Order Module Reference

This documentation provides a reference to the `restoreOrderChanges` method. This belongs to the Order Module.
