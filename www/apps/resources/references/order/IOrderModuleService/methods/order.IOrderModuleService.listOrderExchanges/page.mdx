...
slug: /references/order/listOrderExchanges
sidebar_label: listOrderExchanges
---

import { TypeList } from "docs-ui"

# listOrderExchanges - Order Module Reference

This documentation provides a reference to the `listOrderExchanges` method. This belongs to the Order Module.
