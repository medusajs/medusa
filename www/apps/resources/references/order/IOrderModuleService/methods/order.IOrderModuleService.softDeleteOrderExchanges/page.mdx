...
slug: /references/order/softDeleteOrderExchanges
sidebar_label: softDeleteOrderExchanges
---

import { TypeList } from "docs-ui"

# softDeleteOrderExchanges - Order Module Reference

This documentation provides a reference to the `softDeleteOrderExchanges` method. This belongs to the Order Module.
