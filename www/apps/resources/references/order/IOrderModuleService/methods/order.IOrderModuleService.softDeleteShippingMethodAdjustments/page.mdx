...
slug: /references/order/softDeleteShippingMethodAdjustments
sidebar_label: softDeleteShippingMethodAdjustments
---

import { TypeList } from "docs-ui"

# softDeleteShippingMethodAdjustments - Order Module Reference

This documentation provides a reference to the `softDeleteShippingMethodAdjustments` method. This belongs to the Order Module.
