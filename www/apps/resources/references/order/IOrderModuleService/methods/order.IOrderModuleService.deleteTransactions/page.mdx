...
slug: /references/order/deleteTransactions
sidebar_label: deleteTransactions
---

import { TypeList } from "docs-ui"

# deleteTransactions - Order Module Reference

This documentation provides a reference to the `deleteTransactions` method. This belongs to the Order Module.
