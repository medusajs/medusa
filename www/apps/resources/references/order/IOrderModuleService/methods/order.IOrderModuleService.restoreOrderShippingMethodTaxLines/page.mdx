...
slug: /references/order/restoreOrderShippingMethodTaxLines
sidebar_label: restoreOrderShippingMethodTaxLines
---

import { TypeList } from "docs-ui"

# restoreOrderShippingMethodTaxLines - Order Module Reference

This documentation provides a reference to the `restoreOrderShippingMethodTaxLines` method. This belongs to the Order Module.
