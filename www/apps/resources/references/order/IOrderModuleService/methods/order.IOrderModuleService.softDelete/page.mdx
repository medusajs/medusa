...
slug: /references/order/softDelete
sidebar_label: softDelete
---

import { TypeList } from "docs-ui"

# softDelete - Order Module Reference

This documentation provides a reference to the `softDelete` method. This belongs to the Order Module.
