...
slug: /references/order/restoreOrders
sidebar_label: restoreOrders
---
...
This documentation provides a reference to the `restoreOrders` method. This belongs to the Order Module.
