...
slug: /references/customer/restoreCustomers
sidebar_label: restoreCustomers
---

import { TypeList } from "docs-ui"

# restoreCustomers - Customer Module Reference

This documentation provides a reference to the `restoreCustomers` method. This belongs to the Customer Module.
