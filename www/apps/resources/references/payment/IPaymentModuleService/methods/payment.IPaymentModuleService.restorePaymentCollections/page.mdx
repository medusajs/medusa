...
slug: /references/payment/restorePaymentCollections
sidebar_label: restorePaymentCollections
---

import { TypeList } from "docs-ui"

# restorePaymentCollections - Payment Module Reference

This documentation provides a reference to the `restorePaymentCollections` method. This belongs to the Payment Module.
