...
slug: /references/payment/listRefundReasons
sidebar_label: listRefundReasons
---

import { TypeList } from "docs-ui"

# listRefundReasons - Payment Module Reference

This documentation provides a reference to the `listRefundReasons` method. This belongs to the Payment Module.
