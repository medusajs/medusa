...
<WorkflowDiagram workflow={{"name":"updatePromotionRulesWorkflow","steps":[{"type":"step","name":"updatePromotionRulesStep","description":"This step updates one or more promotion rules.","link":"../../../Steps_Promotion/functions/core_flows.Steps_Promotion.updatePromotionRulesStep/page.mdx","depth":1}]}} />
