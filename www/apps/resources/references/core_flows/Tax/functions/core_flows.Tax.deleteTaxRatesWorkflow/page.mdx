...
<WorkflowDiagram workflow={{"name":"deleteTaxRatesWorkflow","steps":[{"type":"step","name":"deleteTaxRatesStep","description":"This step deletes one or more tax rates.","link":"../core_flows.Tax.deleteTaxRatesStep/page.mdx","depth":1}]}} />
