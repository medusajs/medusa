...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/tax/workflows/delete-tax-rate-rules.ts#L38" />
...
<TypeList types={[{"name":"DeleteTaxRateRulesWorkflowInput","type":"[DeleteTaxRateRulesWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.DeleteTaxRateRulesWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"DeleteTaxRateRulesWorkflowInput","type":"`object`","description":"The data to delete tax rate rules.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="deleteTaxRateRulesWorkflow"/>
