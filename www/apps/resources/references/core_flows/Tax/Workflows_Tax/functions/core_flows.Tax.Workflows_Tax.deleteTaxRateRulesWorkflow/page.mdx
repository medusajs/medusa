...
<WorkflowDiagram workflow={{"name":"deleteTaxRateRulesWorkflow","steps":[{"type":"step","name":"deleteTaxRateRulesStep","description":"This step deletes one or more tax rate rules.","link":"../../../../Steps_Tax/functions/core_flows.Steps_Tax.deleteTaxRateRulesStep/page.mdx","depth":1}]}} />
