...
# createTaxRateRulesStep - Medusa Core Workflows Reference

This documentation provides a reference to the `createTaxRateRulesStep`. It belongs to the `@medusajs/medusa/core-flows` package.
