...
<WorkflowDiagram workflow={{"name":"createLocationFulfillmentSetWorkflow","steps":[{"type":"step","name":"createFulfillmentSets","description":"This step creates one or more fulfillment sets.","link":"../../../Steps_Fulfillment/functions/core_flows.Steps_Fulfillment.createFulfillmentSets/page.mdx","depth":1}]}} />
