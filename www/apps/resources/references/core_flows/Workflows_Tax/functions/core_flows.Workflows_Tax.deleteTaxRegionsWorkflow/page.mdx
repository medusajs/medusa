...
<WorkflowDiagram workflow={{"name":"deleteTaxRegionsWorkflow","steps":[{"type":"step","name":"deleteTaxRegionsStep","description":"This step deletes one or more tax regions.","link":"../../../Steps_Tax/functions/core_flows.Steps_Tax.deleteTaxRegionsStep/page.mdx","depth":1}]}} />
