...
<WorkflowDiagram workflow={{"name":"createInvitesWorkflow","steps":[{"type":"step","name":"createInviteStep","description":"This step creates one or more invites.","link":"../core_flows.Invite.createInviteStep/page.mdx","depth":1}]}} />
