...
# refreshInviteTokensStep - Medusa Workflows API Reference

This documentation provides a reference to the `refreshInviteTokensStep`. It belongs to the `@medusajs/core-flows` package.
