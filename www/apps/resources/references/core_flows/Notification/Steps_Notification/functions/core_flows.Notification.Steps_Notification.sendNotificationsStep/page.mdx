...
<TypeList types={[{"name":"SendNotificationsStepInput","type":"[SendNotificationsStepInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.SendNotificationsStepInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"SendNotificationsStepInput","type":"`object`[]","description":"The notifications to send.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="sendNotificationsStep"/>
