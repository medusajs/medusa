...
<WorkflowDiagram workflow={{"name":"createPromotionRulesWorkflow","steps":[{"type":"step","name":"addRulesToPromotionsStep","description":"This step adds rules to a promotion.","link":"../../../../Steps_Promotion/functions/core_flows.Steps_Promotion.addRulesToPromotionsStep/page.mdx","depth":1}]}} />
