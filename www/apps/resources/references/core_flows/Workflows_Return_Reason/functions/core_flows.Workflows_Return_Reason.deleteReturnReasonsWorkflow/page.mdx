...
<WorkflowDiagram workflow={{"name":"deleteReturnReasonsWorkflow","steps":[{"type":"step","name":"deleteReturnReasonStep","description":"This step deletes one or more return reasons.","link":"../../../Steps_Return_Reason/functions/core_flows.Steps_Return_Reason.deleteReturnReasonStep/page.mdx","depth":1}]}} />
