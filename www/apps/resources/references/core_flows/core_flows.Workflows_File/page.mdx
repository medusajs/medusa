...
<WorkflowDiagram workflow={{"name":"deleteFilesWorkflow","steps":[{"type":"step","name":"deleteFilesStep","description":"This step deletes one or more files.","link":"../Steps_File/functions/core_flows.Steps_File.deleteFilesStep/page.mdx","depth":1}]}} />
...
<WorkflowDiagram workflow={{"name":"uploadFilesWorkflow","steps":[{"type":"step","name":"uploadFilesStep","description":"This step uploads one or more files.","link":"../Steps_File/functions/core_flows.Steps_File.uploadFilesStep/page.mdx","depth":1}]}} />
