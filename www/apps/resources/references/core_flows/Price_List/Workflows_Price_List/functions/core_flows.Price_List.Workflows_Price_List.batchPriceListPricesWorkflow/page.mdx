...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/price-list/workflows/batch-price-list-prices.ts#L64" />
...
<TypeList types={[{"name":"BatchPriceListPricesWorkflowInput","type":"[BatchPriceListPricesWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.BatchPriceListPricesWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"BatchPriceListPricesWorkflowInput","type":"`object`","description":"The data to manage a price list's prices.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="batchPriceListPricesWorkflow"/>
