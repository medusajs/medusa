...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/735e0aa51ef64274257057a59046776af54203f4/packages/core/core-flows/src/auth/workflows/request-verification.ts#L24" />
...
<TypeList types={[{"name":"AuthVerificationDTO","type":"`AuthVerificationDTO`","optional":false,"defaultValue":"","description":"","expandable":false,"children":[]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="requestVerificationWorkflow"/>
