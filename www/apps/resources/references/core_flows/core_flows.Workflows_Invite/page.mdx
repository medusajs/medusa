...
<WorkflowDiagram workflow={{"name":"acceptInviteWorkflow","steps":[{"type":"step","name":"validateTokenStep","description":"This step validates a specified token and returns its associated invite.","link":"../Steps_Invite/functions/core_flows.Steps_Invite.validateTokenStep/page.mdx","depth":1},{"type":"step","name":"createUsersStep","description":"This step creates one or more users.","link":"../Steps_User/functions/core_flows.Steps_User.createUsersStep/page.mdx","depth":2},{"type":"step","name":"setAuthAppMetadataStep","description":"This step sets the `app_metadata` property of an auth identity.","link":"../Steps_Auth/functions/core_flows.Steps_Auth.setAuthAppMetadataStep/page.mdx","depth":3},{"type":"step","name":"deleteInvitesStep","description":"This step deletes one or more invites.","link":"../Steps_Invite/functions/core_flows.Steps_Invite.deleteInvitesStep/page.mdx","depth":4}]}} />
...
<WorkflowDiagram workflow={{"name":"createInvitesWorkflow","steps":[{"type":"step","name":"createInviteStep","description":"This step creates one or more invites.","link":"../Steps_Invite/functions/core_flows.Steps_Invite.createInviteStep/page.mdx","depth":1}]}} />
...
<WorkflowDiagram workflow={{"name":"refreshInviteTokensWorkflow","steps":[{"type":"step","name":"refreshInviteTokensStep","description":"This step refreshes the tokens of one or more invites.","link":"../Steps_Invite/functions/core_flows.Steps_Invite.refreshInviteTokensStep/page.mdx","depth":1}]}} />
