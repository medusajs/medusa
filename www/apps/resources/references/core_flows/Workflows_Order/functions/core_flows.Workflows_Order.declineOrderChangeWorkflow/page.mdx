...
<WorkflowDiagram workflow={{"name":"declineOrderChangeWorkflow","steps":[{"type":"step","name":"declineOrderChangeStep","description":"This step declines an order change.","link":"../../../Steps_Order/functions/core_flows.Steps_Order.declineOrderChangeStep/page.mdx","depth":1}]}} />
