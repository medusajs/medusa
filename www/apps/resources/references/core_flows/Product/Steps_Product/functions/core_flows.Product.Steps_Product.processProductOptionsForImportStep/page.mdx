---
slug: /references/medusa-workflows/steps/processProductOptionsForImportStep
sidebar_label: processProductOptionsForImportStep
tags:
  - product
  - step
---
...
# processProductOptionsForImportStep - Medusa Core Workflows Reference

This documentation provides a reference to the `processProductOptionsForImportStep`. It belongs to the `@medusajs/medusa/core-flows` package.
