...
This workflow creates one or more product options. It's used by the [Create Product Option Admin API Route](https://docs.medusajs.com/api/admin#product-options\_postproductoptions).
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/b9f64590e75a037f97760b6bfe5bef715f4e5938/packages/core/core-flows/src/product/workflows/create-product-options.ts#L64" />
