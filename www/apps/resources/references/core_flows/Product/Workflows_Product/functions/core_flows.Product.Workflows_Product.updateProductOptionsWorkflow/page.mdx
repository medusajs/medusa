...
This workflow updates one or more product options. It's used by the [Update Product Option Admin API Route](https://docs.medusajs.com/api/admin#product-options\_postproductoptionsid).
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/9aadd07b63d005d57b912b202144ef3f96bf2c90/packages/core/core-flows/src/product/workflows/update-product-options.ts#L58" />
