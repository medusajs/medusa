...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/product/workflows/delete-product-variants.ts#L54" />
...
<TypeList types={[{"name":"DeleteProductVariantsWorkflowInput","type":"[DeleteProductVariantsWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.DeleteProductVariantsWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"DeleteProductVariantsWorkflowInput","type":"`object`","description":"The data to delete one or more product variants.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="deleteProductVariantsWorkflow"/>
