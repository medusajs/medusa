---
slug: /references/medusa-workflows/steps/revokeApiKeysStep
sidebar_label: revokeApiKeysStep
tags:
  - api key
  - step
---
...
This documentation provides a reference to the `revokeApiKeysStep`. It belongs to the `@medusajs/medusa/core-flows` package.
...
<TypeList types={[{"name":"RevokeApiKeysStepInput","type":"[RevokeApiKeysStepInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.RevokeApiKeysStepInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"RevokeApiKeysStepInput","type":"`object`","description":"The data to revoke API keys.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="revokeApiKeysStep"/>
