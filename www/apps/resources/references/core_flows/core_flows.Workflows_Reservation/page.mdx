...
<WorkflowDiagram workflow={{"name":"createReservationsWorkflow","steps":[{"type":"step","name":"createReservationsStep","description":"This step creates one or more reservations.","link":"../Steps_Reservation/functions/core_flows.Steps_Reservation.createReservationsStep/page.mdx","depth":1}]}} />
...
<WorkflowDiagram workflow={{"name":"deleteReservationsWorkflow","steps":[{"type":"step","name":"deleteReservationsStep","description":"This step deletes one or more reservations.","link":"../Steps_Reservation/functions/core_flows.Steps_Reservation.deleteReservationsStep/page.mdx","depth":1}]}} />
...
<WorkflowDiagram workflow={{"name":"updateReservationsWorkflow","steps":[{"type":"step","name":"updateReservationsStep","description":"This step updates one or more reservations.","link":"../Steps_Reservation/functions/core_flows.Steps_Reservation.updateReservationsStep/page.mdx","depth":1}]}} />
