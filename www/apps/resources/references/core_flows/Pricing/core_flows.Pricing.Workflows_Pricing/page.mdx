...
<WorkflowDiagram workflow={{"name":"createPricePreferencesWorkflow","steps":[{"type":"step","name":"createPricePreferencesStep","description":"This step creates one or more price preferences.","link":"../../Steps_Pricing/functions/core_flows.Steps_Pricing.createPricePreferencesStep/page.mdx","depth":1}]}} />
