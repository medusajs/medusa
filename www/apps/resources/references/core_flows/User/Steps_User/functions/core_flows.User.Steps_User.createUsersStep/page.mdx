...
you must attach an auth identity to each user using the [setAuthAppMetadataStep](../../../../Auth/Steps_Auth/functions/core_flows.Auth.Steps_Auth.setAuthAppMetadataStep/page.mdx).
