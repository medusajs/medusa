...
This documentation provides a reference to the `updateUsersWorkflow`. It belongs to the `@medusajs/core-flows` package.

This workflow updates one or more users.

## Diagram

<WorkflowDiagram workflow={{"name":"updateUsersWorkflow","steps":[{"type":"step","name":"updateUsersStep","description":"This step updates one or more stores.","link":"../core_flows.User.updateUsersStep/page.mdx","depth":1}]}} />
