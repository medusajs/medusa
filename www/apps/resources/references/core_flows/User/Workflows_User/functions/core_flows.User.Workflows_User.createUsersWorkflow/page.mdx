...
as [acceptInviteWorkflow](../../../../Invite/Workflows_Invite/functions/core_flows.Invite.Workflows_Invite.acceptInviteWorkflow/page.mdx) to create a user for an invite.

You can attach an auth identity to each user to allow the user to log in using the
[setAuthAppMetadataStep](../../../../Auth/Steps_Auth/functions/core_flows.Auth.Steps_Auth.setAuthAppMetadataStep/page.mdx). Learn more about auth identities in
...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/user/workflows/create-users.ts#L45" />
