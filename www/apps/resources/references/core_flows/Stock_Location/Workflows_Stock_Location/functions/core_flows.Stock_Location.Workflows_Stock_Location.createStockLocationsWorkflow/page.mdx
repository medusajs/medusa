...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/stock-location/workflows/create-stock-locations.ts#L45" />
...
<TypeList types={[{"name":"CreateStockLocationsWorkflowInput","type":"[CreateStockLocationsWorkflowInput](../../../../core_core_flows_src/interfaces/core_flows.core_core_flows_src.CreateStockLocationsWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"CreateStockLocationsWorkflowInput","type":"`object`","description":"The data to create the stock locations.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="createStockLocationsWorkflow"/>
