...
<WorkflowDiagram workflow={{"name":"deleteCustomerGroupsWorkflow","steps":[{"type":"step","name":"deleteCustomerGroupStep","description":"This step deletes one or more customer groups.","link":"../../../../Steps_Customer_Group/functions/core_flows.Steps_Customer_Group.deleteCustomerGroupStep/page.mdx","depth":1}]}} />
