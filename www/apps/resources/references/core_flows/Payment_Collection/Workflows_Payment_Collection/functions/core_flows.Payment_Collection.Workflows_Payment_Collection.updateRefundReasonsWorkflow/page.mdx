...
<WorkflowDiagram workflow={{"name":"updateRefundReasonsWorkflow","steps":[{"type":"step","name":"updateRefundReasonsStep","description":"This step updates one or more refund reasons.","link":"../../../../Steps_Payment_Collection/functions/core_flows.Steps_Payment_Collection.updateRefundReasonsStep/page.mdx","depth":1}]}} />
