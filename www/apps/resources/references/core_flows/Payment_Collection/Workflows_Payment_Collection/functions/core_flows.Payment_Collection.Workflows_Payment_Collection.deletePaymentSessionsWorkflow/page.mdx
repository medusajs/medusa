...
[refreshPaymentCollectionForCartWorkflow](../../../../Cart/Workflows_Cart/functions/core_flows.Cart.Workflows_Cart.refreshPaymentCollectionForCartWorkflow/page.mdx) to delete payment sessions when the cart's total changes.

You can use this workflow within your own customizations or custom workflows, allowing you
to delete payment sessions in your custom flows.

<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/payment-collection/workflows/delete-payment-sessions.ts#L41" />
