...
<WorkflowDiagram workflow={{"name":"createRefundReasonsWorkflow","steps":[{"type":"step","name":"createRefundReasonStep","description":"This step creates one or more refund reasons.","link":"../../../../Steps_Payment_Collection/functions/core_flows.Steps_Payment_Collection.createRefundReasonStep/page.mdx","depth":1}]}} />
