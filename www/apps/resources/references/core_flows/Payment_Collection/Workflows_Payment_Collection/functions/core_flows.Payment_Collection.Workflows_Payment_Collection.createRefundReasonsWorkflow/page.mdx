...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/payment-collection/workflows/create-refund-reasons.ts#L40" />
...
<TypeList types={[{"name":"CreateRefundReasonsWorkflowInput","type":"[CreateRefundReasonsWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.CreateRefundReasonsWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"CreateRefundReasonsWorkflowInput","type":"`object`","description":"The data to create refund reasons.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="createRefundReasonsWorkflow"/>
