...
<WorkflowDiagram workflow={{"name":"cancelOrderChangeWorkflow","steps":[{"type":"step","name":"cancelOrderChangeStep","description":"This step cancels an order change.","link":"../../../../Steps_Order/functions/core_flows.Steps_Order.cancelOrderChangeStep/page.mdx","depth":1}]}} />
