...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/order/workflows/on-carry-promotions-flag-set.ts#L169" />
...
<TypeList types={[{"name":"OnCarryPromotionsFlagSetWorkflowInput","type":"[OnCarryPromotionsFlagSetWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.OnCarryPromotionsFlagSetWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"OnCarryPromotionsFlagSetWorkflowInput","type":"`object`","description":"The data to set the carry over promotions flag for an order change.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="onCarryPromotionsFlagSet"/>
