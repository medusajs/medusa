...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/order/workflows/create-order-payment-collection.ts#L47" />
...
<TypeList types={[{"name":"CreateOrderPaymentCollectionWorkflowInput","type":"[CreateOrderPaymentCollectionWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.CreateOrderPaymentCollectionWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"CreateOrderPaymentCollectionWorkflowInput","type":"`object`","description":"The details of the payment collection to create.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="createOrderPaymentCollectionWorkflow"/>
