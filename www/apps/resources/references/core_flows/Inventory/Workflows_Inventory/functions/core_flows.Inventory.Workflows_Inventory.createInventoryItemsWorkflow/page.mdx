...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/inventory/workflows/create-inventory-items.ts#L110" />
...
<TypeList types={[{"name":"CreateInventoryItemsWorkflowInput","type":"[CreateInventoryItemsWorkflowInput](../../../../core_core_flows_src/interfaces/core_flows.core_core_flows_src.CreateInventoryItemsWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"CreateInventoryItemsWorkflowInput","type":"`object`","description":"The data to create the inventory items.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="createInventoryItemsWorkflow"/>
