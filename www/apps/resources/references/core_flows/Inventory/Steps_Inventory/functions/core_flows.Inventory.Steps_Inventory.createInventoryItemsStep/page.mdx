...
import { createInventoryItemsStep } from "@medusajs/medusa/core-flows"

const myWorkflow = createWorkflow(
  "my-workflow",
  () => {
    const data = createInventoryItemsStep({})
  }
)
```
