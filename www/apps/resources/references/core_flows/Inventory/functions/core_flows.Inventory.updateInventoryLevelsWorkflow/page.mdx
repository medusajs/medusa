...
<WorkflowDiagram workflow={{"name":"updateInventoryLevelsWorkflow","steps":[{"type":"step","name":"updateInventoryLevelsStep","description":"This step updates one or more inventory levels.","link":"../core_flows.Inventory.updateInventoryLevelsStep/page.mdx","depth":1}]}} />
