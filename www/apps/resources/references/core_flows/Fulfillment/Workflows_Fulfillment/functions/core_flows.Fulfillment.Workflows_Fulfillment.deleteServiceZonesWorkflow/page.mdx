...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/699a9a85c795e13f9e787056e0fb65cfea0115dc/packages/core/core-flows/src/fulfillment/workflows/delete-service-zones.ts#L34" />
...
<TypeList types={[{"name":"DeleteServiceZonesWorkflowInput","type":"[DeleteServiceZonesWorkflowInput](../../../../core_core_flows_src/types/core_flows.core_core_flows_src.DeleteServiceZonesWorkflowInput/page.mdx)","optional":false,"defaultValue":"","description":"","expandable":false,"children":[{"name":"DeleteServiceZonesWorkflowInput","type":"`object`","description":"The data to delete one or more service zones.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.medusajs.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="deleteServiceZonesWorkflow"/>
