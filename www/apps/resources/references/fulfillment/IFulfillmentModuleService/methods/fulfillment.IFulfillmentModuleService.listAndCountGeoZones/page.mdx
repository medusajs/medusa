...
slug: /references/fulfillment/listAndCountGeoZones
sidebar_label: listAndCountGeoZones
---
...
This documentation provides a reference to the `listAndCountGeoZones` method. This belongs to the Fulfillment Module.
