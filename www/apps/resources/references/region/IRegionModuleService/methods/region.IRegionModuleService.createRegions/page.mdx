...
slug: /references/region/createRegions
sidebar_label: createRegions
---

import { TypeList } from "docs-ui"

# createRegions - Region Module Reference

This documentation provides a reference to the `createRegions` method. This belongs to the Region Module.
