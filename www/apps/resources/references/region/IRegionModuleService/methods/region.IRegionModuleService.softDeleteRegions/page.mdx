...
slug: /references/region/softDeleteRegions
sidebar_label: softDeleteRegions
---

import { TypeList } from "docs-ui"

# softDeleteRegions - Region Module Reference

This documentation provides a reference to the `softDeleteRegions` method. This belongs to the Region Module.
