...
slug: /references/region/restoreRegions
sidebar_label: restoreRegions
---

import { TypeList } from "docs-ui"

# restoreRegions - Region Module Reference

This documentation provides a reference to the `restoreRegions` method. This belongs to the Region Module.
