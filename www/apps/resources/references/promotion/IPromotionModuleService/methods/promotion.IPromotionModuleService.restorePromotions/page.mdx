...
slug: /references/promotion/restorePromotions
sidebar_label: restorePromotions
---

import { TypeList } from "docs-ui"

# restorePromotions - Promotion Module Reference

This documentation provides a reference to the `restorePromotions` method. This belongs to the Promotion Module.
