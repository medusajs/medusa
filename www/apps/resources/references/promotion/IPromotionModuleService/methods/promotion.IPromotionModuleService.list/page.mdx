...
slug: /references/promotion/list
sidebar_label: list
---

import { TypeList } from "docs-ui"

# list - Promotion Module Reference

This documentation provides a reference to the `list` method. This belongs to the Promotion Module.
