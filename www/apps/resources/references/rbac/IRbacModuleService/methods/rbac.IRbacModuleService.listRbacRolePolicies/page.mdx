...
slug: /references/rbac/listRbacRolePolicies
sidebar_label: listRbacRolePolicies
---

import { TypeList } from "docs-ui"

# listRbacRolePolicies - RBAC Module Reference
...
This documentation provides a reference to the `listRbacRolePolicies` method. This belongs to the RBAC Module.
