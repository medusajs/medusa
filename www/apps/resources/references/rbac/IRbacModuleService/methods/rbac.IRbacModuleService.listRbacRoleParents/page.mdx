...
slug: /references/rbac/listRbacRoleParents
sidebar_label: listRbacRoleParents
---

import { TypeList } from "docs-ui"

# listRbacRoleParents - RBAC Module Reference
...
This documentation provides a reference to the `listRbacRoleParents` method. This belongs to the RBAC Module.
