...
slug: /references/rbac/listRbacPolicies
sidebar_label: listRbacPolicies
---

import { TypeList } from "docs-ui"

# listRbacPolicies - RBAC Module Reference
...
This documentation provides a reference to the `listRbacPolicies` method. This belongs to the RBAC Module.
