...
slug: /references/rbac/listRbacRoles
sidebar_label: listRbacRoles
---

import { TypeList } from "docs-ui"

# listRbacRoles - RBAC Module Reference
...
This documentation provides a reference to the `listRbacRoles` method. This belongs to the RBAC Module.
