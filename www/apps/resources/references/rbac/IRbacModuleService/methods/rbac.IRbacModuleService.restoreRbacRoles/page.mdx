...
slug: /references/rbac/restoreRbacRoles
sidebar_label: restoreRbacRoles
---

import { TypeList } from "docs-ui"

# restoreRbacRoles - RBAC Module Reference
...
This documentation provides a reference to the `restoreRbacRoles` method. This belongs to the RBAC Module.
