...
slug: /references/rbac/restoreRbacPolicies
sidebar_label: restoreRbacPolicies
---

import { TypeList } from "docs-ui"

# restoreRbacPolicies - RBAC Module Reference
...
This documentation provides a reference to the `restoreRbacPolicies` method. This belongs to the RBAC Module.
