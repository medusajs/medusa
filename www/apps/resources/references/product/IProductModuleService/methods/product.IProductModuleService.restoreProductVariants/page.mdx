...
slug: /references/product/restoreProductVariants
sidebar_label: restoreProductVariants
---

import { TypeList } from "docs-ui"

# restoreProductVariants - Product Module Reference

This documentation provides a reference to the `restoreProductVariants` method. This belongs to the Product Module.

This method is used to restore variants which were deleted using the softDelete method.
