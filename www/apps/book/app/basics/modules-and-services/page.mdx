...
You use the `Module` function imported from `@medusajs/utils` to create the module definition.

It accepts an object parameter with the required property `service`, whose value is the module's main service.
