...
The Next.js Starter is compatible with some Medusa integrations out-of-the-box, such as Stripe. You can also change some of its configurations if necessary.
