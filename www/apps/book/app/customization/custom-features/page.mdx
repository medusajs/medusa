...
1. A module whose main service interacts with the database or integrates a third-party service.
2. A workflow that implements the steps of a custom functionality, such as creating a brand. You implement functionalities in a workflow to benefit from features such as roll-back in case of errors, retry configurations, and more.
