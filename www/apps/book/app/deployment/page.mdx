...
## Deploying the Medusa Server with the Admin

<Note type="soon">

Admin deployment details coming soon.
...
Admin deployment details are still in progress.

</Note>

### Deploy Admin with the Server

Since the Medusa Admin is installed in the server, you may choose to host them together. 
...
1. Disable the `autoRebuild` option of the Medusa Admin. 
