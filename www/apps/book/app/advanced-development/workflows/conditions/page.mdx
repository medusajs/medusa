...
In this chapter, you'll learn how to execute an action based on a condition using the when-then utility.

## What is the When-Then Utility?

The when-then utility is a function that executes an action if a condition is satisfied.
