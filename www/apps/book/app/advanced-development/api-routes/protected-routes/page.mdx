...
If you opt-out of authentication in a route as mentioned in the [previous section](#authentication-opt-out), you can't access the authenticated user anymore. Use the [authenticate middleware](#protect-custom-api-routes) instead.
