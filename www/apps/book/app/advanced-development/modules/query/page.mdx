...
In your resources, such as API routes or workflows, you can resolve the Query to fetch data across custom modules and Medusa’s commerce modules.
...
export const exampleHighlights = [
  ["13", "", "Resolve the Query from the Medusa container."],
