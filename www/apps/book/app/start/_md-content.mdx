...
### 1a. Node.js (v20.19.0+ or v22.12.0+, LTS only, but not v25+)

```bash
node --version
```

Required: Node.js `^20.19.0` or `>=22.12.0` (LTS versions only, `<= 24`). The Next.js Starter Storefront does not support Node.js v25+.
