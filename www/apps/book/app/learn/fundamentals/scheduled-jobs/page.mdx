...
export const highlights = [
  ["6", "greetingJob", "The scheduled job function to execute at a specified interval."]
  ["6", "container", "Receive the Medusa container as a parameter"],
  ["7", "logger", "Resolve the logger from the container"],
  ["14", "config", "The scheduled job's configurations."],
  ["15", "name", "The job's unique name"],
  ["16", "schedule", "The schedule to run the job on."]
]
