...
For example, to inject the Cache Module:
...
In this example, you inject the Cache Module's service into your module's container.
...
You can then resolve the injected module's service in your module's service constructor.