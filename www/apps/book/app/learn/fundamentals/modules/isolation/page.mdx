...
- Use [Module Links](../../../fundamentals/module-links/page.mdx) to extend an existing module's data models, and [Query](../../query/page.mdx) to retrieve data across modules.
...
Then, you can retrieve data across modules using [Query](../../query/page.mdx).
...
Some Framework APIs and tools are not registered in the module's container. For example, [Query](../../query/page.mdx) is only registered in the Medusa container.
