...
## API Routes that Disallow Retrievable Fields

Some of Medusa's API routes block specific field path segments as a hard security boundary, which means you can't retrieve them even if you override the allowed fields and relations.

Learn more about disallowed fields, how to apply them to custom API routes, and how to override them in the [Disallowed Fields in API Routes](../disallowed-fields/page.mdx) chapter.
