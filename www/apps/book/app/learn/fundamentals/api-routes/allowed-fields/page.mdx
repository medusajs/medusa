...
In this example, you apply a middleware to the [Get Customer Store API Route](!api!/store/customers/get-customer).
...
Push the normalized field path, without a `*`, `+`, or `.*` prefix or suffix.
