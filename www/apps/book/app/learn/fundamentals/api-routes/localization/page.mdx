...
To retrieve data models with translated fields, pass the `locale` property in the second parameter object of [Query](/learn/fundamentals/query) when querying your data.
...
Learn more in the [Query](../../query/page.mdx#retrieve-localized-data) chapter.
