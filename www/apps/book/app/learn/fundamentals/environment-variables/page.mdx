...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      <Table.Cell>
        `MEDUSA_CLOUD_OTLP_TRACES_EXPORTER_URL`
      </Table.Cell>
      <Table.Cell>
        URL for exporting OpenTelemetry trace data in Medusa Cloud environments. Learn more in the [Instrumentation](../../debugging-and-testing/instrumentation/page.mdx#medusa-cloud-integration) chapter.
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
    ...
    <Table.Row>
      <Table.Cell>
        `MEDUSA_CLOUD_OTLP_TRACES_EXPORTER_HEADERS`
      </Table.Cell>
      <Table.Cell>
        JSON string of headers for OpenTelemetry trace export in Medusa Cloud environments.
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
    ...
    <Table.Row>
      <Table.Cell>
        `MEDUSA_CLOUD_OTLP_METRICS_EXPORTER_URL`
      </Table.Cell>
      <Table.Cell>
        URL for exporting OpenTelemetry metrics data in Medusa Cloud environments.
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
    ...
    <Table.Row>
      <Table.Cell>
        `MEDUSA_CLOUD_OTLP_METRICS_EXPORTER_HEADERS`
      </Table.Cell>
      <Table.Cell>
        JSON string of headers for OpenTelemetry metrics export in Medusa Cloud environments.
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
