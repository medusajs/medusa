...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        A random string used to create authentication tokens in the http layer. Only used if [projectConfig.http.jwtSecret](../../configurations/medusa-config/page.mdx#http-jwtSecret-1-3) isn't set in `medusa-config.ts`. **Required in production environments.**
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        A random string used to create cookie tokens in the http layer. Only used if [projectConfig.http.cookieSecret](../../configurations/medusa-config/page.mdx#http-cookieSecret-1-5) isn't set in `medusa-config.ts`. **Required in production environments.**
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        The JWKS URI for the Medusa Cloud OAuth service. Used to verify JWT tokens issued by the Medusa Cloud OAuth service. Only used if [projectConfig.cloud.oauthJwksUri](../../configurations/medusa-config/page.mdx#cloud-oauthJwksUri) isn't set in `medusa-config.ts`. **Required when using Medusa Cloud OAuth authentication.**
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
    ...
    <Table.Row>
      ...
      <Table.Cell>
        The expected `aud` claim of id_tokens issued by the Medusa Cloud OAuth service. Only used if [projectConfig.cloud.oauthAudience](../../configurations/medusa-config/page.mdx#cloud-oauthAudience) isn't set in `medusa-config.ts`. **Required when using Medusa Cloud OAuth authentication.**
      </Table.Cell>
      <Table.Cell>
        \-
      </Table.Cell>
