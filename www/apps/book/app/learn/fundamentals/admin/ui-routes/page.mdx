...
The UI route component must be created as an arrow function. The [Admin ESLint Plugin](../eslint/page.mdx) enforces this and other UI route development patterns automatically.
