...
The `__BACKEND_URL__` global variable is injected by the admin bundler at build time. You can learn more about available global variables and environment variables in the [Admin Environment Variables](../environment-variables/page.mdx) chapter.
