...
For example, consider you're creating an API route that retrieves products based on filters using [Query](../../fundamentals/query/page.mdx), a tool that fetches data across the application. In the API route's function, you can resolve Query from the container passed to the API route and use it:
...
You can learn more about how Query works in [this chapter](../../fundamentals/query/page.mdx).
