...
1. Data models collected in the [Query's graph](../query/page.mdx#querying-the-graph). These types provide you with auto-completion and type checking when using Query.
