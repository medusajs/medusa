...
{/* TODO: confirm whether a `.npmrc` entry or `pnpm.overrides` block is required for pnpm users, and document Vite alias ordering for Dashboard HMR. Flagged in #15406. */}
