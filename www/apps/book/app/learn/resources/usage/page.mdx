...
Telemetry data is collected when Medusa CLI commands that emit telemetry events are run. For example, `medusa start` and some other CLI commands send usage events.
