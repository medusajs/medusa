...
- `useQueryGraphStep`: a step that Medusa provides to retrieve data using [Query](../../../fundamentals/query/page.mdx). You'll use this to retrieve the brand's details using its ID.
