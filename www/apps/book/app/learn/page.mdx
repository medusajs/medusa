...
### Learn Medusa with an AI Agent

If you prefer to learn Medusa interactively with an AI agent, install the `learn-medusa` plugin in Claude Code (or another AI agent) and follow a step-by-step guided experience:
...
The interactive learning experience guides you through building a brands feature step by step, covering the same concepts as the chapters in this documentation. Refer to the [Agentic Skills guide](./introduction/build-with-llms-ai/agentic-skills/page.mdx) for more details and instructions for other AI agents.
