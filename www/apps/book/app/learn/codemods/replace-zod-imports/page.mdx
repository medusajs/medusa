...
Starting from [Medusa v2.13.7](https://github.com/medusajs/medusa/releases/tag/v2.13.7), Zod has been upgraded to v4, which introduces breaking changes to the Zod API. You may need to update your validation schemas accordingly. See the [Zod v4 upgrade guide](https://zod.dev/UPGRADE_GUIDE#zod-v4) for details.
...
- **Check for Zod v4 breaking changes**: If upgrading to Medusa v2.13.7+, review your Zod schemas for breaking changes. Common issues include:
