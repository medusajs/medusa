...
This API route executes a `createPostWorkflow` workflow that creates a new record of `Post`. The workflow's implementation isn't shown here, as it isn't relevant to writing the test. Learn how to create a workflow in the [Workflows](../../../../fundamentals/workflows/page.mdx) chapter.
...
This API route accepts an ID path parameter, and executes a `deletePostWorkflow` workflow that deletes a `Post` record by that ID. As with the previous example, the workflow's implementation isn't shown here.
...
export const adminHighlights = [
  ["9", "headers", "Define the headers that you'll pass in the request."],
  ["11", "beforeEach", "Run before every test."],
  ["21", "user", "Create the admin user."],
  ["25", "authIdentity", "Create the auth identity for the user."],
  ["40", "token", "Generate a JWT token for the user."],
  ["52", "headers", "Set the token in the Authorization header."],
  ["57", "headers", "Pass the headers to the request."]
]
...
export const customerHighlights = [
  ["11", "headers", "Define the headers that you'll pass in the request."],
  ["13", "beforeEach", "Run before every test."],
  ["23", "customer", "Create the customer."],
  ["27", "authIdentity", "Create the auth identity for the customer."],
  ["42", "token", "Generate a JWT token for the customer."],
  ["54", "headers", "Set the token in the Authorization header."],
  ["57", "pak", "Create a publishable API key"],
  ["69", "headers", "Set the publishable API key in the request's header."],
  ["74", "headers", "Pass the headers to the request."]
]
