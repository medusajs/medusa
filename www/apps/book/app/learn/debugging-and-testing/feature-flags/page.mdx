...
For example, to enable the [Index Module](../../fundamentals/query/index-module/page.mdx)'s feature flag in `medusa-config.ts`:
...
For example, to enable the [Index Module](../../fundamentals/query/index-module/page.mdx)'s feature flag using an environment variable:
