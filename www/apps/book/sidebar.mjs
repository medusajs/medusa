  ...
  sidebarAttachHrefCommonOptions([
    ...
    },
    {
      ...
      children: [
        ...
        {
          type: "link",
          path: "/learn/basics/modules-and-services",
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            {
              type: "link",
              path: "/learn/advanced-development/modules/module-links",
              title: "Module Links",
            },
            {
              type: "link",
              path: "/learn/advanced-development/modules/module-link-directions",
              title: "Module Link Direction",
            },
            {
              type: "link",
              path: "/learn/advanced-development/modules/remote-link",
              title: "Remote Link",
            },
            {
              type: "link",
              path: "/learn/advanced-development/modules/query",
              title: "Query",
            },
            {
              type: "link",
    ...
    {
      type: "link",
      path: "/learn/architectural-modules",
