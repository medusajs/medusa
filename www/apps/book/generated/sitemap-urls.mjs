export const sitemapUrls = [
  ...
  "/learn/fundamentals/api-routes/allowed-fields",
  "/learn/fundamentals/api-routes/cors",
  "/learn/fundamentals/api-routes/disallowed-fields",
  ...
  "/learn/fundamentals/query/index-module",
  "/learn/fundamentals/query",
  "/learn/fundamentals/query/query-context",
  "/learn/fundamentals/query/search",
  ...
  "/learn/introduction/build-with-llms-ai/mcp-server/migrate-from-magento",
  "/learn/introduction/build-with-llms-ai/mcp-server/migrate-from-shopify",
  "/learn/introduction/build-with-llms-ai/mcp-server/migrate-from-woocommerce",
  "/learn/introduction/build-with-llms-ai/mcp-server",
  "/learn/introduction/build-with-llms-ai/mcp-server/submit-feedback",
  "/learn/introduction/build-with-llms-ai/mcp-server/upgrade-instructions",
