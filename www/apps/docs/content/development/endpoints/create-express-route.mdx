...
# Create Endpoint - Express Router Approach

In this document, you’ll learn how to create endpoints in Medusa using the express router approach.

:::note

Following v1.17.2 of `@medusajs/medusa`, it's highly recommended to use the [File-Routing Approach](./create.mdx) instead. Future versions of Medusa may drop support of this approach.
