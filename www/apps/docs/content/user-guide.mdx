...
Refer to [this documentation](./cli/reference.mdx#user) on how to create a user.
...
The Medusa Admin supports multiple-languages, with English being the default one. Check out available languages [here](./user-guide/tips/languages/index.mdx).

Learn how to change the language in [this guide](./user-guide/settings/profile/index.mdx#change-admin-language).
