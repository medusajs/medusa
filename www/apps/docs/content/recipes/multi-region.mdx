...
<DocCardList colSize={4} items={[
  {
    type: 'link',
    href: '/user-guide/settings/taxes/manage',
...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/user-guide/settings/regions/providers',
...
<DocCardList colSize={6} items={[
  {
    type: 'link',
    href: '/user-guide/products/manage#edit-product-variant-prices',
...
<DocCardList colSize={4} items={[
  ...
  {
    type: 'link',
    href: '/user-guide/settings/locations',
