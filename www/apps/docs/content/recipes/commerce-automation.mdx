...
<Details>
  <DetailsSummary>Example: Sending an email for new notes</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Synchronizing products with a third-party service</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Add customer to VIP group</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Sending a newsletter email after adding ten products</DetailsSummary>
