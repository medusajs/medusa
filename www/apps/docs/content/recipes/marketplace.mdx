...
<Details>
  <DetailsSummary>Example: Associate User with Store</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Extend User Service</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Listen to Order Created Event</DetailsSummary>
