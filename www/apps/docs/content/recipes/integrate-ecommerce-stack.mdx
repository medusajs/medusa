...
<Details>
  <DetailsSummary>Example: Create a service for an ERP system</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Update products across systems with workflows</DetailsSummary>
...
<Details>
  <DetailsSummary>Example: Create a webhook listener for ERP changes</DetailsSummary>
