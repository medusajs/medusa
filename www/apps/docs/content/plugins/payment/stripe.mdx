...
You can refer to [this documentation in the user guide](../../user-guide/settings/regions/providers/index.mdx#manage-payment-providers) to learn how to add a payment processor like Stripe to a region.
