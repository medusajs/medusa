...
4. If the payment is confirmed successfully, [complete the cart](https://docs.medusajs.com/v1/api/store#carts_postcartscartcomplete) in Medusa. Otherwise show an error.
