...
You can use the [Medusa Admin](../../user-guide/products/manage.mdx#manage-product-variants) or the [Admin REST API Routes](https://docs.medusajs.com/v1/api/admin#products_postproductsproductvariantsvariant) to update the quantity.
