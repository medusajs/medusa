...
<DocCardList colSize={4} items={[
  {
    type: 'link',
    href: '/modules/price-lists/serverless-module',
    label: 'Pricing Module',
    customProps: {
      icon: Icons['currency-dollar-solid'],
      description: 'Learn how you can use the pricing module in a serverless setup.',
      badge: {
        variant: 'orange',
        children: 'Beta'
      }
  ...
  {
    type: 'link',
    href: '/contribution/admin-translations',
    label: 'Multi-language Support in Admin',
    customProps: {
      icon: Icons['globe-europe-solid'],
      description: 'Contribute by translating the admin to your language.'
    }
  },
  {
    type: 'link',
