...
Using Medusa’s [Batch Job Admin APIs](https://docs.medusajs.com/v1/api/admin#batch-jobs), you can import prices into a price list.
...
You can use the [Create Price List API Route](https://docs.medusajs.com/v1/api/admin#price-lists_postpricelistspricelist), or follow the [how-to guide to learn how to create and manage price lists using the Admin API](./manage-price-lists.mdx).
...
- [Batch Jobs API Reference](https://docs.medusajs.com/v1/api/admin#batch-jobs)
