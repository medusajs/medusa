---
description: 'Learn how to implement gift card functionalities for admins using the REST APIs. This includes how to create, update, and delete gift cards, as well as customer gift cards.'
addHowToData: true
---
...
- Manage product gift cards including retrieving, adding, updating, and deleting them.
- Managing customer gift cards including retrieving, adding, updating and deleting them.
...
## Manage Customer Gift Cards

This section covers how to manage customer gift cards. You can create an unlimited number of customer gift cards.

### List Customer Gift Cards

You can retrieve all customer gift cards by sending a request to the [List Gift Cards API Route](https://docs.medusajs.com/api/admin#gift-cards_getgiftcards):
      ...
      return (
        <div>
          ...
          {gift_cards && !gift_cards.length && (
            <span>No customer gift cards...</span>
          )}
...
### Create a Customer Gift Card

Merchants can create customer gift cards to send a reward or gift to the customer.

You can create a customer gift card by sending a request to the [Create a Gift Card API Route](https://docs.medusajs.com/api/admin#gift-cards_postgiftcards):
...
You can delete a customer gift card by sending a request to the [Delete a Gift Card API Route](https://docs.medusajs.com/api/admin#gift-cards_deletegiftcardsgiftcard):
