...
Admins can manage their main gift card with unlimited denominations as a regular product.
...
<DocCardList colSize={6} items={[
  ...
  {
    type: 'link',
    href: '/user-guide/products/gift-cards/product-gift-card',
    label: 'User Guide: Manage Product Gift Cards',
    customProps: {
      icon: Icons['users-solid'],
      description: 'Learn how to manage product gift cards using Medusa Admin.'
    }
  },
]} />
...
Admins can create customer gift cards that are sent to specific customers. These customers can then use the gift card during checkout, the same way they would if they purchased one.

<DocCardList colSize={4} items={[
  {
    type: 'link',
    href: '/user-guide/products/gift-cards/customer-gift-card',
    label: 'User Guide: Customer Gift Cards',
    customProps: {
      icon: Icons['users-solid'],
      description: 'Learn how to manage customer gift cards using Medusa Admin.'
    }
  },
  {
    type: 'link',
    href: '/modules/gift-cards/admin/manage-gift-cards#manage-customer-gift-cards',
    label: 'Admin: Manage Customer Gift Cards',
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to manage customer gift cards using Admin APIs.'
    }
  },
  {
    type: 'link',
    ...
    customProps: {
      icon: Icons['academic-cap-solid'],
      description: 'Learn how to use send a customer gift card code to a customer.'
    }
  },
]} />
