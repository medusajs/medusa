...
Using the [region admin REST APIs](https://docs.medusajs.com/api/admin#regions), you can manage regions in your store, including creating, updating, and deleting regions.
