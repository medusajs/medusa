...
Refer to [this user guide](https://docs.medusajs.com/user-guide/users/profile#change-admin-language) to learn how to switch the language of the Medusa admin.
