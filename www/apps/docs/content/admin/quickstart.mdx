...
Medusa supports multiple languages and translations. Check out available languages [here](../user-guide/tips/languages/index.mdx).

Refer to [this user guide](../user-guide/settings/profile/index.mdx#change-admin-language) to learn how to switch the language of the Medusa Admin.
