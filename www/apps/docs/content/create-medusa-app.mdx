...
<Details>
  <DetailsSummary>Command Options</DetailsSummary>
...
<Details className="border-t-0">
  <DetailsSummary>Example: Connect to a Vercel PostgreSQL Database</DetailsSummary>
...
<Details className="border-t-0">
  <DetailsSummary>Example: Connect to a Supabase Database</DetailsSummary>
