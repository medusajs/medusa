...
The Stock Location Module is the `@medusajs/stock-location` NPM package that provides stock-location-related features in your Medusa and Node.js applications.
