...
- Medusa Backend: Use the Pricing Module in the Medusa backend or replace it with your custom module. To use the Pricing Module in the backend, make sure to [enable the `medusa_v2` feature flag](../../development/feature-flags/toggle.md).
