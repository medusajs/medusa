...
Refer to [the method’s reference](../../../references/promotion/IPromotionModuleService/methods/promotion.IPromotionModuleService.computeActions.mdx) for full details on this method’s parameters and return type.
...
Refer to [this reference](../../../references/promotion/interfaces/promotion.AddItemAdjustmentAction.mdx) for details on the object’s properties.
...
Refer to [this reference](../../../references/promotion/interfaces/promotion.RemoveItemAdjustmentAction.mdx) for details on the object’s properties.
...
Refer to [this reference](../../../references/promotion/interfaces/promotion.AddShippingMethodAdjustment.mdx) for details on the object’s properties.
...
Refer to [this reference](../../../references/promotion/interfaces/promotion.RemoveShippingMethodAdjustment.mdx) for details on the object’s properties.
...
Refer to [this reference](../../../references/promotion/interfaces/promotion.CampaignBudgetExceededAction.mdx) for details on the object’s properties.
