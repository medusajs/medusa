...
By default, the tax amout is calculated by taking the tax rate from the line item or shipping method’s amount, and then added to the item/method’s subtotal.
