...
Learn more about actions in the [Promotion Module’s documentation](../../promotion/actions/index.mdx).
...
The `LineItem` data model has a `is_discountable` field that indicates whether promotions can be applied to the line item. It’s enabled by default.
