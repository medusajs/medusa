...
You can use the Cart Module's main service by resolving from the dependency container the resource `ModuleRegistrationName.CART` imported from `@medusajs/modules-sdk`.
