...
You can use the Auth Module's main service by resolving from the dependency container the resource `ModuleRegistrationName.AUTH` imported from `@medusajs/modules-sdk`.
