...
As explained in the [Auth Provider](../auth-providers/index.mdx) guide, when a user or customer is authenticated, you receive an `authUser` object:
...
Learn more about the `AuthUser`'s attributes in [this reference](../../../references/auth_models/classes/auth_models.AuthUser.mdx).
