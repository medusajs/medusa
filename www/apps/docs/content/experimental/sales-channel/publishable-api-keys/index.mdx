...
To create a publishable API key, either use the [Medusa Admin](../../../user-guide/settings/developer/api-key-management/index.mdx) or the [Admin API Routes](https://docs.medusajs.com/api/admin#publishable-api-keys).
