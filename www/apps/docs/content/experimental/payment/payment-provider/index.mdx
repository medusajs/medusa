...
Refer to [this guide](../../../references/payment_provider/classes/payment_provider.AbstractPaymentProvider.mdx) on how to create a payment provider for the Payment Module.
...
Learn more about this option in [this documentation](../module-options/index.mdx#providers).
