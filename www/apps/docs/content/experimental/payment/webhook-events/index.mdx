...
Learn more about the method’s parameters and return types in [this reference](../../../references/payment/IPaymentModuleService/methods/payment.IPaymentModuleService.processEvent.mdx).
