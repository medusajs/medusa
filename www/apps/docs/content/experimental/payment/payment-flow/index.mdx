...
Learn more about the `createPaymentCollections` method in [this reference](../../../references/payment/IPaymentModuleService/methods/payment.IPaymentModuleService.createPaymentCollections.mdx).
...
Learn more about the `createPaymentSession` method in [this reference](../../../references/payment/IPaymentModuleService/methods/payment.IPaymentModuleService.createPaymentSession.mdx).
...
Learn more about the `authorizePaymentSession` method in [this reference](../../../references/payment/IPaymentModuleService/methods/payment.IPaymentModuleService.authorizePaymentSession.mdx).
...
You can then use the payment to capture the amount using the [capturePayment method](../../../references/payment/IPaymentModuleService/methods/payment.IPaymentModuleService.capturePayment.mdx). You can also refund captured amounts using the [refundPayment method](../../../references/payment/IPaymentModuleService/methods/payment.IPaymentModuleService.refundPayment.mdx).
