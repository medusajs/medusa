...
The bulk editor is used in different areas of the Medusa Admin, including the [Edit Product Variant Prices](../../products/manage/index.mdx#edit-product-variant-prices) form.
