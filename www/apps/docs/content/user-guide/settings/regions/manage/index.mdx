...
To manage the tax-inclusive pricing option, enable the `tax_inclusive_pricing` feature flag. Learn more about it in [this guide](../../../../development/feature-flags/toggle.md).
...
3. In the form that opens:
    ...
    2. Choose the region's currency in the Currency field. If you can't find a currency, make sure to [add it to the store first](../../store/index.mdx#add-currencies).
...
This opens the taxes page of the region. Learn more about managing taxes in [this guide](../../taxes/manage/index.mdx).
