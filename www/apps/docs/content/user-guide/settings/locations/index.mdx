...
This feature requires installing the [Stock Location Module](../../experimental/stock-location/index.mdx).
...
An [inventory item's](../../inventory/index.mdx) quantity is set per location.
