...
Taxes in Medusas are directly associated with [Regions](../regions/index.mdx). As regions and countries often have different tax rates and rules, Medusa supports specifying the tax rate for each region.
...
- [Manage Taxes](./manage/index.mdx)
- [Manage Tax Rates](./tax-rates/index.mdx)
