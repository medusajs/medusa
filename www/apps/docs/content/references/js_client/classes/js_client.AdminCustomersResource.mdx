...
Customers can either be created when they register through the [CustomersResource.create](js_client.CustomersResource.mdx#create) method, or created by the admin using the [create](js_client.AdminCustomersResource.mdx#create) method.
...
<ParameterTypes parameters={[
  {
    "name": "payload",
    "type": "[AdminPostCustomersReq](../../medusa/classes/medusa.AdminPostCustomersReq.mdx)",
...
<ParameterTypes parameters={[
  {
    ...
    "type": "ResponsePromise&#60;AdminCustomersRes&#62;",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  ...
  {
    "name": "payload",
    "type": "[AdminPostCustomersCustomerReq](../../medusa/classes/medusa.AdminPostCustomersCustomerReq.mdx)",
