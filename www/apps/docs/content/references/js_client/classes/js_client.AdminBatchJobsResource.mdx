...
A batch job is a task that is performed by the Medusa backend asynchronously. For example, the Import Product feature is implemented using batch jobs.
...
<ParameterTypes parameters={[
  {
    ...
    "type": "ResponsePromise&#60;AdminBatchJobRes&#62;",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "payload",
    "type": "[AdminPostBatchesReq](../../medusa/classes/medusa.AdminPostBatchesReq.mdx)",
    ...
    "children": [
      {
        "name": "context",
        "type": "`Record<string, unknown>`",
        "description": "Additional information regarding the batch to be used for processing.",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
        "children": []
...
<ParameterTypes parameters={[
  {
    "name": "query",
    "type": "[AdminGetBatchParams](../../medusa/classes/medusa.AdminGetBatchParams.mdx)",
    ...
    "children": [
      {
        "name": "canceled_at",
        "type": "`null` \\| [DateComparisonOperator](../../medusa/classes/medusa.DateComparisonOperator.mdx)",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "ResponsePromise&#60;AdminBatchJobListRes&#62;",
    "optional": false,
    "defaultValue": "",
