...
3\. Upload a file using the [Admin REST APIs](https://docs.medusajs.com/v1/api/admin#uploads_postuploads) or using the Medusa admin, for example, to [upload a product's thumbnail](https://docs.medusajs.com/user-guide/products/manage#manage-thumbnails).
