...
<TypeList types={[{"name":"fulfillment","type":"`FulfillmentProviderData`","description":"The `data` attribute of the fulfillment being canceled","optional":false,"defaultValue":"","expandable":false,"children":[]}]}  sectionTitle="cancelFulfillment"/>
