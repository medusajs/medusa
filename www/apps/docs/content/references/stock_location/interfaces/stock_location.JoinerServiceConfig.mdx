...
<ParameterTypes parameters={[
  {
    "name": "alias",
    "type": "[JoinerServiceConfigAlias](stock_location.JoinerServiceConfigAlias.mdx) \\| [JoinerServiceConfigAlias](stock_location.JoinerServiceConfigAlias.mdx)[]",
  ...
  {
    "name": "extends",
    "type": "``{ relationship: [JoinerRelationship](../types/stock_location.JoinerRelationship.mdx) ; serviceName: string  }``[]",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
      {
        "name": "relationship",
        "type": "[JoinerRelationship](../types/stock_location.JoinerRelationship.mdx)",
        "description": "",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
