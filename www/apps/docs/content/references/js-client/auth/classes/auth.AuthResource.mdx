    ...
    "children": [
      {
        ...
        "type": "`object`",
        "description": "#### Schema StoreBearerAuthRes type: object properties: access_token: description: Access token that can be used to send authenticated requests. type: string",
        "optional": false,
        "defaultValue": "",
        "children": []
      }
