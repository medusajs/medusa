...
[internal](../../modules/internal.mdx).[internal](../../internal/modules/internal.internal-2.mdx).Writable
...
**addListener**(`event`, `listener`): [`Writable`](internal.internal-2.Writable.mdx)
...
<ParameterTypes parameters={[
  {
    "name": "Writable",
    "type": "[`Writable`](internal.internal-2.Writable.mdx)",
    "optional": false,
    "defaultValue": "",
    "description": "",
    "expandable": false,
...
<ParameterTypes parameters={[
  ...
  {
    "name": "listener",
    "type": "(`src`: [`Readable`](../../internal/classes/internal.Readable.mdx)) => `void`",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
...
<ParameterTypes parameters={[
  {
    "name": "stream",
    "type": "[`ComposeFnParam`](../../modules/internal.mdx#composefnparam) \\| `T` \\| [`Iterable`](../../internal/interfaces/internal.Iterable.mdx)<`T`\\> \\| [`AsyncIterable`](../../internal/interfaces/internal.AsyncIterable.mdx)<`T`\\>",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
...
The buffered data will be flushed when either the [uncork](../../internal/classes/internal.WritableBase.mdx#uncork) or [end](../../internal/classes/internal.WritableBase.mdx#end) methods are called.
...
<ParameterTypes parameters={[
  ...
  {
    "name": "src",
    "type": "[`Readable`](../../internal/classes/internal.Readable.mdx)",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
...
**end**(`cb?`): [`Writable`](internal.internal-2.Writable.mdx)
...
Calling the [write](../../internal/classes/internal.WritableBase.mdx#write) method after calling [end](../../internal/classes/internal.WritableBase.mdx#end) will raise an error.
...
**end**(`chunk`, `cb?`): [`Writable`](internal.internal-2.Writable.mdx)
...
**end**(`chunk`, `encoding`, `cb?`): [`Writable`](internal.internal-2.Writable.mdx)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](internal.internal-2.Writable.mdx#defaultmaxlisteners).
...
**on**(`event`, `listener`): [`Writable`](internal.internal-2.Writable.mdx)
...
**once**(`event`, `listener`): [`Writable`](internal.internal-2.Writable.mdx)
...
**prependListener**(`event`, `listener`): [`Writable`](internal.internal-2.Writable.mdx)
...
**prependOnceListener**(`event`, `listener`): [`Writable`](internal.internal-2.Writable.mdx)
...
**removeListener**(`event`, `listener`): [`Writable`](internal.internal-2.Writable.mdx)
...
The `writable.uncork()` method flushes all data buffered since [cork](../../internal/classes/internal.WritableBase.mdx#cork) was called.
...
recommended to encapsulate the logic into a `Readable` and use [pipe](../../internal/interfaces/internal.internal.MedusaRequest.mdx#pipe). However, if calling `write()` is preferred, it is
...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[`Pick`](../../modules/internal.mdx#pick)<[`WritableOptions`](../interfaces/internal.internal-2.WritableOptions.mdx), ``\"signal\"`` \\| ``\"decodeStrings\"`` \\| ``\"highWaterMark\"`` \\| ``\"objectMode\"``\\>",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
