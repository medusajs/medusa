...
[internal](../../modules/internal.mdx).Stream
...
<ParameterTypes parameters={[
  {
    "name": "Stream",
    "type": "[`Stream`](internal.Stream.mdx)",
    "optional": false,
    "defaultValue": "",
    "description": "",
    "expandable": false,
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](internal.Stream.mdx#defaultmaxlisteners).
