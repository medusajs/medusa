...
`**addListener**(event, listener): PassThrough`
...
`**end**(chunk, encoding?, cb?): PassThrough`
...
`**once**(event, listener): PassThrough`
...
`**prependListener**(event, listener): PassThrough`
...
`**prependOnceListener**(event, listener): PassThrough`
...
`**removeListener**(event, listener): PassThrough`
