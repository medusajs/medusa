...
`**addListener**(event, listener): Duplex`
...
`**prependListener**(event, listener): Duplex`
...
`**prependOnceListener**(event, listener): Duplex`
...
`**removeListener**(event, listener): Duplex`
