...
`**addListener**(event, listener): Transform`
...
`**end**(chunk, encoding?, cb?): Transform`
...
`**prependListener**(event, listener): Transform`
...
`**prependOnceListener**(event, listener): Transform`
...
`**removeListener**(event, listener): Transform`
