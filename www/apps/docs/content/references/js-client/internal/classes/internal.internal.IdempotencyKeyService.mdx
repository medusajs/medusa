...
[internal](../../modules/internal.mdx).[internal](../modules/internal.internal.mdx).IdempotencyKeyService
...
<ParameterTypes parameters={[
  {
    "name": "payload",
    "type": "[`CreateIdempotencyKeyInput`](../../modules/internal.mdx#createidempotencykeyinput)",
...
<ParameterTypes parameters={[
  {
    ...
    "type": "`string` \\| [`Selector`](../modules/internal.internal.mdx#selector)<[`IdempotencyKey`](internal.internal.IdempotencyKey.mdx)\\>",
...
<ParameterTypes parameters={[
  ...
  {
    "name": "callback",
    "type": "(`transactionManager`: `EntityManager`) => `Promise`<[`IdempotencyCallbackResult`](../../modules/internal.mdx#idempotencycallbackresult)\\>",
