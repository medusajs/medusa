...
[internal](../../modules/internal.mdx).AsyncResource
...
<ParameterTypes parameters={[
  {
    "name": "AsyncResource",
    "type": "[`AsyncResource`](internal.AsyncResource.mdx)",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "fn",
    "type": "`Func`",
    "description": "The function to bind to the current execution context.",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
    "children": []
  },
  {
    "name": "type",
    "type": "`string`",
    "description": "An optional name to associate with the underlying `AsyncResource`.",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": []
