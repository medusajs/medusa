...
<ParameterTypes parameters={[
  ...
  {
    "name": "container_",
    "type": "[`InjectedDependencies`](../types/internal.InjectedDependencies-16.mdx) & {}",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
...
<ParameterTypes parameters={[
  {
    "name": "selector",
    "type": "[`Selector`](../types/internal.internal.Selector.mdx)<[`Notification`](internal.Notification.mdx)\\>",
