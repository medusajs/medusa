...
`**emit**<TypeParameter T>(data): Promise\&#60;void \| StagedJob[]\&#62;`
...
`**emit**<TypeParameter T>(eventName, data, options?): Promise\&#60;void \| StagedJob\&#62;`
