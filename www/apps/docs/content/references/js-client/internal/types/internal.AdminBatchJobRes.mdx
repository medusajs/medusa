...
<ParameterTypes parameters={[
  {
    ...
    "children": [
      ...
      {
        "name": "result",
        "type": "{ `advancement_count?`: `number` ; `count?`: `number` ; `errors?`: (`string` \\| [`BatchJobResultError`](internal.internal.BatchJobResultError.mdx))[] ; `file_key?`: `string` ; `file_size?`: `number` ; `progress?`: `number` ; `stat_descriptors?`: [`BatchJobResultStatDescriptor`](internal.internal.BatchJobResultStatDescriptor.mdx)[]  } & Record<`string`, `unknown`\\>",
        ...
        "children": [
          ...
          {
            "name": "errors",
            "type": "(`string` \\| [`BatchJobResultError`](internal.internal.BatchJobResultError.mdx))[]",
            "description": "",
            "optional": true,
            "defaultValue": "",
            "expandable": false,
          ...
          },
          {
            ...
            "type": "[`BatchJobResultStatDescriptor`](internal.internal.BatchJobResultStatDescriptor.mdx)[]",
            "description": "",
            "optional": true,
            "defaultValue": "",
            "expandable": false,
