...
[internal](../../modules/internal.mdx).TransformOptions
...
<ParameterTypes parameters={[
  ...
  {
    "name": "callback",
    "type": "[`TransformCallback`](../../modules/internal.mdx#transformcallback)",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
    "children": [
      {
        "name": "__type",
        "type": "(`error?`: [`Error`](../../modules/internal.mdx#error) \\| ``null``, `data?`: `any`) => `void`",
        "description": "",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
