...
medusa.admin.productTags.list().then(({ product_tags }) => {
...
<ParameterTypes parameters={[
  {
    "name": "query",
    "type": "[`AdminGetProductTagsParams`](../internal/classes/internal.AdminGetProductTagsParams.mdx)",
...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../internal/types/internal.ResponsePromise.mdx)<[`AdminProductTagsListRes`](../internal/types/internal.AdminProductTagsListRes.mdx)\\>",
    "optional": false,
    "defaultValue": "",
