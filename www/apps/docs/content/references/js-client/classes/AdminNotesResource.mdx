...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminNotesRes`](../modules/internal.mdx#adminnotesres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminNotesListRes`](../modules/internal.mdx#adminnoteslistres)\\>",
    "optional": false,
    "defaultValue": "",
