...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminShippingProfilesRes`](../modules/internal.mdx#adminshippingprofilesres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminShippingProfilesListRes`](../modules/internal.mdx#adminshippingprofileslistres)\\>",
    "optional": false,
    "defaultValue": "",
