...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreReturnReasonsListRes`](../modules/internal.mdx#storereturnreasonslistres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreReturnReasonsRes`](../modules/internal.mdx#storereturnreasonsres)\\>",
    "optional": false,
    "defaultValue": "",
