...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminPaymentRes`](../modules/internal.mdx#adminpaymentres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminRefundRes`](../modules/internal.mdx#adminrefundres)\\>",
    "optional": false,
    "defaultValue": "",
