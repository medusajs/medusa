...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminCurrenciesListRes`](../modules/internal.mdx#admincurrencieslistres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminCurrenciesRes`](../modules/internal.mdx#admincurrenciesres)\\>",
    "optional": false,
    "defaultValue": "",
