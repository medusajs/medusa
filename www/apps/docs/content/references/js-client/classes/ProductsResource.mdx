...
<ParameterTypes parameters={[
  {
    ...
    "description": "An instance of [ProductVariantsResource](ProductVariantsResource.mdx) used to send requests to [Store Product Variant API Routes](https://docs.medusajs.com/api/store#product-variants\\_getvariants).",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
    "children": []
