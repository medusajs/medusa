...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreCollectionsListRes`](../modules/internal.mdx#storecollectionslistres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreCollectionsRes`](../modules/internal.mdx#storecollectionsres)\\>",
    "optional": false,
    "defaultValue": "",
