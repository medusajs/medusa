...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreGetProductCategoriesRes`](../modules/internal.mdx#storegetproductcategoriesres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreGetProductCategoriesCategoryRes`](../modules/internal.mdx#storegetproductcategoriescategoryres)\\>",
    "optional": false,
    "defaultValue": "",
