...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminPaymentCollectionDeleteRes`](../modules/internal.mdx#adminpaymentcollectiondeleteres)\\>",
    "optional": false,
    "defaultValue": "",
...
<ParameterTypes parameters={[
  {
    "name": "ResponsePromise",
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`AdminPaymentCollectionsRes`](../modules/internal.mdx#adminpaymentcollectionsres)\\>",
    "optional": false,
    "defaultValue": "",
