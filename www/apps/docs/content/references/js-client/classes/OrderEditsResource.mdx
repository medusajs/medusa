...
<ParameterTypes parameters={[
  {
    ...
    "type": "[`ResponsePromise`](../modules/internal.mdx#responsepromise)<[`StoreOrderEditsRes`](../modules/internal.mdx#storeordereditsres)\\>",
    "optional": false,
    "defaultValue": "",
    ...
    "children": [
      {
        ...
        "children": [
          {
            "name": "order_edit",
            "type": "[`Omit`](../modules/internal.mdx#omit)<[`OrderEdit`](../internal/classes/internal.OrderEdit.mdx), ``\"internal_note\"`` \\| ``\"created_by\"`` \\| ``\"confirmed_by\"`` \\| ``\"canceled_by\"``\\>",
