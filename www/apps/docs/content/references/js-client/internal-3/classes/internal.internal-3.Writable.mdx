...
`**addListener**(event, listener): Writable`
...
`**end**(chunk, encoding, cb?): Writable`
...
`**prependListener**(event, listener): Writable`
...
`**prependOnceListener**(event, listener): Writable`
...
`**removeListener**(event, listener): Writable`
...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[Pick](../../internal/types/internal.Pick.mdx)\\&#60;WritableOptions, `\"signal\"` \\| `\"decodeStrings\"` \\| `\"highWaterMark\"` \\| `\"objectMode\"`\\&#62;",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
