...
<ParameterTypes parameters={[
  {
    "name": "stream",
    "type": "[`ComposeFnParam`](../../internal/types/internal.ComposeFnParam.mdx) \\| `T` \\| [`Iterable`](../../internal/interfaces/internal.Iterable.mdx)<`T`\\> \\| [`AsyncIterable`](../../internal/interfaces/internal.AsyncIterable.mdx)<`T`\\>",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[`Pick`](../../internal/types/internal.Pick.mdx)<[`WritableOptions`](../interfaces/internal.internal-3.WritableOptions.mdx), ``\"signal\"`` \\| ``\"decodeStrings\"`` \\| ``\"highWaterMark\"`` \\| ``\"objectMode\"``\\>",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
