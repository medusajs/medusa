...
[internal](../../modules/internal.mdx).[internal](../../internal/modules/internal.internal-3.mdx).Writable
...
**addListener**(`event`, `listener`): [`Writable`](internal.internal-3.Writable.mdx)
...
<ParameterTypes parameters={[
  {
    "name": "Writable",
    "type": "[`Writable`](internal.internal-3.Writable.mdx)",
    "optional": false,
    "defaultValue": "",
    "description": "",
    "expandable": false,
...
**end**(`cb?`): [`Writable`](internal.internal-3.Writable.mdx)
...
**end**(`chunk`, `cb?`): [`Writable`](internal.internal-3.Writable.mdx)
...
**end**(`chunk`, `encoding`, `cb?`): [`Writable`](internal.internal-3.Writable.mdx)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](internal.internal-3.Writable.mdx#defaultmaxlisteners).
...
**on**(`event`, `listener`): [`Writable`](internal.internal-3.Writable.mdx)
...
**once**(`event`, `listener`): [`Writable`](internal.internal-3.Writable.mdx)
...
**prependListener**(`event`, `listener`): [`Writable`](internal.internal-3.Writable.mdx)
...
**prependOnceListener**(`event`, `listener`): [`Writable`](internal.internal-3.Writable.mdx)
...
**removeListener**(`event`, `listener`): [`Writable`](internal.internal-3.Writable.mdx)
...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[`Pick`](../../modules/internal.mdx#pick)<[`WritableOptions`](../interfaces/internal.internal-3.WritableOptions.mdx), ``\"signal\"`` \\| ``\"decodeStrings\"`` \\| ``\"highWaterMark\"`` \\| ``\"objectMode\"``\\>",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
