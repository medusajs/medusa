...
slug: /commerce-modules/sales-channel/reference/listAndCount
sidebar_label: listAndCount
---

import TypeList from "@site/src/components/TypeList"

# listAndCount - Sales Channel Module Reference

This documentation provides a reference to the `listAndCount` method. This belongs to the Sales Channel Module.
