...
slug: /references/promotion/listAndCountCampaigns
sidebar_label: listAndCountCampaigns
---

import TypeList from "@site/src/components/TypeList"

# listAndCountCampaigns - Promotion Module Reference

This documentation provides a reference to the `listAndCountCampaigns` method. This belongs to the Promotion Module.
