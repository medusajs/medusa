...
<TypeList types={[{"name":"computedActions","type":"[ComputeActions](../../types/promotion.ComputeActions.mdx)[]","description":"The computed actions to adjust their promotion's campaign budget.","optional":false,"defaultValue":"","expandable":false,"children":[]}]}  sectionTitle="registerUsage"/>
