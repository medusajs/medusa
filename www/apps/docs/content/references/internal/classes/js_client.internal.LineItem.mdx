...
<ParameterTypes parameters={[
  {
    "name": "adjustments",
    "type": "[LineItemAdjustment](js_client.internal.internal.LineItemAdjustment.mdx)[]",
  ...
  {
    "name": "order_edit",
    "type": "`null` \\| [OrderEdit](js_client.internal.OrderEdit.mdx)",
