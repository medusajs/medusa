...
<ParameterTypes parameters={[
  ...
  {
    "name": "changes",
    "type": "[OrderItemChange](js_client.internal.OrderItemChange.mdx)[]",
  ...
  },
  {
    ...
    "type": "[PaymentCollection](js_client.internal.PaymentCollection.mdx)",
  ...
  {
    "name": "status",
    "type": "[OrderEditStatus](../enums/js_client.internal.OrderEditStatus.mdx)",
