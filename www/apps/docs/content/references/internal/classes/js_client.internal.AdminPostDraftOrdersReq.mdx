...
<ParameterTypes parameters={[
  {
    ...
    "type": "`string` \\| [AddressPayload](js_client.internal.AddressPayload.mdx)",
  ...
  {
    "name": "discounts",
    "type": "[Discount](js_client.internal.Discount-2.mdx)[]",
  ...
  {
    "name": "items",
    "type": "[Item](js_client.internal.Item-3.mdx)[]",
  ...
  },
  {
    ...
    "type": "[ShippingMethod](js_client.internal.ShippingMethod.mdx)[]",
