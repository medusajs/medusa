...
<ParameterTypes parameters={[
  ...
  {
    "name": "description",
    "type": "`string` \\| [StringComparisonOperator](js_client.internal.StringComparisonOperator.mdx)",
  ...
  {
    "name": "quantity",
    "type": "[NumericalComparisonOperator](js_client.internal.NumericalComparisonOperator.mdx)",
