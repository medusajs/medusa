...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[ProductVariantOptionReq](js_client.internal.ProductVariantOptionReq.mdx)[]",
  ...
  {
    "name": "prices",
    "type": "[ProductVariantPricesCreateReq](js_client.internal.ProductVariantPricesCreateReq.mdx)[]",
