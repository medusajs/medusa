...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[ProductVariantOptionReq](js_client.internal.ProductVariantOptionReq-1.mdx)[]",
  ...
  {
    "name": "prices",
    "type": "[ProductVariantPricesUpdateReq](js_client.internal.ProductVariantPricesUpdateReq.mdx)[]",
