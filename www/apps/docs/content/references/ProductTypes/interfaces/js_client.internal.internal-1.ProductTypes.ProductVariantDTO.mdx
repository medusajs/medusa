...
<ParameterTypes parameters={[
  ...
  {
    "name": "options",
    "type": "[ProductOptionValueDTO](js_client.internal.internal-1.ProductTypes.ProductOptionValueDTO.mdx)[]",
  ...
  {
    "name": "product",
    "type": "[ProductDTO](js_client.internal.internal-1.ProductTypes.ProductDTO.mdx)",
