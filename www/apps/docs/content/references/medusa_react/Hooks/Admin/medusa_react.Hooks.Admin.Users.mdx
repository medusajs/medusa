...
for the user using the [useAdminSendResetPasswordToken](../../../modules/medusa_react.mdx#useadminsendresetpasswordtoken) hook, then use that token to reset the password in this hook.
...
That token must be used later to reset the password using the [useAdminResetPassword](../../../modules/medusa_react.mdx#useadminresetpassword) hook.
