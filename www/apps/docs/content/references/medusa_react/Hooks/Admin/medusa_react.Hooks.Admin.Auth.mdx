...
When you log the admin user in using the [authentication](../../../modules/user.mdx) hook, Medusa React will automatically attach the
...
This hook requires [authentication](../../../modules/user.mdx).
