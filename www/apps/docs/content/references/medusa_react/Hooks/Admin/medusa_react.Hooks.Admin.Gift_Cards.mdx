...
These gift cards are different than the saleable gift cards in a store, which are created and managed through [useAdminCreateProduct](../medusa_react.Hooks.Admin.mdx#useadmincreateproduct).
