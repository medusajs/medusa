...
<ParameterTypes parameters={[
  {
    "name": "filters",
    "type": "[FilterableProductCategoryProps](../../product/interfaces/product.FilterableProductCategoryProps.mdx)",
    ...
    "children": [
      {
        "name": "$and",
        "type": "([FilterableProductCategoryProps](../../product/interfaces/product.FilterableProductCategoryProps.mdx) \\| [BaseFilterable](../../product/interfaces/product.BaseFilterable.mdx)&#60;[FilterableProductCategoryProps](../../product/interfaces/product.FilterableProductCategoryProps.mdx)&#62;)[]",
  ...
  {
    "name": "config",
    "type": "[FindConfig](../../product/interfaces/product.FindConfig.mdx)&#60;[ProductCategoryDTO](../../product/interfaces/product.ProductCategoryDTO.mdx)&#62;",
    "description": "The configurations determining how the product categories are retrieved. Its properties, such as `select` or `relations`, accept the\nattributes or relations associated with a product category.",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
        ...
        "children": [
          {
            "name": "ProductCategoryDTO",
            "type": "`object`",
            "description": "A product category's data.",
            "optional": false,
            "defaultValue": "",
            "expandable": false,
            "children": []
