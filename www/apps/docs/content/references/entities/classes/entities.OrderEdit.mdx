...
<ParameterTypes parameters={[
  ...
  {
    "name": "changes",
    "type": "[OrderItemChange](entities.OrderItemChange.mdx)[]",
  ...
  },
  {
    ...
    "type": "[PaymentCollection](entities.PaymentCollection.mdx)",
  ...
  {
    "name": "status",
    "type": "[OrderEditStatus](../enums/entities.OrderEditStatus.mdx)",
