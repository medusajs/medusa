...
<ParameterTypes parameters={[
  ...
  {
    "name": "result",
    "type": "``{ advancement_count?: number ; count?: number ; errors?: (string \\| [BatchJobResultError](../types/entities.BatchJobResultError.mdx))[] ; file_key?: string ; file_size?: number ; progress?: number ; stat_descriptors?: [BatchJobResultStatDescriptor](../types/entities.BatchJobResultStatDescriptor.mdx)[]  }`` & `Record<string, unknown>`",
    ...
    "children": [
      ...
      {
        "name": "errors",
        "type": "(`string` \\| [BatchJobResultError](../types/entities.BatchJobResultError.mdx))[]",
        "description": "",
        "optional": true,
        "defaultValue": "",
        "expandable": false,
      ...
      },
      {
        ...
        "type": "[BatchJobResultStatDescriptor](../types/entities.BatchJobResultStatDescriptor.mdx)[]",
        "description": "",
        "optional": true,
        "defaultValue": "",
        "expandable": false,
  ...
  {
    "name": "status",
    "type": "[BatchJobStatus](../enums/entities.BatchJobStatus.mdx)",
