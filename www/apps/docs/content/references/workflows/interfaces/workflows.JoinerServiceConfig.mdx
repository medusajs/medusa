...
<ParameterTypes parameters={[
  {
    "name": "alias",
    "type": "[JoinerServiceConfigAlias](workflows.JoinerServiceConfigAlias.mdx) \\| [JoinerServiceConfigAlias](workflows.JoinerServiceConfigAlias.mdx)[]",
  ...
  {
    "name": "extends",
    "type": "``{ relationship: [JoinerRelationship](../types/workflows.JoinerRelationship.mdx) ; serviceName: string  }``[]",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
      {
        "name": "relationship",
        "type": "[JoinerRelationship](../types/workflows.JoinerRelationship.mdx)",
        "description": "",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
