...
<ParameterTypes parameters={[
  ...
  },
  {
    "name": "primaryKey",
    "type": "`string`",
    "description": "Primary key for the index. Used to enforce unique documents in an index. See more in Meilisearch' https://docs.meilisearch.com/learn/core\\_concepts/primary\\_key.html.",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": []
