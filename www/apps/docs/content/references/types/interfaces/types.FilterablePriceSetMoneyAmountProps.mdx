...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceSetMoneyAmountProps](types.FilterablePriceSetMoneyAmountProps.mdx) \\| [BaseFilterable](../../DAL/interfaces/types.DAL.BaseFilterable.mdx)&#60;[FilterablePriceSetMoneyAmountProps](types.FilterablePriceSetMoneyAmountProps.mdx)&#62;)[]",
