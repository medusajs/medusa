...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceSetProps](types.FilterablePriceSetProps.mdx) \\| [BaseFilterable](../../DAL/interfaces/types.DAL.BaseFilterable.mdx)&#60;[FilterablePriceSetProps](types.FilterablePriceSetProps.mdx)&#62;)[]",
  ...
  {
    "name": "money_amounts",
    "type": "[FilterableMoneyAmountProps](types.FilterableMoneyAmountProps.mdx)",
