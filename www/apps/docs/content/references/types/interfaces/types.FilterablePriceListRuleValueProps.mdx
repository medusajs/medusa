...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceListRuleValueProps](types.FilterablePriceListRuleValueProps.mdx) \\| [BaseFilterable](../../DAL/interfaces/types.DAL.BaseFilterable.mdx)&#60;[FilterablePriceListRuleValueProps](types.FilterablePriceListRuleValueProps.mdx)&#62;)[]",
