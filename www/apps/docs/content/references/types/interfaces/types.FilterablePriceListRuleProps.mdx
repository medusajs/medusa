...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceListRuleProps](types.FilterablePriceListRuleProps.mdx) \\| [BaseFilterable](../../DAL/interfaces/types.DAL.BaseFilterable.mdx)&#60;[FilterablePriceListRuleProps](types.FilterablePriceListRuleProps.mdx)&#62;)[]",
