...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterableCurrencyProps](types.FilterableCurrencyProps.mdx) \\| [BaseFilterable](../../DAL/interfaces/types.DAL.BaseFilterable.mdx)&#60;[FilterableCurrencyProps](types.FilterableCurrencyProps.mdx)&#62;)[]",
