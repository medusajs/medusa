...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceSetMoneyAmountRulesProps](types.FilterablePriceSetMoneyAmountRulesProps.mdx) \\| [BaseFilterable](../../DAL/interfaces/types.DAL.BaseFilterable.mdx)&#60;[FilterablePriceSetMoneyAmountRulesProps](types.FilterablePriceSetMoneyAmountRulesProps.mdx)&#62;)[]",
