...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceRuleProps](pricing.FilterablePriceRuleProps.mdx) \\| [BaseFilterable](pricing.BaseFilterable.mdx)&#60;[FilterablePriceRuleProps](pricing.FilterablePriceRuleProps.mdx)&#62;)[]",
