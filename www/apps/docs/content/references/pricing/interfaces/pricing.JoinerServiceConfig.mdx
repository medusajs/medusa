...
<ParameterTypes parameters={[
  {
    "name": "alias",
    "type": "[JoinerServiceConfigAlias](pricing.JoinerServiceConfigAlias.mdx) \\| [JoinerServiceConfigAlias](pricing.JoinerServiceConfigAlias.mdx)[]",
  ...
  {
    "name": "extends",
    "type": "``{ relationship: [JoinerRelationship](../types/pricing.JoinerRelationship.mdx) ; serviceName: string  }``[]",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
      {
        "name": "relationship",
        "type": "[JoinerRelationship](../types/pricing.JoinerRelationship.mdx)",
        "description": "",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
