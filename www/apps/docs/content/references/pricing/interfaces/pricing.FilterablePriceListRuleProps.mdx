...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceListRuleProps](pricing.FilterablePriceListRuleProps.mdx) \\| [BaseFilterable](pricing.BaseFilterable.mdx)&#60;[FilterablePriceListRuleProps](pricing.FilterablePriceListRuleProps.mdx)&#62;)[]",
