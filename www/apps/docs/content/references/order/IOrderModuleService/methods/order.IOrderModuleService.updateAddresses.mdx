...
slug: /references/order/updateAddresses
...
## updateAddresses(data, sharedContext?): Promise&#60;[OrderAddressDTO](../../interfaces/order.OrderAddressDTO.mdx)[]&#62;
