...
This method is used to retrieve a paginated list of price list rules along with the total count of available price list rules satisfying the provided filters.
