...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterableMoneyAmountProps](services.FilterableMoneyAmountProps.mdx) \\| [BaseFilterable](services.BaseFilterable.mdx)&#60;[FilterableMoneyAmountProps](services.FilterableMoneyAmountProps.mdx)&#62;)[]",
