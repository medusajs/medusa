...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceListProps](services.FilterablePriceListProps-1.mdx) \\| [BaseFilterable](services.BaseFilterable.mdx)&#60;[FilterablePriceListProps](services.FilterablePriceListProps-1.mdx)&#62;)[]",
