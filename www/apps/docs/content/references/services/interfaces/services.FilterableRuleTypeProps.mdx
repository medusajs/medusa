...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterableRuleTypeProps](services.FilterableRuleTypeProps.mdx) \\| [BaseFilterable](services.BaseFilterable.mdx)&#60;[FilterableRuleTypeProps](services.FilterableRuleTypeProps.mdx)&#62;)[]",
