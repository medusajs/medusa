...
node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:17
...
node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:13
...
### journalMode
 ...
 `Optional` `Readonly` **journalMode**: ``"DELETE"`` \| ``"TRUNCATE"`` \| ``"PERSIST"`` \| ``"MEMORY"`` \| ``"WAL"`` \| ``"OFF"``

The SQLite journal mode (optional)

#### Defined in

node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:29
...
### mode
 ...
 `Optional` `Readonly` **mode**: ``"secret"`` \| ``"no-encryption"`` \| ``"encryption"`` \| ``"newsecret"``

Set the mode for database encryption

#### Defined in

node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:21
...
node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:30
...
node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:9
...
node_modules/typeorm/driver/capacitor/CapacitorConnectionOptions.d.ts:25
