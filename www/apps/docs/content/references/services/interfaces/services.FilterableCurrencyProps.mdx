...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterableCurrencyProps](services.FilterableCurrencyProps.mdx) \\| [BaseFilterable](services.BaseFilterable.mdx)&#60;[FilterableCurrencyProps](services.FilterableCurrencyProps.mdx)&#62;)[]",
