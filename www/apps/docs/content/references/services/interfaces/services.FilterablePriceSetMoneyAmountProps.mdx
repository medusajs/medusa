...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([FilterablePriceSetMoneyAmountProps](services.FilterablePriceSetMoneyAmountProps.mdx) \\| [BaseFilterable](services.BaseFilterable.mdx)&#60;[FilterablePriceSetMoneyAmountProps](services.FilterablePriceSetMoneyAmountProps.mdx)&#62;)[]",
