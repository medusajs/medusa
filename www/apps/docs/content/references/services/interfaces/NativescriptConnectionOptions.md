...
### androidFlags
 ...
 `Optional` `Readonly` **androidFlags**: `number`
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:43
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:13
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:18
...
### iosFlags
 ...
 `Optional` `Readonly` **iosFlags**: `number`

Flags to pass to SQLite when opening the database on iOS. (see https://www.sqlite.org/c3ref/open.html)

#### Defined in

node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:39
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:26
...
### migrate
 ...
 `Optional` `Readonly` **migrate**: `boolean`
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:35
...
### multithreading
 ...
 `Optional` `Readonly` **multithreading**: `boolean`

Whether to enable background multitasking. All SQL is ran on a background worker thread. (requires the "Commercial Plugin")

#### Defined in

node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:30
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:44
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:22
...
node_modules/typeorm/driver/nativescript/NativescriptConnectionOptions.d.ts:9
