...
<ParameterTypes parameters={[{"name":"data","type":"`T`","description":"the custom shipping option to create","optional":false,"defaultValue":"","expandable":false,"children":[]}]} />
...
<ParameterTypes parameters={[{"name":"id","type":"`string`","description":"the id of the custom shipping option to retrieve.","optional":false,"defaultValue":"","expandable":false,"children":[]},{"name":"config","type":"[FindConfig](../../medusa/interfaces/medusa.FindConfig.mdx)&#60;[CustomShippingOption](../../entities/classes/entities.CustomShippingOption.mdx)&#62;","description":"any options needed to query for the result.","optional":false,"defaultValue":"{}","expandable":false,"children":[]}]} />
...
<ParameterTypes parameters={[{"name":"CustomShippingOptionService","type":"`object`","description":"","optional":false,"defaultValue":"","expandable":false,"children":[]}]} />
