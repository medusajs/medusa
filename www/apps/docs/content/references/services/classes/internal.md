...
**addListener**(`eventName`, `listener`): [`internal`](internal.md)
...
**off**(`eventName`, `listener`): [`internal`](internal.md)
...
**on**(`eventName`, `listener`): [`internal`](internal.md)
...
**once**(`eventName`, `listener`): [`internal`](internal.md)
...
**prependListener**(`eventName`, `listener`): [`internal`](internal.md)
...
**prependOnceListener**(`eventName`, `listener`): [`internal`](internal.md)
...
**removeAllListeners**(`event?`): [`internal`](internal.md)
...
**removeListener**(`eventName`, `listener`): [`internal`](internal.md)
...
**setMaxListeners**(`n`): [`internal`](internal.md)
