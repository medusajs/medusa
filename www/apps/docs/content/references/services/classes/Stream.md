...
docs-util/node_modules/@types/node/stream.d.ts:944
...
**addListener**(`eventName`, `listener`): [`Stream`](Stream.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](Stream.md#defaultmaxlisteners).
...
**off**(`eventName`, `listener`): [`Stream`](Stream.md)
...
**on**(`eventName`, `listener`): [`Stream`](Stream.md)
...
**once**(`eventName`, `listener`): [`Stream`](Stream.md)
...
**prependListener**(`eventName`, `listener`): [`Stream`](Stream.md)
...
**prependOnceListener**(`eventName`, `listener`): [`Stream`](Stream.md)
...
**removeAllListeners**(`event?`): [`Stream`](Stream.md)
...
**removeListener**(`eventName`, `listener`): [`Stream`](Stream.md)
...
**setMaxListeners**(`n`): [`Stream`](Stream.md)
