...
- [`TypedEventEmitter`](TypedEventEmitter.md)<{ `cancel`: Method cancel  }\>
...
**addListener**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
| :------ |
| `event` | `EventKey` |
| `listener` | { `cancel`: Method cancel  }[`EventKey`] |
...
**addListener**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
| `...args` | [`Parameters`](../index.md#parameters)<{ `cancel`: Method cancel  }[`EventKey`]\> |
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](CancellationToken.md#defaultmaxlisteners).
...
**listeners**<`EventKey`\>(`event`): { `cancel`: Method cancel  }[`EventKey`][]
...
{ `cancel`: Method cancel  }[`EventKey`][]

-`{ `cancel`: Method cancel  }[`EventKey`][]`: 
	-`{ `cancel`: Method cancel  }[`EventKey`]`: (optional) 
...
**off**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**off**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**on**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
| `listener` | { `cancel`: Method cancel  }[`EventKey`] | The callback function |
...
**on**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**once**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**once**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**prependListener**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**prependListener**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**prependOnceListener**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**prependOnceListener**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**rawListeners**<`EventKey`\>(`event`): { `cancel`: Method cancel  }[`EventKey`][]
...
**removeAllListeners**<`EventKey`\>(`event?`): [`CancellationToken`](CancellationToken.md)
...
**removeListener**<`EventKey`\>(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**removeListener**(`event`, `listener`): [`CancellationToken`](CancellationToken.md)
...
**setMaxListeners**(`n`): [`CancellationToken`](CancellationToken.md)
