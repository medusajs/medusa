...
<ParameterTypes parameters={[{"name":"RegionService","type":"`object`","description":"Provides layer to manipulate regions.","optional":false,"defaultValue":"","expandable":false,"children":[]}]} />
