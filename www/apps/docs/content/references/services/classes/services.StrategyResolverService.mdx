...
<TypeList types={[{"name":"AbstractBatchJobStrategy","type":"`AbstractBatchJobStrategy`","optional":false,"defaultValue":"","description":"","expandable":false,"children":[]}]}  sectionTitle="resolveBatchJobByType"/>
