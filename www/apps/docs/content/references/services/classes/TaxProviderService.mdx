...
<ParameterTypes parameters={[
  {
    "name": "getTaxLines",
    "type": "(`itemLines`: [ItemTaxCalculationLine](../types/ItemTaxCalculationLine.mdx)[], `shippingLines`: [ShippingTaxCalculationLine](../types/ShippingTaxCalculationLine.mdx)[], `context`: [TaxCalculationContext](../types/TaxCalculationContext.mdx)) => Promise\\&#60;ProviderTaxLine[]\\&#62;",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
