...
<ParameterTypes parameters={[{"name":"PaymentProviderService","type":"`object`","description":"Helps retrieve payment providers","optional":false,"defaultValue":"","expandable":false,"children":[]}]} />
