...
<ParameterTypes parameters={[
  ...
  {
    "name": "changes",
    "type": "[OrderItemChange](services.OrderItemChange.mdx)[]",
  ...
  },
  {
    ...
    "type": "[PaymentCollection](services.PaymentCollection.mdx)",
  ...
  {
    "name": "status",
    "type": "[OrderEditStatus](../enums/services.OrderEditStatus.mdx)",
