...
**clone**(): [`FindCursor`](FindCursor.md)<`TSchema`\>
...
| Name | Description |
| :------ | :------ |
| `hint` | [`Hint`](../types/Hint.md) | If specified, then the query system will only consider plans using the hinted index. |
...
**prependOnceListener**<`EventKey`\>(`event`, `listener`): [`FindCursor`](FindCursor.md)<`TSchema`\>
...
| Name | Description |
| :------ | :------ |
| `sort` | [`Sort`](../types/Sort.md) | The key or keys set for the sort. |
| `direction?` | [`SortDirection`](../types/SortDirection.md) | The direction of the sorting (1 or -1). |
