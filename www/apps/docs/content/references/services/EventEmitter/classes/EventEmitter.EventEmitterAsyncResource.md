...
[EventEmitter](../../modules/EventEmitter.md).EventEmitterAsyncResource
...
| Name | Description |
| :------ | :------ |
| `options?` | [`EventEmitterAsyncResourceOptions`](../interfaces/EventEmitter.EventEmitterAsyncResourceOptions.md) | Only optional in child class. |

#### Overrides

[EventEmitter](../../classes/EventEmitter-1.md).[constructor](../../classes/EventEmitter-1.md#constructor)

#### Defined in

docs-util/node_modules/@types/node/events.d.ts:486
...
docs-util/node_modules/@types/node/events.d.ts:495

___

### asyncResource

 `Readonly` **asyncResource**: [`EventEmitterReferencingAsyncResource`](../interfaces/EventEmitter.EventEmitterReferencingAsyncResource.md)

The underlying AsyncResource

#### Defined in

docs-util/node_modules/@types/node/events.d.ts:499
...
docs-util/node_modules/@types/node/events.d.ts:497
...
[EventEmitter](../../classes/EventEmitter-1.md).[captureRejections](../../classes/EventEmitter-1.md#capturerejections)
...
[EventEmitter](../../classes/EventEmitter-1.md).[defaultMaxListeners](../../classes/EventEmitter-1.md#defaultmaxlisteners)
...
[EventEmitter](../../classes/EventEmitter-1.md).[errorMonitor](../../classes/EventEmitter-1.md#errormonitor)
...
**addListener**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
[`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
docs-util/node_modules/@types/node/events.d.ts:493
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](EventEmitter.EventEmitterAsyncResource.md#defaultmaxlisteners).
...
**off**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**on**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**once**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**prependListener**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**prependOnceListener**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**removeAllListeners**(`event?`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**removeListener**(`eventName`, `listener`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
**setMaxListeners**(`n`): [`EventEmitterAsyncResource`](EventEmitter.EventEmitterAsyncResource.md)
...
[EventEmitter](../../classes/EventEmitter-1.md).[addAbortListener](../../classes/EventEmitter-1.md#addabortlistener)
...
[EventEmitter](../../classes/EventEmitter-1.md).[getEventListeners](../../classes/EventEmitter-1.md#geteventlisteners)
...
[EventEmitter](../../classes/EventEmitter-1.md).[getMaxListeners](../../classes/EventEmitter-1.md#getmaxlisteners-1)
...
[EventEmitter](../../classes/EventEmitter-1.md).[listenerCount](../../classes/EventEmitter-1.md#listenercount-1)
...
[EventEmitter](../../classes/EventEmitter-1.md).[on](../../classes/EventEmitter-1.md#on-1)
...
[EventEmitter](../../classes/EventEmitter-1.md).[once](../../classes/EventEmitter-1.md#once-1)
...
[EventEmitter](../../classes/EventEmitter-1.md).[setMaxListeners](../../classes/EventEmitter-1.md#setmaxlisteners-1)
