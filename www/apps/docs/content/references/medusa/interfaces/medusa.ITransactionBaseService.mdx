...
<ParameterTypes parameters={[{"name":"withTransaction","type":"(`transactionManager?`: `EntityManager`) => [ITransactionBaseService](medusa.ITransactionBaseService.mdx)","description":"","optional":false,"defaultValue":"","expandable":false,"children":[]}]} expandUrl="https://docs.medusajs.com/development/entities/repositories#retrieving-a-list-of-records"/>
