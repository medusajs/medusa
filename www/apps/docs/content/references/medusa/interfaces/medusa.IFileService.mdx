...
<ParameterTypes parameters={[
  ...
  {
    "name": "upload",
    "type": "(`file`: `File`) => Promise&#60;[FileServiceUploadResult](../types/medusa.FileServiceUploadResult.mdx)&#62;",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
  ...
  },
  {
    ...
    "type": "(`transactionManager?`: `EntityManager`) => [IFileService](medusa.IFileService.mdx)",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
