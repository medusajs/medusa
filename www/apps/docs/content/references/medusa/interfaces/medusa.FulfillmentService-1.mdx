...
<ParameterTypes parameters={[
  ...
  },
  {
    ...
    "children": [
      ...
      {
        "name": "items",
        "type": "[FulfillmentItem](../classes/medusa.FulfillmentItem.mdx)[]",
      ...
      {
        "name": "tracking_links",
        "type": "[TrackingLink](../classes/medusa.TrackingLink.mdx)[]",
