...
<ParameterTypes parameters={[
  ...
  },
  {
    ...
    "description": "A region holds settings specific to a geographical location, including the currency, tax rates, and fulfillment and payment providers. A Region can consist of multiple countries to accommodate common shopping settings across countries.",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
    "children": [
