...
<ParameterTypes parameters={[
  {
    "name": "constructor",
    "type": "() => [AdminPostInvitesInviteAcceptReq](medusa.AdminPostInvitesInviteAcceptReq.mdx)",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
  ...
  {
    "name": "user",
    "type": "[AdminPostInvitesInviteAcceptUserReq](medusa.AdminPostInvitesInviteAcceptUserReq.mdx)",
