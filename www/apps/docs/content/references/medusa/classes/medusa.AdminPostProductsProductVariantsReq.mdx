...
<ParameterTypes parameters={[
  {
    "name": "constructor",
    "type": "() => [AdminPostProductsProductVariantsReq](medusa.AdminPostProductsProductVariantsReq.mdx)",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
  ...
  {
    "name": "options",
    "type": "[ProductVariantOptionReq](medusa.ProductVariantOptionReq.mdx)[]",
