...
<ParameterTypes parameters={[
  {
    "name": "constructor",
    "type": "(...`args`: `unknown`[]) => [AdminGetReservationsParams](medusa.AdminGetReservationsParams.mdx)",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
  ...
  {
    "name": "description",
    "type": "`string` \\| [StringComparisonOperator](medusa.StringComparisonOperator.mdx)",
