...
<ParameterTypes parameters={[
  ...
  {
    "name": "complete",
    "type": "(`cartId`: `string`, `idempotencyKey`: [IdempotencyKey](medusa.IdempotencyKey.mdx), `context`: [RequestContext](../types/medusa.RequestContext.mdx)) => Promise&#60;[CartCompletionResponse](../types/medusa.CartCompletionResponse.mdx)&#62;",
    "description": "",
    "optional": false,
    "defaultValue": "",
    "expandable": false,
