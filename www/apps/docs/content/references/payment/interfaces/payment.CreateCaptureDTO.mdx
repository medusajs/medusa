...
<TypeList types={[{"name":"payment_id","type":"`string`","description":"The associated payment's ID.","optional":false,"defaultValue":"","expandable":false,"children":[]},{"name":"amount","type":"[BigNumberInput](../types/payment.BigNumberInput.mdx)","description":"The amount of the capture.","optional":true,"defaultValue":"","expandable":false,"children":[]},{"name":"captured_by","type":"`string`","description":"Who captured the payment. For example,\na user's ID.","optional":true,"defaultValue":"","expandable":false,"children":[]}]}  sectionTitle="CreateCaptureDTO"/>
