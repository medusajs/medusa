...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([`FilterableProductTypeProps`](FilterableProductTypeProps.mdx) \\| [`BaseFilterable`](BaseFilterable.mdx)<[`FilterableProductTypeProps`](FilterableProductTypeProps.mdx)\\>)[]",
