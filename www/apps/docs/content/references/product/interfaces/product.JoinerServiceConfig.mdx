...
<ParameterTypes parameters={[
  {
    "name": "alias",
    "type": "[JoinerServiceConfigAlias](product.JoinerServiceConfigAlias.mdx) \\| [JoinerServiceConfigAlias](product.JoinerServiceConfigAlias.mdx)[]",
  ...
  {
    "name": "extends",
    "type": "``{ relationship: [JoinerRelationship](../types/product.JoinerRelationship.mdx) ; serviceName: string  }``[]",
    "description": "",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
      {
        "name": "relationship",
        "type": "[JoinerRelationship](../types/product.JoinerRelationship.mdx)",
        "description": "",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
