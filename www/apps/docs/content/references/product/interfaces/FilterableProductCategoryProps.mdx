...
<ParameterTypes parameters={[
  {
    "name": "$and",
    "type": "([`FilterableProductCategoryProps`](FilterableProductCategoryProps.mdx) \\| [`BaseFilterable`](BaseFilterable.mdx)<[`FilterableProductCategoryProps`](FilterableProductCategoryProps.mdx)\\>)[]",
