...
This method is used to restore products which were deleted using the [softDelete](product.IProductModuleService.softDelete.mdx) method.
...
<ParameterTypes parameters={[
  ...
  },
  {
    ...
    "description": "Configurations determining which relations to restore along with each of the products. You can pass to its `returnLinkableKeys`\nproperty any of the product's relation attribute names, such as `variant_id`.",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
