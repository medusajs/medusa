...
<ParameterTypes parameters={[
  ...
  },
  {
    ...
    "description": "The configurations determining how the product category is retrieved. Its properties, such as `select` or `relations`, accept the\nattributes or relations associated with a product category.",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
...
<ParameterTypes parameters={[
  {
    "name": "Promise",
    "type": "Promise&#60;[ProductCategoryDTO](../../interfaces/product.ProductCategoryDTO.mdx)&#62;",
    "optional": false,
    "defaultValue": "",
