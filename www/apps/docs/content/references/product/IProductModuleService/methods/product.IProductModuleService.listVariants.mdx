...
<ParameterTypes parameters={[
  {
    "name": "filters",
    "type": "[FilterableProductVariantProps](../../interfaces/product.FilterableProductVariantProps.mdx)",
    ...
    "children": [
      {
        "name": "$and",
        "type": "([FilterableProductVariantProps](../../interfaces/product.FilterableProductVariantProps.mdx) \\| [BaseFilterable](../../interfaces/product.BaseFilterable.mdx)&#60;[FilterableProductVariantProps](../../interfaces/product.FilterableProductVariantProps.mdx)&#62;)[]",
  ...
  },
  {
    ...
    "description": "The configurations determining how the product variants are retrieved. Its properties, such as `select` or `relations`, accept the\nattributes or relations associated with a product variant.",
    "optional": true,
    "defaultValue": "",
    "expandable": false,
    "children": [
