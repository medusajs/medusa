...
<ParameterTypes parameters={[{"name":"Promise","type":"`Promise`<[[`ProductCollectionDTO`](../../interfaces/ProductCollectionDTO.mdx)[], `number`]\\>","optional":false,"defaultValue":"","description":"The list of product collections along with the total count.","children":[{"name":"ProductCollectionDTO[]","type":"[`ProductCollectionDTO`](../../interfaces/ProductCollectionDTO.mdx)[]","optional":false,"defaultValue":"","description":"","children":[]},{"name":"number","type":"`number`","optional":true,"defaultValue":"","description":"","children":[]}]}]} />
