...
Next, Bloom will ask for your API keys. Paste the test keys you copied from your Stripe dashboard:

1. Enter your Publishable key (starts with `pk_test_`).
2. Enter your Secret key (starts with `sk_test_`).
