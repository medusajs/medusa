import { CardList, InProductAction } from "docs-ui"
...
Bloom's Integrations feature allows you to add popular services to your store with simple prompts. Bloom can add integrations for:

- **Accepting Payments**: Add Stripe to process credit cards, Apple Pay, Google Pay, and more.
- **Sending Notifications**: Connect Slack to get alerts about new orders and events.
- **Managing Consent**: Use Cookiebot to handle customer privacy and cookie consent.
- **Building Email Lists**: Integrate Klaviyo to send marketing emails and newsletters.
...
If you don't see the service you want to integrate, you can ask Bloom to add it using a custom prompt as explained [below](#custom-integrations). Consider sharing a feedback at the end of this page with the service you'd like to see added next.
...
On the integrations page, you'll see cards for supported integrations like Stripe and Slack. To add the service, click the "Build" button on the card. This will send a prompt to Bloom to add your integration.

#### Custom Integrations

If you can't find the service you want to integrate, you can enter a custom prompt to add it in the input field at the top of the page.
...
Bloom will interpret your prompt and set up the integration based on the details you provide.
...
3. "Please enter your API keys for Stripe."
...
<CardList items={[
  {
    ...
    text: "Learn how to integrate custom services."
  },
  {
    href: "/going-live",
