...
export async function GET(request: Request) {
  ...
  // path.join(process.cwd(), "specs/admin/openapi.full.yaml")
  ...
  // path.join(process.cwd(), "specs/store/openapi.full.yaml")
  // path.join(process.cwd(), "specs/store/openapi.yaml")
  ...
  // path.join(process.cwd(), "specs-v2/admin/openapi.full.yaml")
  // path.join(process.cwd(), "specs-v2/admin/openapi.yaml")
  // path.join(process.cwd(), "specs-v2/store/code_samples")
  // path.join(process.cwd(), "specs-v2/store/components")
  // path.join(process.cwd(), "specs-v2/store/openapi.full.yaml")
  // path.join(process.cwd(), "specs-v2/store/openapi.yaml")
