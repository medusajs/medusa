...
- Allowed fields and relations are the only ones you can retrieve in the API route. If an API route has no allowed fields, you can retrieve any field or relation.
...
If an API route has any of these restrictions, they're listed in this reference under the Allowed and Disallowed collapsibles.
