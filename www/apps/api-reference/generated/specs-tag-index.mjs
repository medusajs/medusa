export const specsTagIndex = {
  "admin": {
    ...
    "layouts": [
      "admin_layouts_configurations.yaml",
      "admin_layouts_{zone}_configuration.yaml"
    ],
    "locales": [
      "admin_locales.yaml",
    ...
    "orders": [
      ...
      "admin_orders_{id}_payment-sessions_authorize.yaml",
      ...
      "admin_orders_{id}_transfer_guest.yaml"
    ],
    "payment-collections": [
    ...
    "product-options": [
      "admin_product-options.yaml",
      "admin_product-options_{id}.yaml",
      "admin_product-options_{id}_values.yaml",
      "admin_product-options_{id}_values_{value_id}.yaml"
    ],
    "product-tags": [
    ...
    "products": [
      ...
      "admin_products_{id}_options_batch.yaml",
    ...
    "multi-factor-authentication": [
      "auth_mfa_challenges_{id}_verify.yaml",
      "auth_mfa_factors.yaml",
      "auth_mfa_factors_{id}_verify.yaml",
      "auth_mfa_recovery-codes.yaml"
    ],
    "auth": [
  ...
  "store": {
    "auth": [
      ...
      "auth_session.yaml",
      "auth_token_refresh.yaml",
      "auth_verification_confirm.yaml",
      "auth_verification_request.yaml"
    ],
    ...
    "product-options": [
      "store_product-options.yaml",
      "store_product-options_{id}.yaml"
    ],
    "product-tags": [
