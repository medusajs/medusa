...
import { ProductMediaRepository } from "../repositories/product-media"
...
class ProductMediaService extends TransactionBaseService {
  protected productMediaRepository_: typeof ProductMediaRepository
  protected productVariantService_: ProductVariantService

  constructor(container: InjectedDependencies) {
    super(container)
    this.productMediaRepository_ = container.productMediaRepository
  ...
  async create(
    data: Pick<ProductMedia, "name" | "file_key" | "variant_id" | "type">
  ): Promise<ProductMedia> {
