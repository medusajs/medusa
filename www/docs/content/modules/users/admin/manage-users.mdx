...
You can retrieve users in a store by sending a request to the [List Users endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/GetUsers):
...
You can create a user by sending a request to the [Create User endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsers):
...
The endpoint accepts other optional body parameters, such as first name or last name. Check the [API reference](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsers) for details on optional body parameters.
...
You can update a user’s details by sending a request to the [Update User endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsersUser):
...
In the request body, you can pass any of the user’s fields that you want to update as parameters. In the example above, you update the user’s `first_name`. Check the [API reference](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsersUser) for all the optional parameters.
...
You can delete a user by sending a request to the [Delete User endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/DeleteUsersUser):
