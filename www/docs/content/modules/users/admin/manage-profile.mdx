...
You can log in a user by sending a request to the [User Login endpoint](https://docs.medusajs.com/api/admin#tag/Auth/operation/PostAuth):
...
You can log out a user by sending a request to the [User Logout endpoint](https://docs.medusajs.com/api/admin#tag/Auth/operation/DeleteAuth):
...
You can retrieve the current user’s details for their profile by sending a request to the [Get Current User endpoint](https://docs.medusajs.com/api/admin#tag/Auth/operation/GetAuth):
...
You can update a user’s details in their profile by sending a request to the [Update User endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsersUser):
...
You can request a password reset by sending a request to the [Request Password Reset endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsersUserPasswordToken):
...
You can reset the password by sending a request to the [Reset Password endpoint](https://docs.medusajs.com/api/admin#tag/Users/operation/PostUsersUserPassword):
