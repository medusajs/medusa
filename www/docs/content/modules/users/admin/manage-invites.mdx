...
You can list invites by sending a request to the [List Invite endpoint](https://docs.medusajs.com/api/admin#tag/Invites/operation/GetInvites):
...
You can create an invite by sending a request to the [Create Invite endpoint](https://docs.medusajs.com/api/admin#tag/Invites/operation/PostInvites):
...
You can accept an invite by sending a request to the [Accept Invite endpoint](https://docs.medusajs.com/api/admin#tag/Invites/operation/PostInvitesInviteAccept):
...
You can resend an invite if it’s not accepted yet. To resend an invite, send a request to the [Resend Invite endpoint](https://docs.medusajs.com/api/admin#tag/Invites/operation/PostInvitesInviteResend):
...
You can delete an invite by sending a request to the [Delete Invite endpoint](https://docs.medusajs.com/api/admin#tag/Invites/operation/DeleteInvitesInvite):
