...
You can list all available currencies in your system by sending a request to the [List Currencies endpoint](https://docs.medusajs.com/api/admin#tag/Currencies/operation/GetCurrencies):
...
This endpoint accepts optional filter and search query parameters. For example, you can pass the `code` query parameter to search the list of currencies by a code. You can learn about available query parameters in the [API reference](https://docs.medusajs.com/api/admin#tag/Currencies/operation/GetCurrencies).
...
You can update a currency by sending a request to the [Update Currency endpoint](https://docs.medusajs.com/api/admin#tag/Currencies/operation/PostCurrenciesCurrency):
...
You can list currencies in a store by sending a request to the [Get Store Details endpoint](https://docs.medusajs.com/api/admin#tag/Store/operation/GetStore):
...
You can add a currency to a store using the [Add a Currency Code endpoint](https://docs.medusajs.com/api/admin#tag/Store/operation/PostStoreCurrenciesCode):
...
You can remove a currency from a store by sending a request to the [Delete Currency Code endpoint](https://docs.medusajs.com/api/admin#tag/Store/operation/DeleteStoreCurrenciesCode):
