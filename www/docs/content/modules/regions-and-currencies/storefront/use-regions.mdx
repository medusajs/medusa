...
You can retrieve available regions by sending a request to the [List Regions](https://docs.medusajs.com/api/store/#tag/Region/operation/GetRegions) endpoint:
...
To retrieve products with the prices based on the selected regions, you can pass the `region_id` query parameter to the [List Products](https://docs.medusajs.com/api/store/#tag/Product/operation/GetProducts) or [Get a Product](https://docs.medusajs.com/api/store/#tag/Product/operation/GetProductsProduct) endpoints.
...
This request returns the list of products along with [pagination fields](https://docs.medusajs.com/api/store/#section/Pagination). The prices of the products are based on the selected region.
