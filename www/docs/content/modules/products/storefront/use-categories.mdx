...
You can list product categories by sending a request to the [List Product Categories endpoint](https://docs.medusajs.com/api/store#tag/Product-Category/operation/GetProductCategories):
...
You can retrieve a single product category by its ID using the [Get a Product Category endpoint](https://docs.medusajs.com/api/store#tag/Product-Category/operation/GetProductCategoriesCategory):
...
This request requires the product category ID as a path parameter. You can also pass query parameters such as `expand` and `fields` as explained in the [API reference](https://docs.medusajs.com/api/store#tag/Product-Category/operation/GetProductCategoriesCategory).
