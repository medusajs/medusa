...
You can list available products using the [List Products endpoint](https://docs.medusajs.com/api/store#tag/Products/operation/GetProducts):
...
You can retrieve the details of a single product by its ID using the [Get a Product endpoint](https://docs.medusajs.com/api/store#tag/Products/operation/GetProductsProduct):
