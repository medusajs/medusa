...
You can list the tax rates by sending a request to the [List Tax Rates endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/GetTaxRates):
...
You can pass to this endpoint filter and search parameters as explained in the [API reference](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/GetTaxRates).

The endpoint returns an array of tax rate objects along with [pagination parameters](https://docs.medusajs.com/api/admin#section/Pagination).
...
You can create a tax rate by sending a request to the [Create Tax Rate endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/PostTaxRates):
...
You can optionally pass other parameters, such as `rate`, which is a number that indicates the tax rate. Refer to the [API reference](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/PostTaxRates) for other optional parameters.
...
You can update a tax rate by sending a request to the [Update Tax Rate endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/PostTaxRatesTaxRate):
...
You can add a product to a tax rate by sending a request to the [Add Products endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/PostTaxRatesTaxRateProducts):
...
You can remove a product from a tax rate by sending a request to the [Delete Products endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/DeleteTaxRatesTaxRateProducts):
...
You can add a product type to a tax rate by sending a request to the [Add Product Types endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/PostTaxRatesTaxRateProductTypes):
...
You can remove a product type from a tax rate by sending a request to the [Delete Product Types endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/DeleteTaxRatesTaxRateProductTypes):
...
You can add a shipping option to a tax rate by sending a request to the [Add Shipping Option endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/PostTaxRatesTaxRateShippingOptions):
...
You can remove a shipping option from a tax rate by sending a request to the [Delete Shipping Options endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/DeleteTaxRatesTaxRateShippingOptions):
...
You can delete a tax rate by sending a request to the [Delete Tax Rate endpoint](https://docs.medusajs.com/api/admin#tag/Tax-Rates/operation/DeleteTaxRatesTaxRate):
