...
Using Medusa’s Discount Admin APIs, you can manage discounts, their conditions, status, rules, and more. You can also manage [dynamic discounts and their discount codes](https://docs.medusajs.com/api/admin/#tag/Discount/operation/PostDiscountsDiscountDynamicCodes).
...
You can use Medusa’s Admin APIs to achieve more functionalities as well. Check out the [API reference](https://docs.medusajs.com/api/admin/#tag/Discount) to learn more.
...
You can create a discount by sending a request to the [Create Discount](https://docs.medusajs.com/api/admin/#tag/Discount/operation/PostDiscounts) endpoint:
...
This request accepts [many request-body parameters](https://docs.medusajs.com/api/admin/#tag/Discount/operation/PostDiscounts) including:
...
You can update any of the discount’s information, configurations, and conditions by sending a request to the [Update Discount](https://docs.medusajs.com/api/admin/#tag/Discount/operation/PostDiscountsDiscount) endpoint.
...
You can check the [API reference](https://docs.medusajs.com/api/admin/#tag/Discount/operation/PostDiscountsDiscount) for all the accepted parameters to update the discount.
...
You can send a request to the [Create Condition](https://docs.medusajs.com/api/admin/#tag/Discount-Condition/operation/PostDiscountsDiscountConditions) endpoint to create a condition in a discount:
...
You can check the [API reference](https://docs.medusajs.com/api/admin/#tag/Discount-Condition/operation/PostDiscountsDiscountConditions) for a full list of accepted parameters based on the condition type.
...
You can retrieve a condition and its resources by sending a request to the [Get Condition](https://docs.medusajs.com/api/admin/#tag/Discount-Condition/operation/GetDiscountsDiscountConditionsCondition) endpoint:
...
You can update a condition’s resources using the [Update Condition](https://docs.medusajs.com/api/admin/#tag/Discount/operation/PostDiscountsDiscountConditionsCondition) endpoint. You can’t update a condition’s operator.
...
You can delete a condition by sending a request to the [Delete Condition](https://docs.medusajs.com/api/admin/#tag/Discount-Condition/operation/DeleteDiscountsDiscountConditionsCondition) endpoint:
...
You can delete a discount by sending a request to the [Delete Discount](https://docs.medusajs.com/api/admin/#tag/Discount/operation/DeleteDiscountsDiscount) endpoint:
