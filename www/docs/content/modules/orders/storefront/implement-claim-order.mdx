...
In addition, it is assumed you already have a logged-in customer before performing the steps in this document. You can refer to the [API reference](https://docs.medusajs.com/api/store/#tag/Auth/operation/PostAuth) for more details on that.
