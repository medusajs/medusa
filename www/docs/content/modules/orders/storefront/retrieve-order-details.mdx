...
You can retrieve an order by its ID using the [Get Order endpoint](https://docs.medusajs.com/api/store#tag/Orders/operation/GetOrdersOrder):
...
This endpoint requires the order’s ID to be passed as a path parameter. You can utilize the [expand](https://docs.medusajs.com/api/store#section/Expanding-Fields) and [fields](https://docs.medusajs.com/api/store#section/Selecting-Fields) query parameters to select parameters and relations to return.
...
You can retrieve an order by its display ID using the [Look Up Order endpoint](https://docs.medusajs.com/api/store#tag/Orders/operation/GetOrders):
...
You can pass other query parameters to filter the orders even further, and the endpoint will return the first order that matches the filters. Learn more about available query parameters in the [API reference](https://docs.medusajs.com/api/store#tag/Orders/operation/GetOrders).
...
You can retrieve an order by the cart ID using the [Get by Cart ID endpoint](https://docs.medusajs.com/api/store#tag/Orders/operation/GetOrdersOrderCartId):
