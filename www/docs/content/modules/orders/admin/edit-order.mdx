...
You can perform other functionalities related to order editing. To learn more, check out the [API reference](https://docs.medusajs.com/api/admin/#tag/OrderEdit).
...
To do that, send a request to the [Create an OrderEdit](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/PostOrderEdits) endpoint:
...
To add a new item to the original order, send a request to the [Add Line Item](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/PostOrderEditsEditLineItems) endpoint:
...
To update an item, send a request to the [Update Line Item](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/PostOrderEditsEditLineItemsLineItem) endpoint:
...
You can remove an item from the original order by sending a request to the [Remove Line Item](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/DeleteOrderEditsOrderEditLineItemsLineItem) endpoint:
...
To revert an item change, send a request to the [Delete Item Change](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/DeleteOrderEditsOrderEditItemChange) endpoint:
...
To move an Order Edit into the request state, send a request to the [Request Confirmation](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/PostOrderEditsOrderEditRequest) endpoint:
...
To confirm an Order Edit, send a request to the [Confirm Order Edit](https://docs.medusajs.com/api/admin/#tag/OrderEdit/operation/PostOrderEditsOrderEditConfirm) endpoint:
...
If the payment is authorized by the customer, it can be captured by sending a request to the [Capture Payment](https://docs.medusajs.com/api/admin/#tag/Payment/operation/PostPaymentsPaymentCapture) endpoint:
...
To refund the difference to the customer, send a request to the [Refund Payment](https://docs.medusajs.com/api/admin/#tag/Payment/operation/PostPaymentsPaymentRefunds) endpoint:
...
Check out what other parameters can be sent in the [API reference](https://docs.medusajs.com/api/admin/#tag/Payment/operation/PostPaymentsPaymentRefunds).
