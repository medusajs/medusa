...
You can list available return reasons using the [List Return Reasons endpoint](https://docs.medusajs.com/api/admin#tag/Return-Reasons/operation/GetReturnReasons):
...
You can create a return reason using the [Create Return Reason endpoint](https://docs.medusajs.com/api/admin#tag/Return-Reasons/operation/PostReturnReasons):
...
You can delete a return reason by sending a request to the [Delete Return Reason endpoint](https://docs.medusajs.com/api/admin#tag/Return-Reasons/operation/DeleteReturnReason):
...
You can view all returns in your commerce system, regardless of which order they belong to, using the [List Returns endpoint](https://docs.medusajs.com/api/admin#tag/Returns/operation/GetReturns).

:::

When you retrieve an order using the [Get Order endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/GetOrdersOrder), you can access the returns within the order object:
...
You can retrieve a swap either using the Get Order endpoint as explained [here](./manage-swaps.mdx#view-orders-swaps), or using the [List Swaps](https://docs.medusajs.com/api/admin#tag/Swaps/operation/GetSwaps) or [Get Swap endpoint](https://docs.medusajs.com/api/admin#tag/Swaps/operation/GetSwapsSwap).
...
You can mark a return as received by sending a request to the [Receive a Return endpoint](https://docs.medusajs.com/api/admin#tag/Returns/operation/PostReturnsReturnReceive):
...
You can cancel a return by sending a request to the [Cancel Return endpoint](https://docs.medusajs.com/api/admin#tag/Returns/operation/PostReturnsReturnCancel):
