...
You can list orders by sending a request to the [List Orders endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/GetOrders):
...
The request returns an array of orders along with [pagination fields](https://docs.medusajs.com/api/admin#section/Pagination).

### Filter Orders

This endpoint accepts a variety of query parameters that allow you to filter orders. You can check available query parameters in the [API reference](https://docs.medusajs.com/api/admin#tag/Orders/operation/GetOrders).
...
You can retrieve an order by sending a request to the [Get an Order endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/GetOrdersOrder):
...
You can update any of the above details of an order by sending a request to the [Update an Order endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrder):
...
You can capture an order’s payment by sending a request to the [Capture Order’s Payment endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderCapture):
...
To refund payment, send a request to the [Refund Payment endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderRefunds):
...
You can also add other optional body parameters, as explained in the [API reference](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderRefunds).
...
You can create a fulfillment by sending a request to the [Create a Fulfillment endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderFulfillments):
...
You can also pass other optional request body parameters as explained in the [API reference](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderFulfillments).

The request returns the updated order as an object.

### Create Shipment

You can create a shipment for a fulfillment by sending a request to the [Create Shipment endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderShipment):
...
In the request body, the `fulfillment_id` parameter is required. Its value is the ID of the fulfillment to create the shipment for. You can also pass other optional body parameters as explained in the [API reference](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderShipment).

The request returns the updated order as an object.

### Cancel Fulfillment

You can cancel a fulfillment by sending a request to the [Cancel Fulfillment endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderFulfillmentsCancel):
...
You can mark an order completed, changing its status, by sending a request to the [Complete an Order endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderComplete):
...
You can cancel an order by sending a request to the [Cancel Order endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderCancel):
...
You can archive an order by sending a request to the [Archive Order endpoint](https://docs.medusajs.com/api/admin#tag/Orders/operation/PostOrdersOrderArchive):
